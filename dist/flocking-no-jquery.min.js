...
!function(n, r) {
                ...
                switch (n = h, m) {
                  ...
                  case 4:
                    !function(e, t, n, r, a, o, i, u) {
                        for (var s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C, A, w, I, N, M, P, O = 0, T = 0, D = 0, L = 2 * r, V = 3 * r, R = n, F = n + i, E = n + 2 * i, B = n + 3 * i, G = R + i; R < G; ) k = .5 * e[R], 
                        S = .5 * t[R], x = .5 * e[F], C = .5 * t[F], A = .5 * e[E], w = .5 * t[E], I = .5 * e[B], 
                        N = .5 * t[B], s = x * (M = a[O]) - C * (P = o[O]), l = x * P + C * M, y = k - (c = A * (M = a[T]) - w * (P = o[T])), 
                        ...
                        t[F] = b - h, e[B] = y - v, t[B] = b + h), O += r, T += L, D += V, ++R, ++F, ++E, 
                        ++B;
                    }(e, t, n, i, c, d, g, p);
                    break;
                  ...
                  case 5:
                    !function(e, t, n, r, a, o, i) {
                        for (var u, s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C, A, w, I, N, M, P, O, T, D, L, V, R, F, E, B, G, q, _, U, j, W, z = 0, H = 0, K = 0, J = 0, $ = 2 * r, Y = 3 * r, Q = 4 * r, X = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, re = a[r * i], ae = o[r * i], oe = a[2 * r * i], ie = o[2 * r * i], ue = .4472135954999579, se = X + i; X < se; ) L = e[X] * ue, 
                        V = t[X] * ue, R = e[Z] * ue, F = t[Z] * ue, E = e[ee] * ue, B = t[ee] * ue, G = e[te] * ue, 
                        ...
                        P = u + S * oe + C * re, O = s + x * oe + A * re, T = -M * ie + I * ae, D = N * ie - w * ae, 
                        e[ee] = P + T, t[ee] = O + D, e[te] = P - T, t[te] = O - D, z += r, H += $, K += Y, 
                        J += Q, ++X, ++Z, ++ee, ++te, ++ne;
                    }(e, t, n, i, c, d, g);
                    break;
    ...
    !function() {
        ...
        m.defaults("flock.webAudio.outputManager", {
            ...
            model: {
                isGenerating: !1,
                shouldInitIOS: D.platform.isIOS,
                audioSettings: {}
            },
            invokers: {
                bindAudioProcess: {
        ...
        }, D.webAudio.outputManager.iOSStart = function(e, t, n) {
