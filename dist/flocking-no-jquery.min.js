...
!function(n, r) {
    ...
    !function() {
        ...
        V.midi.createSystemRealtimeMessageReaders = function(e) {
            ...
            var n = new Uint8Array(V.midi.write.getByteCount(e.type, e.note));
            switch (e.type) {
              case "noteOn":
                n[0] = V.midi.write.statusByte(t, 9), n[1] = e.note, n[2] = e.velocity;
                break;

              case "noteOff":
                n[0] = V.midi.write.statusByte(t, 8), n[1] = e.note, n[2] = e.velocity;
                break;

              case "aftertouch":
                e.note ? (n[0] = V.midi.write.statusByte(t, 10), n[1] = e.note, n[2] = e.velocity) : (n[0] = V.midi.write.statusByte(t, 13), 
                n[1] = e.pressure);
                break;

              case "control":
                n[0] = V.midi.write.statusByte(t, 11), n[1] = e.number, n[2] = e.value;
                break;

              case "program":
                n[0] = V.midi.write.statusByte(t, 12), n[1] = e.program;
                break;

              case "pitchbend":
                n[0] = V.midi.write.statusByte(t, 14), V.midi.write.writeValueToTwoBytesInArray(e.value, n, 1);
                break;

              case "songPointer":
                n[0] = V.midi.write.statusByte(2, 15), V.midi.write.writeValueToTwoBytesInArray(e.value, n, 1);
                break;

              case "songSelect":
                n[0] = V.midi.write.statusByte(3, 15), V.midi.write.writeValueToTwoBytesInArray(e.value, n, 1);
                break;

              case "tuneRequest":
                n[0] = V.midi.write.statusByte(6, 15);
                break;

              case "clock":
                n[0] = V.midi.write.statusByte(8, 15);
                break;

              case "start":
                n[0] = V.midi.write.statusByte(10, 15);
                break;

              case "continue":
                n[0] = V.midi.write.statusByte(11, 15);
                break;

              case "stop":
                n[0] = V.midi.write.statusByte(12, 15);
                break;

              case "activeSense":
                n[0] = V.midi.write.statusByte(14, 15);
                break;

              case "reset":
                n[0] = V.midi.write.statusByte(15, 15);
                break;

              default:
                V.fail("Cannot handle MIDI message of type '" + e.type + "'.");
            }
            return n;
        }, V.midi.write.getByteCount = function(e, t) {
            switch (e) {
              case "noteOn":
              case "noteOff":
                return 3;
              ...
              default:
                V.fail("Cannot handle MIDI message of type '" + e + "'.");
            }
        }, V.midi.write.statusByte = function(e, t) {
            return (t << 4) + e;
        }, V.midi.write.writeValueToTwoBytesInArray = function(e, t, n) {
