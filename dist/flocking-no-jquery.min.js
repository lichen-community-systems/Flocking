...
!function(n, r) {
    ...
    !function(y, b) {
        ...
        b.defaultsStore = {}, b.resolveGradesImpl = function(e, t) {
            ...
            var e = function(e, t, n, r, a, o) {
                ...
                !b.isPrimitive(e)) {
                    ...
                    d.replace ? (u = 1 - a.length, s = 0, l = -1) : (u = 0, s = a.length - 1, l = 1);
        ...
        h.fabricateDestroyMethod = function(e, t, n, r) {
            ...
            function() {
                ...
                t = i.source), e = o.apply(null, t)), !1 === h.defeatLogging && h.popActivity(), 
                e;
            };
        ...
        y.clearLinkCounts = function(n, r) {
            ...
            return a.context ? ((o = y.resolveContext(a.context, e)) || u(" context must be a reference to an existing component"), 
            i = a.contextSegs ? y.getForComponent(o, a.contextSegs) : o) : i = e, a.nonModel || (y.isComponent(i) || s(i), 
            ...
            r = y.model.stepTargetAccess(e.model, t.type, t.segs, 0, a - 1, n)), "ADD" === t.type) {
                ...
                switch (n = h, m) {
                  ...
                  case 4:
                    !function(e, t, n, r, a, o, i, u) {
                        for (var s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C, A, w, I, N, M, P, T = 0, O = 0, V = 0, D = 2 * r, L = 3 * r, R = n, F = n + i, E = n + 2 * i, B = n + 3 * i, G = R + i; R < G; ) k = .5 * e[R], 
                        S = .5 * t[R], x = .5 * e[F], C = .5 * t[F], A = .5 * e[E], w = .5 * t[E], I = .5 * e[B], 
                        N = .5 * t[B], s = x * (M = a[T]) - C * (P = o[T]), l = x * P + C * M, y = k - (c = A * (M = a[O]) - w * (P = o[O])), 
                        b = S - (d = A * P + w * M), k += c, S += d, m = s + (f = I * (M = a[V]) - N * (P = o[V])), 
                        g = l + (p = I * P + N * M), h = s - f, v = l - p, e[E] = k - m, t[E] = S - g, e[R] = k + m, 
                        t[R] = S + g, u ? (e[F] = y - v, t[F] = b + h, e[B] = y + v, t[B] = b - h) : (e[F] = y + v, 
                        t[F] = b - h, e[B] = y - v, t[B] = b + h), T += r, O += D, V += L, ++R, ++F, ++E, 
                        ++B;
                    }(e, t, n, i, c, d, g, p);
                    break;
                  ...
                  case 5:
                    !function(e, t, n, r, a, o, i) {
                        for (var u, s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C, A, w, I, N, M, P, T, O, V, D, L, R, F, E, B, G, q, _, U, j, W, z = 0, H = 0, K = 0, J = 0, $ = 2 * r, Y = 3 * r, Q = 4 * r, X = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, re = a[r * i], ae = o[r * i], oe = a[2 * r * i], ie = o[2 * r * i], ue = .4472135954999579, se = X + i; X < se; ) D = e[X] * ue, 
                        L = t[X] * ue, R = e[Z] * ue, F = t[Z] * ue, E = e[ee] * ue, B = t[ee] * ue, G = e[te] * ue, 
                        q = t[te] * ue, _ = e[ne] * ue, U = t[ne] * ue, u = D, s = L, l = R * (j = a[z]) - F * (W = o[z]), 
                        c = R * W + F * j, d = E * (j = a[H]) - B * (W = o[H]), f = E * W + B * j, p = G * (j = a[K]) - q * (W = o[K]), 
                        m = G * W + q * j, S = l + (g = _ * (j = a[J]) - U * (W = o[J])), x = c + (h = _ * W + U * j), 
                        N = l - g, M = c - h, C = d + p, A = f + m, w = d - p, I = f - m, e[X] = D + S + C, 
                        t[X] = L + x + A, v = u + S * re + C * oe, y = s + x * re + A * oe, b = M * ae + I * ie, 
                        k = -N * ae - w * ie, e[Z] = v - b, t[Z] = y - k, e[ne] = v + b, t[ne] = y + k, 
                        P = u + S * oe + C * re, T = s + x * oe + A * re, O = -M * ie + I * ae, V = N * ie - w * ae, 
                        e[ee] = P + O, t[ee] = T + V, e[te] = P - O, t[te] = T - V, z += r, H += $, K += Y, 
                        J += Q, ++X, ++Z, ++ee, ++te, ++ne;
                    }(e, t, n, i, c, d, g);
                    break;
    ...
    !function() {
        ...
        V.shim = {
            ...
            if (V.debug.failHard) throw e = e instanceof Error ? e : new Error(e);
            V.log.fail(e);
    ...
    !function() {
        ...
        V.shim = {
            ...
            }), t = V.shim.URL.createObjectURL(n)) : t = "data:text/javascript;base64," + window.btoa(e), 
            new Worker(t);
    ...
    !function() {
        ...
        }, V.webAudio.mediaStreamFailure = function(e) {
        ...
        var e = {
            ...
            getUserMedia: function(e, t, n) {
                navigator.mediaDevices ? navigator.mediaDevices.getUserMedia(e).then(t).catch(n) : navigator.getUserMedia ? navigator.getUserMedia(e, t, n) : V.webAudio.mediaStreamFailure(n);
            },
    ...
    !function() {
        ...
        m.registerNamespace("flock.midi"), V.midi.requestAccess = function(e, t, n) {
            ...
            var t = {};
            return V.midi.collectPorts("inputs", e, t), V.midi.collectPorts("outputs", e, t), 
            t;
        ...
        }), V.midi.write = function(e) {
            if ("sysex" === e.type) return V.midi.write.sysex(e);
            switch (e.type) {
              case "noteOn":
                return V.midi.write.note(9, e);

              case "noteOff":
                return V.midi.write.note(8, e);

              case "aftertouch":
                return V.midi.write.aftertouch(e);

              case "control":
                return V.midi.write.controlChange(e);

              case "program":
                return V.midi.write.programChange(e);

              case "pitchbend":
                return V.midi.write.largeValueMessage(14, e.channel, e);

              case "songPointer":
                return V.midi.write.largeValueMessage(15, 2, e);

              case "songSelect":
                return V.midi.write.largeValueMessage(15, 3, e);

              case "tuneRequest":
                return V.midi.write.singleByteMessage(15, 6);

              case "clock":
                return V.midi.write.singleByteMessage(15, 8);

              case "start":
                return V.midi.write.singleByteMessage(15, 10);

              case "continue":
                return V.midi.write.singleByteMessage(15, 11);

              case "stop":
                return V.midi.write.singleByteMessage(15, 12);

              case "activeSense":
                return V.midi.write.singleByteMessage(15, 14);

              case "reset":
                return V.midi.write.singleByteMessage(15, 15);

              default:
                V.fail("Cannot write an unrecognized MIDI message of type '" + e.type + "'.");
            }
        }, V.midi.write.note = function(e, t) {
            return V.midi.write.threeByteMessage(e, t.channel, t.note, t.velocity);
        }, V.midi.write.controlChange = function(e) {
            return V.midi.write.threeByteMessage(11, e.channel, e.number, e.value);
        }, V.midi.write.programChange = function(e) {
            return V.midi.write.twoByteMessage(12, e.channel, e.program);
        }, V.midi.write.aftertouch = function(e) {
            return e.note ? V.midi.write.note(10, e) : V.midi.write.twoByteMessage(13, e.channel, e.pressure);
        }, V.midi.write.singleByteMessage = function(e, t) {
            var n = new Uint8Array(1);
            return n[0] = V.midi.write.statusByte(e, t), n;
        }, V.midi.write.twoByteMessage = function(e, t, n) {
            var r = new Uint8Array(2);
            return r[0] = V.midi.write.statusByte(e, t), r[1] = n, r;
        }, V.midi.write.threeByteMessage = function(e, t, n, r) {
            var a = new Uint8Array(3);
            return a[0] = V.midi.write.statusByte(e, t), a[1] = n, a[2] = r, a;
        }, V.midi.write.largeValueMessage = function(e, t, n) {
            var r = new Uint8Array(3);
            return r[0] = V.midi.write.statusByte(e, t), V.midi.write.twoByteValue(n.value, r, 1), 
            r;
        }, V.midi.write.statusByte = function(e, t) {
            return (e << 4) + t;
        }, V.midi.write.twoByteValue = function(e, t, n) {
            t[n = n || 0] = 127 & e, t[n + 1] = e >> 7 & 127;
        }, V.midi.write.sysex = function(e) {
            240 !== e.data[0] && 247 !== e.data[e.data.length - 1] || V.fail("Sysex payloads should not include framing bytes.");
            var t = e.data, n = t.length, r = new Uint8Array(n + 2);
            return r[0] = 240, r[n + 1] = 247, r.set(t, 1), r;
        }, V.midi.connection.send = function(e, t) {
            var n = V.midi.write(t);
    ...
    !function() {
        ...
        m.defaults("flock.webAudio.outputManager", {
            ...
            model: {
                isGenerating: !1,
                shouldInitSafari: V.platform.browser.safari,
                audioSettings: {}
            },
            invokers: {
                bindAudioProcess: {
        ...
        }, V.webAudio.outputManager.safariStart = function(e, t, n) {
    ...
    !function() {
        ...
        V.ugenDefaults = function(e, t) {
            ...
            n || r ? (e = n ? r ? n.rate !== V.rates.AUDIO ? r.rate !== V.rates.AUDIO ? V.krMulKrAdd : V.krMulAdd : r.rate !== V.rates.AUDIO ? V.mulKrAdd : V.mulAdd : n.rate !== V.rates.AUDIO ? V.krMul : V.mul : r.rate !== V.rates.AUDIO ? V.krAdd : V.add, 
            t.mulAddFn = e, t.mulAdd = function(e) {
                t.mulAddFn(e, t.output, t.inputs.mul, t.inputs.add);
            }) : t.mulAdd = t.mulAddFn = V.noOp;
    ...
    !function() {
        ...
        V.ugen.playBuffer = function(y, e, t) {
            ...
            return O.gen = function(e) {
                var t, n, r, a, o, i, u, s, l, c, d = O.model, f = d.strides, p = O.output, m = O.inputs, g = O.buffers, h = g.length - 1, v = d.prevTrigger, y = d.maxVoices, b = d.activeVoices, k = d.freeVoices, S = m.trigger.output, x = f.trigger, C = 0, A = m.bufferIndex.output, w = f.bufferIndex, I = 0, N = m.speed.output, M = f.speed, P = 0, T = O.inputs.channel.output[0];
                for (t = 0; t < e; t++) {
                    if (0 < (n = S[C]) && v <= 0 && b.length < y) {
                        if (a = Math.round(A[I] * h), a = Math.max(0, a), !(o = g[a = Math.min(a, h)])) continue;
                        (r = k.pop()).speed = N[P], r.currentIdx = 0, r.writePos = t, r.buffer = o.data.channels[T], 
                        b.push(r);
                    }
                    C += x, P += M, I += w, p[t] = 0, v = n;
                }
                for (i = 0; i < b.length; ) {
                    for (u = (r = b[i]).buffer, s = Math.min(u.length - r.currentIdx, e), l = r.writePos; l < s; l++) c = O.interpolate ? O.interpolate(r.currentIdx, u) : u[0 | r.currentIdx], 
                    p[l] += c, r.currentIdx += r.speed;
                    r.currentIdx >= u.length ? (k.push(r), b.splice(i, 1)) : (r.writePos = 0, i++);
                }
                d.prevTrigger = v, d.unscaledValue = c, O.mulAdd(e), d.value = V.ugen.lastOutputValue(e, p);
            }, O.init = function() {
                ...
                V.onMulAddInputChanged(O), O.calculateStrides();
            }, O.init(), O;
    ...
    !function() {
        ...
        V.envelope = {}, V.envelope.makeCreator = function(r, a) {
            ...
            var r, a, o = t.curve;
            return 0 === n.stage || n.stage > n.numStages ? r = V.line.constant : (a = o[n.stage - 1], 
            n.currentCurve = a, r = V.lineGenerator(a)), V.ugen.envGen.setupStage(e, t, n), 
            r.init(n), r;
    ...
    !function() {
        ...
        V.ugen.dust = function(l, e, t) {
            ...
            return c.gen = function(e) {
                ...
                n = i.scale), o = 0; o < e; o++) a = (r = Math.random()) < t ? r * n : 0, u[o] = a;
    ...
    !function() {
        ...
        V.ugen.change = function(e, t, n) {
            ...
            return c.gen = function(e) {
                ...
                n = V.ugen.sequencer.nextStage(s, l, o, r)) : 0 < u ? (r.idx = 0, n = V.ugen.sequencer.nextStage(s, l, o, r)) : n = a.holdLastValue ? r.unscaledValue : 0 : (n = l[r.idx], 
