...
!function(e, t) {
    ...
    !function(e, t) {
        ...
        if (!e.FFT) {
            var t = function(e, t, n, r, a, o, i) {
                ...
                for (var u, s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C = 0, A = 0, w = 2 * r, I = n, N = n + i, M = n + 2 * i, T = o[r * i], P = .5773502691896258, O = I + i; I < O; ) g = e[I] * P, 
                h = t[I] * P, v = e[N] * P, y = t[N] * P, b = e[M] * P, k = t[M] * P, S = a[C], 
                c = v * (x = o[C]) + y * S, u = (l = v * S - y * x) - (d = b * (S = a[A]) - k * (x = o[A])), 
                s = c - (f = b * x + k * S), v = g - .5 * (p = l + d), y = h - .5 * (m = c + f), 
                u *= T, s *= T, e[I] = g + p, t[I] = h + m, e[M] = v + s, t[M] = y - u, e[N] = v - s, 
                t[N] = y + u, C += r, A += w, ++I, ++N, ++M;
            }, r = function(e, t, n, r, a, o, i, u) {
                for (var s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C, A, w, I, N, M, T, P = 0, O = 0, D = 0, V = 2 * r, L = 3 * r, R = n, F = n + i, E = n + 2 * i, B = n + 3 * i, G = R + i; R < G; ) k = .5 * e[R], 
                S = .5 * t[R], x = .5 * e[F], C = .5 * t[F], A = .5 * e[E], w = .5 * t[E], I = .5 * e[B], 
                N = .5 * t[B], s = x * (M = a[P]) - C * (T = o[P]), l = x * T + C * M, y = k - (c = A * (M = a[O]) - w * (T = o[O])), 
                b = S - (d = A * T + w * M), k += c, S += d, m = s + (f = I * (M = a[D]) - N * (T = o[D])), 
                g = l + (p = I * T + N * M), h = s - f, v = l - p, e[E] = k - m, t[E] = S - g, e[R] = k + m, 
                t[R] = S + g, u ? (e[F] = y - v, t[F] = b + h, e[B] = y + v, t[B] = b - h) : (e[F] = y + v, 
                t[F] = b - h, e[B] = y - v, t[B] = b + h), P += r, O += V, D += L, ++R, ++F, ++E, 
                ++B;
            }, a = function(e, t, n, r, a, o, i) {
                for (var u, s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C, A, w, I, N, M, T, P, O, D, V, L, R, F, E, B, G, q, _, U, j, W, z = 0, H = 0, K = 0, J = 0, $ = 2 * r, Y = 3 * r, Q = 4 * r, X = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, re = a[r * i], ae = o[r * i], oe = a[2 * r * i], ie = o[2 * r * i], ue = .4472135954999579, se = X + i; X < se; ) V = e[X] * ue, 
                ...
                T = u + S * oe + C * re, P = s + x * oe + A * re, O = -M * ie + I * ae, D = N * ie - w * ae, 
                e[ee] = T + O, t[ee] = P + D, e[te] = T - O, t[te] = P - D, z += r, H += $, K += Y, 
                J += Q, ++X, ++Z, ++ee, ++te, ++ne;
    ...
    !function() {
        ...
        i.midi.createSystemRealtimeMessageReaders = function(e) {
            ...
            switch (e.type) {
              ...
              case "pitchbend":
                t = 14, n = i.midi.write.valueToTwoByteArray(e.value);
                break;
              ...
              case "songPointer":
                r = 2, t = 15, n = i.midi.write.valueToTwoByteArray(e.value);
                break;

              case "songSelect":
                r = 3, t = 15, n = i.midi.write.valueToTwoByteArray(e.value);
                break;
    ...
    !function() {
        ...
        i.ugen.playBuffer = function(e, t, n) {
            ...
            var r = i.ugen(e, t, n);
            return r.gen = function(e) {
                var t, n, a, o, u, s, l, c, d, f, p = r.model, m = p.strides, g = r.output, h = r.inputs, v = r.buffers, y = v.length - 1, b = p.prevTrigger, k = p.maxVoices, S = p.activeVoices, x = p.freeVoices, C = h.trigger.output, A = m.trigger, w = 0, I = h.bufferIndex.output, N = m.bufferIndex, M = 0, T = h.speed.output, P = m.speed, O = 0, D = r.inputs.channel.output[0];
                for (t = 0; t < e; t++) {
                    if ((n = C[w]) > 0 && b <= 0 && S.length < k) {
                        if (o = Math.round(I[M] * y), o = Math.max(0, o), o = Math.min(o, y), !(u = v[o])) continue;
                        (a = x.pop()).speed = T[O], a.currentIdx = 0, a.writePos = t, a.buffer = u.data.channels[D], 
                        S.push(a);
                    }
                    w += A, O += P, M += N, g[t] = 0, b = n;
                }
                for (s = 0; s < S.length; ) {
