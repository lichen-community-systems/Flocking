...
!function(n, r) {
                ...
                switch (n = h, m) {
                  ...
                  case 4:
                    !function(e, t, n, r, a, o, i, u) {
                        for (var s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C, A, w, I, N, M, P, T = 0, O = 0, D = 0, L = 2 * r, V = 3 * r, R = n, F = n + i, E = n + 2 * i, G = n + 3 * i, B = R + i; R < B; ) k = .5 * e[R], 
                        ...
                        t[F] = b - h, e[G] = y - v, t[G] = b + h), T += r, O += L, D += V, ++R, ++F, ++E, 
                        ++G;
                    }(e, t, n, i, c, d, g, p);
                    break;
                  ...
                  case 5:
                    !function(e, t, n, r, a, o, i) {
                        for (var u, s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C, A, w, I, N, M, P, T, O, D, L, V, R, F, E, G, B, q, _, U, j, W, z = 0, H = 0, K = 0, J = 0, $ = 2 * r, Y = 3 * r, Q = 4 * r, X = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, re = a[r * i], ae = o[r * i], oe = a[2 * r * i], ie = o[2 * r * i], ue = .4472135954999579, se = X + i; X < se; ) L = e[X] * ue, 
                        V = t[X] * ue, R = e[Z] * ue, F = t[Z] * ue, E = e[ee] * ue, G = t[ee] * ue, B = e[te] * ue, 
                        q = t[te] * ue, _ = e[ne] * ue, U = t[ne] * ue, u = L, s = V, l = R * (j = a[z]) - F * (W = o[z]), 
                        ...
                        t[X] = V + x + A, v = u + S * re + C * oe, y = s + x * re + A * oe, b = M * ae + I * ie, 
    ...
    !function() {
        ...
        D.platform.audioEngine = D.platform.isBrowser ? "webAudio" : "nodejs", D.platform.browser && void 0 !== D.platform.browser.version) {
        ...
        D.shim = {
            ...
            if (D.debug.failHard) throw new Error(e);
            D.log.fail(e);
    ...
    !function() {
        ...
        D.evaluate = {
            ...
            synthValue: function(e) {
                return D.evaluate.synth(e), e.model.value;
            },
            synths: function(e) {
                for (var t = 0; t < e.length; t++) D.evaluate.synth(e[t]);
            },
    ...
    !function() {
        ...
        D.applyDeferred = function(e, t, n) {
            ...
            i && (a = c(a)), D.applyDeferred(function() {
    ...
    !function() {
        ...
        D.shim = {
            ...
            }), t = D.shim.URL.createObjectURL(n)) : t = "data:text/javascript;base64," + window.btoa(e), 
            new Worker(t);
    ...
    !function() {
        ...
        }, D.webAudio.audioSystem.configureDestination = function(e, t) {
            D.platform.browser.safari || (e.destination.channelCount = t, e.destination.channelCountMode = "explicit", 
    ...
    !function() {
        ...
        m.registerNamespace("flock.midi"), D.midi.requestAccess = function(e, t, n) {
            ...
            var t = {}, n = "function" == typeof e.inputs ? D.midi.collectPortsLegacy : D.midi.collectPorts;
            ...
            o = a.next();
            return n;
        }, D.midi.collectPortsLegacy = function(e, t, n) {
        ...
        }), D.midi.connection.send = function() {
            D.fail("Sending MIDI messages is not currently supported.");
    ...
    !function() {
        ...
        m.defaults("flock.webAudio.outputManager", {
            ...
            model: {
                isGenerating: !1,
                shouldInitSafari: D.platform.browser.safari,
                audioSettings: {}
            },
            invokers: {
                bindAudioProcess: {
        ...
        }, D.webAudio.outputManager.safariStart = function(e, t, n) {
    ...
    !function() {
        ...
        D.ugen.playBuffer = function(y, e, t) {
            ...
            return O.gen = function(e) {
                ...
                d.prevTrigger = v, d.unscaledValue = c, O.mulAdd(e), d.value = D.ugen.lastOutputValue(e, p);
            }, O.init = function() {
                ...
                D.onMulAddInputChanged(O), O.calculateStrides();
            }, O.init(), O;
    ...
    !function() {
        ...
        D.envelope = {}, D.envelope.makeCreator = function(r, a) {
            ...
            var r, a, o = t.curve;
            return 0 === n.stage || n.stage > n.numStages ? r = D.line.constant : (a = o[n.stage - 1], 
            n.currentCurve = a, r = D.lineGenerator(a)), D.ugen.envGen.setupStage(e, t, n), 
            r.init(n), r;
    ...
    !function() {
        ...
        D.ugen.lag = function(e, t, n) {
            ...
            return x.gen = function(e) {
                ...
                s.unscaledValue = s.out4, x.mulAdd(e), s.value = D.ugen.lastOutputValue(e, c);
            }, x.onInputChanged(), x;
    ...
    !function() {
        ...
        D.ugen.change = function(e, t, n) {
            ...
            return c.gen = function(e) {
                ...
                n = D.ugen.sequencer.nextStage(s, l, o, r)) : 0 < u ? (r.idx = 0, n = D.ugen.sequencer.nextStage(s, l, o, r)) : n = a.holdLastValue ? r.unscaledValue : 0 : (n = l[r.idx], 
