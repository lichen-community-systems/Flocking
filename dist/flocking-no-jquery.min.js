...
!function(e, t) {
    ...
    !function(e, t) {
        ...
        if (!e.Filter) {
            ...
            t.prototype.filter = function(e, t) {
                ...
                if (3 == i && 2 == a) for (var m, g, h = o[0], v = o[1], y = o[2], b = r[0], k = r[1], S = t[n - 1], x = t[n - 2], A = e[n - 1], C = e[n - 2]; n < l; ++n) m = x, 
                x = S, g = C, A = h * (S = t[n]) + v * x + y * m - b * (C = A) - k * g, e[n] = A; else for (;n < l; ++n) {
                    var w, I = o[0] * t[n];
        ...
        if (!e.FFT) {
            var t = function(e, t, n, r, a, o, i) {
                ...
                for (var u, s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, A = 0, C = 0, w = 2 * r, I = n, N = n + i, T = n + 2 * i, M = o[r * i], P = .5773502691896258, O = I + i; I < O; ) g = e[I] * P, 
                h = t[I] * P, v = e[N] * P, y = t[N] * P, b = e[T] * P, k = t[T] * P, S = a[A], 
                c = v * (x = o[A]) + y * S, u = (l = v * S - y * x) - (d = b * (S = a[C]) - k * (x = o[C])), 
                s = c - (f = b * x + k * S), v = g - .5 * (p = l + d), y = h - .5 * (m = c + f), 
                u *= M, s *= M, e[I] = g + p, t[I] = h + m, e[T] = v + s, t[T] = y - u, e[N] = v - s, 
                t[N] = y + u, A += r, C += w, ++I, ++N, ++T;
            }, r = function(e, t, n, r, a, o, i, u) {
                for (var s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, A, C, w, I, N, T, M, P = 0, O = 0, D = 0, V = 2 * r, L = 3 * r, R = n, F = n + i, E = n + 2 * i, B = n + 3 * i, G = R + i; R < G; ) k = .5 * e[R], 
                S = .5 * t[R], x = .5 * e[F], A = .5 * t[F], C = .5 * e[E], w = .5 * t[E], I = .5 * e[B], 
                N = .5 * t[B], s = x * (T = a[P]) - A * (M = o[P]), l = x * M + A * T, y = k - (c = C * (T = a[O]) - w * (M = o[O])), 
                b = S - (d = C * M + w * T), k += c, S += d, m = s + (f = I * (T = a[D]) - N * (M = o[D])), 
                g = l + (p = I * M + N * T), h = s - f, v = l - p, e[E] = k - m, t[E] = S - g, e[R] = k + m, 
                t[R] = S + g, u ? (e[F] = y - v, t[F] = b + h, e[B] = y + v, t[B] = b - h) : (e[F] = y + v, 
                t[F] = b - h, e[B] = y - v, t[B] = b + h), P += r, O += V, D += L, ++R, ++F, ++E, 
                ++B;
            }, a = function(e, t, n, r, a, o, i) {
                for (var u, s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, A, C, w, I, N, T, M, P, O, D, V, L, R, F, E, B, G, q, U, _, j, W, z = 0, H = 0, K = 0, J = 0, $ = 2 * r, Y = 3 * r, Q = 4 * r, X = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, re = a[r * i], ae = o[r * i], oe = a[2 * r * i], ie = o[2 * r * i], ue = .4472135954999579, se = X + i; X < se; ) V = e[X] * ue, 
                L = t[X] * ue, R = e[Z] * ue, F = t[Z] * ue, E = e[ee] * ue, B = t[ee] * ue, G = e[te] * ue, 
                q = t[te] * ue, U = e[ne] * ue, _ = t[ne] * ue, u = V, s = L, l = R * (j = a[z]) - F * (W = o[z]), 
                c = R * W + F * j, d = E * (j = a[H]) - B * (W = o[H]), f = E * W + B * j, p = G * (j = a[K]) - q * (W = o[K]), 
                m = G * W + q * j, S = l + (g = U * (j = a[J]) - _ * (W = o[J])), x = c + (h = U * W + _ * j), 
                N = l - g, T = c - h, A = d + p, C = f + m, w = d - p, I = f - m, e[X] = V + S + A, 
                t[X] = L + x + C, v = u + S * re + A * oe, y = s + x * re + C * oe, b = T * ae + I * ie, 
                k = -N * ae - w * ie, e[Z] = v - b, t[Z] = y - k, e[ne] = v + b, t[ne] = y + k, 
                M = u + S * oe + A * re, P = s + x * oe + C * re, O = -T * ie + I * ae, D = N * ie - w * ae, 
                e[ee] = M + O, t[ee] = P + D, e[te] = M - O, t[te] = P - D, z += r, H += $, K += Y, 
                J += Q, ++X, ++Z, ++ee, ++te, ++ne;
                ...
                for (l = 0; l < i; ++l) {
                    ...
                    for (c = 0; c < u; ++c) {
                        p = b[0], m = k[0];
                        var A = 0;
                        for (d = 1; d < u; ++d) (A += x) >= s && (A -= s), g = b[d], h = k[d], p += g * (v = a[A]) - h * (y = o[A]), 
                        m += g * y + h * v;
                        e[f] = p, t[f] = m, f += i, x += r;
                    }
                }
            }, i = function(e, u, s, l, c, d, f, p, m, g, h, v, y, b) {
                var k = m[g++], S = m[g++], x = s, A = s + k * S, C = f * p;
                if (1 == S) do {
                    e[s] = l[d], u[s] = c[d], d += C, ++s;
                } while (s != A); else do {
                    i(e, u, s, l, c, d, f * k, p, m, g, h, v, y, b), d += C, s += S;
                } while (s != A);
                switch (s = x, k) {
                  case 2:
                    t(e, u, s, f, h, v, S);
    ...
    !function() {
        ...
        r.registerNamespace("flock.midi"), i.midi.requestAccess = function(e, t, n) {
            ...
            var t = {};
            return i.midi.collectPorts("inputs", e, t), i.midi.collectPorts("outputs", e, t), 
            t;
        ...
        i.midi.createSystemRealtimeMessageReaders = function(e) {
        ...
        }), i.midi.getFirstByte = function(e, t) {
            return (t << 4) + e;
        }, i.midi.arrayToUint8TypedArray = function(e) {
            return new Uint8Array(e);
        }, i.midi.write = function(e) {
            var t = e.channel ? e.channel : 0;
            switch (e.type) {
              case "noteOn":
                return i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(t, 9), e.note, e.velocity ]);

              case "noteOff":
                return i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(t, 8), e.note, e.velocity ]);

              case "aftertouch":
                return e.note ? i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(t, 10), e.note, e.velocity ]) : i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(t, 13), e.pressure ]);

              case "control":
                return i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(t, 11), e.number, e.value ]);

              case "program":
                return i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(t, 12), e.program ]);

              case "pitchbend":
                return i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(t, 14) ].concat(i.midi.write.valueToTwoByteArray(e.value)));

              case "sysex":
                return i.midi.write.sysex(e);

              case "songPointer":
                return i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(2, 15) ].concat(i.midi.write.valueToTwoByteArray(e.value)));

              case "songSelect":
                return i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(3, 15) ].concat(i.midi.write.valueToTwoByteArray(e.value)));

              case "tuneRequest":
                return i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(6, 15) ]);

              case "clock":
                return i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(8, 15) ]);

              case "start":
                return i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(10, 15) ]);

              case "continue":
                return i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(11, 15) ]);

              case "stop":
                return i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(12, 15) ]);

              case "activeSense":
                return i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(14, 15) ]);

              case "reset":
                return i.midi.arrayToUint8TypedArray([ i.midi.getFirstByte(15, 15) ]);

              default:
                i.fail("Cannot handle MIDI message of type '" + e.type + "'.");
            }
        }, i.midi.write.valueToTwoByteArray = function(e) {
            return [ 127 & e, e >> 7 & 127 ];
        }, i.midi.write.sysex = function(e) {
            ...
            r;
        }, i.midi.connection.send = function(e, t) {
            var n = i.midi.write(t);
    ...
    !function() {
        ...
        i.ugen.playBuffer = function(e, t, n) {
            ...
            var r = i.ugen(e, t, n);
            return r.gen = function(e) {
                var t, n, a, o, u, s, l, c, d, f, p = r.model, m = p.strides, g = r.output, h = r.inputs, v = r.buffers, y = v.length - 1, b = p.prevTrigger, k = p.maxVoices, S = p.activeVoices, x = p.freeVoices, A = h.trigger.output, C = m.trigger, w = 0, I = h.bufferIndex.output, N = m.bufferIndex, T = 0, M = h.speed.output, P = m.speed, O = 0, D = r.inputs.channel.output[0];
                for (t = 0; t < e; t++) {
                    if ((n = A[w]) > 0 && b <= 0 && S.length < k) {
                        if (o = Math.round(I[T] * y), o = Math.max(0, o), o = Math.min(o, y), !(u = v[o])) continue;
                        (a = x.pop()).speed = M[O], a.currentIdx = 0, a.writePos = t, a.buffer = u.data.channels[D], 
                        S.push(a);
                    }
                    w += C, O += P, T += N, g[t] = 0, b = n;
                }
                for (s = 0; s < S.length; ) {
    ...
    !function() {
        ...
        i.ugen.lag = function(e, t, n) {
            ...
            var r = i.ugen(e, t, n);
            return r.gen = function(e) {
                var t, n, a, o, u, s, l, c = r.model, d = r.inputs, f = r.output, p = d.source.output, m = c.strides.source, g = d.resonance.output, h = c.strides.resonance, v = d.cutoff.output, y = c.strides.cutoff, b = c.f, k = c.fSq, S = c.fSqSq, x = c.oneMinusF, A = c.fb;
                ...
                s !== c.prevRes && (s > 4 ? s = 4 : s < 0 && (s = 0), A = c.fb = s * (1 - .15 * k)), 
                l = p[n] - c.out4 * A, l *= .35013 * S, c.out1 = l + .3 * c.in1 + x * c.out1, c.in1 = l, 
    ...
    !function() {
        ...
        i.ugen.triggerGrains = function(e, t, n) {
            var r = i.ugen(e, t, n);
            return r.gen = function(e) {
                var t, n, a, o, u, s, l, c = r.model, d = r.inputs, f = r.output, p = d.channel.output[0], m = r.buffer.data.channels[p], g = r.buffer.format.sampleRate, h = d.dur.output[0], v = d.amp.output, y = d.centerPos.output, b = d.trigger.output, k = d.speed.output, S = r.options.grainEnv, x = e - 1, A = 0, C = 0, w = 0, I = 0;
                for (t = 0; t < e; t++) {
                    if (b[C] > 0 && c.prevTrigger <= 0 && c.activeGrains.length < c.maxNumGrains) {
                        ...
                        u = y[A] * g - o.centerIdx; u < 0; ) u += m.length;
                        o.readPos = u, o.writePos = t, o.speed = k[I], c.activeGrains.push(o);
                    }
                    c.prevTrigger = b[C], f[t] = 0, A += c.strides.centerPos, C += c.strides.trigger, 
