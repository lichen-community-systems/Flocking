...
!function(e, t) {
    ...
    !function(e, t) {
        ...
        if (!e.FFT) {
            var t = function(e, t, n, r, a, o, i) {
                ...
                for (var s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C, A, w, I, N, M, P, T = 0, O = 0, D = 0, L = 2 * r, V = 3 * r, R = n, F = n + i, E = n + 2 * i, B = n + 3 * i, G = R + i; R < G; ) k = .5 * e[R], 
                ...
                t[F] = b - h, e[B] = y - v, t[B] = b + h), T += r, O += L, D += V, ++R, ++F, ++E, 
                ++B;
            }, a = function(e, t, n, r, a, o, i) {
                for (var u, s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C, A, w, I, N, M, P, T, O, D, L, V, R, F, E, B, G, q, _, U, j, W, z = 0, H = 0, K = 0, J = 0, $ = 2 * r, Y = 3 * r, Q = 4 * r, X = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, re = a[r * i], ae = o[r * i], oe = a[2 * r * i], ie = o[2 * r * i], ue = .4472135954999579, se = X + i; X < se; ) L = e[X] * ue, 
    ...
    !function() {
        ...
        }, i.webAudio.mediaStreamFailure = function(e) {
            var t = "This browser does not support getUserMedia() or the Media Streams API.";
            e ? e(new Error(t)) : r.log(r.logLevel.IMPORTANT, t);
        };
        var e = {
            AudioContext: window.AudioContext || window.webkitAudioContext,
            getUserMedia: function(e, t, n) {
                navigator.mediaDevices ? navigator.mediaDevices.getUserMedia(e).then(t).catch(n) : navigator.getUserMedia ? navigator.getUserMedia(e, t, n) : i.webAudio.mediaStreamFailure(n);
            },
