...
!function(e, t) {
    ...
    !function(e, t) {
        ...
        if (!e.FFT) {
            var t = function(e, t, n, r, a, o, i) {
                ...
                for (var s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C, A, w, I, N, M, P, T = 0, O = 0, L = 0, V = 2 * r, D = 3 * r, R = n, F = n + i, E = n + 2 * i, B = n + 3 * i, G = R + i; R < G; ) k = .5 * e[R], 
                S = .5 * t[R], x = .5 * e[F], C = .5 * t[F], A = .5 * e[E], w = .5 * t[E], I = .5 * e[B], 
                N = .5 * t[B], s = x * (M = a[T]) - C * (P = o[T]), l = x * P + C * M, y = k - (c = A * (M = a[O]) - w * (P = o[O])), 
                b = S - (d = A * P + w * M), k += c, S += d, m = s + (f = I * (M = a[L]) - N * (P = o[L])), 
                g = l + (p = I * P + N * M), h = s - f, v = l - p, e[E] = k - m, t[E] = S - g, e[R] = k + m, 
                t[R] = S + g, u ? (e[F] = y - v, t[F] = b + h, e[B] = y + v, t[B] = b - h) : (e[F] = y + v, 
                t[F] = b - h, e[B] = y - v, t[B] = b + h), T += r, O += V, L += D, ++R, ++F, ++E, 
                ++B;
            }, a = function(e, t, n, r, a, o, i) {
                for (var u, s, l, c, d, f, p, m, g, h, v, y, b, k, S, x, C, A, w, I, N, M, P, T, O, L, V, D, R, F, E, B, G, q, _, U, j, W, z = 0, H = 0, K = 0, J = 0, $ = 2 * r, Y = 3 * r, Q = 4 * r, X = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, re = a[r * i], ae = o[r * i], oe = a[2 * r * i], ie = o[2 * r * i], ue = .4472135954999579, se = X + i; X < se; ) V = e[X] * ue, 
                D = t[X] * ue, R = e[Z] * ue, F = t[Z] * ue, E = e[ee] * ue, B = t[ee] * ue, G = e[te] * ue, 
                q = t[te] * ue, _ = e[ne] * ue, U = t[ne] * ue, u = V, s = D, l = R * (j = a[z]) - F * (W = o[z]), 
                ...
                P = u + S * oe + C * re, T = s + x * oe + A * re, O = -M * ie + I * ae, L = N * ie - w * ae, 
                e[ee] = P + O, t[ee] = T + L, e[te] = P - O, t[te] = T - L, z += r, H += $, K += Y, 
                J += Q, ++X, ++Z, ++ee, ++te, ++ne;
    ...
    !function() {
        ...
        i.ugen.playBuffer = function(e, t, n) {
            ...
            var r = i.ugen(e, t, n);
            return r.gen = function(e) {
                var t, n, a, o, u, s, l, c, d, f, p = r.model, m = p.strides, g = r.output, h = r.inputs, v = r.buffers, y = v.length - 1, b = p.prevTrigger, k = p.maxVoices, S = p.activeVoices, x = p.freeVoices, C = h.trigger.output, A = m.trigger, w = 0, I = h.bufferIndex.output, N = m.bufferIndex, M = 0, P = h.speed.output, T = m.speed, O = 0, L = r.inputs.channel.output[0];
                for (t = 0; t < e; t++) {
                    if ((n = C[w]) > 0 && b <= 0 && S.length < k) {
                        if (o = Math.round(I[M] * y), o = Math.max(0, o), o = Math.min(o, y), !(u = v[o])) continue;
                        (a = x.pop()).speed = P[O], a.currentIdx = 0, a.writePos = t, a.buffer = u.data.channels[L], 
                        S.push(a);
                    }
    ...
    !function() {
        ...
        i.ugen.distortion = function(e, t, n) {
            ...
            return r.gen = function(e) {
                ...
                for (n = a = 0; n < e; n++, a += l) t = Math.tanh(s[n]), u[n] = t;
        ...
        }), i.ugen.distortion.deJonge = function(e, t, n) {
            var r = i.ugen(e, t, n);
            return r.gen = function(e) {
        ...
        }, i.ugenDefaults("flock.ugen.distortion.deJonge", {
            rate: "audio",
            inputs: {
                source: null,
                amount: 2
        ...
        }), i.ugen.distortion.tarrabiaDeJonge = function(e, t, n) {
            var r = i.ugen(e, t, n);
            return r.gen = function(e) {
                var t, n, a, o, u, s, l, c = r.model, d = r.output, f = r.inputs.source.output, p = c.strides.source, m = r.inputs.amount.output, g = c.strides.amount;
        ...
        }, i.ugenDefaults("flock.ugen.distortion.tarrabiaDeJonge", {
            rate: "audio",
            inputs: {
                source: null,
                amount: 10
    ...
    !function() {
        ...
        }), i.ugen.env = {}, i.ugen.env.simpleASR = i.ugen.asr, i.ugenDefaults("flock.ugen.env.simpleASR", r.copy(i.ugenDefaults("flock.ugen.asr"))), 
        i.ugen.envGen = function(e, t, n) {
            var r = i.ugen(e, t, n);
            return r.krGen = function(e) {
    ...
    return function() {
        ...
        r.registerNamespace("flock.ugen"), i.ugen.scope = function(e, t, n) {
            ...
            var n = e[t.dimension](), r = e.offset(), a = t.mousePosition;
            return r && (a -= r[t.offsetProp]), a / n;
