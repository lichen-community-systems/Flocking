...
!function() {
    ...
    if (!e.FFT) {
        var t = function(e, t, n, o, r, a, i) {
            ...
            for (var l, u, s, f, c, d, m, h, p, k, g, v, b, y, w, A, N, M, S, I, C, x, L, D, F, P, O, R, T, B, E, V, U, q, G, _, W, z, j = 0, H = 0, K = 0, J = 0, Q = 2 * o, X = 3 * o, Y = 4 * o, $ = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, oe = r[o * i], re = a[o * i], ae = r[2 * o * i], ie = a[2 * o * i], le = .4472135954999579, ue = $ + i; $ < ue; ) O = e[$] * le, 
