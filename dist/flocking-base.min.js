...
!function() {
    ...
    if (!e.FFT) {
        var t = function(e, t, n, o, r, a, i) {
            ...
            for (var l, u, s, f, c, d, m, h, p, k, g, v, b, y, w, A, N = 0, M = 0, S = 2 * o, C = n, I = n + i, x = n + 2 * i, L = a[o * i], D = .5773502691896258, F = C + i; C < F; ) p = e[C] * D, 
            k = t[C] * D, g = e[I] * D, v = t[I] * D, b = e[x] * D, y = t[x] * D, w = r[N], 
            ...
            for (var u, s, f, c, d, m, h, p, k, g, v, b, y, w, A, N, M, S, C, I, x, L, D = 0, F = 0, P = 0, O = 2 * o, T = 3 * o, R = n, B = n + i, E = n + 2 * i, V = n + 3 * i, U = R + i; R < U; ) y = .5 * e[R], 
            w = .5 * t[R], A = .5 * e[B], N = .5 * t[B], M = .5 * e[E], S = .5 * t[E], C = .5 * e[V], 
            I = .5 * t[V], u = A * (x = r[D]) - N * (L = a[D]), s = A * L + N * x, v = y - (f = M * (x = r[F]) - S * (L = a[F])), 
            b = w - (c = M * L + S * x), y += f, w += c, h = u + (d = C * (x = r[P]) - I * (L = a[P])), 
            p = s + (m = C * L + I * x), k = u - d, g = s - m, e[E] = y - h, t[E] = w - p, e[R] = y + h, 
            t[R] = w + p, l ? (e[B] = v - g, t[B] = b + k, e[V] = v + g, t[V] = b - k) : (e[B] = v + g, 
            t[B] = b - k, e[V] = v - g, t[V] = b + k), D += o, F += O, P += T, ++R, ++B, ++E, 
            ++V;
        }, r = function(e, t, n, o, r, a, i) {
            for (var l, u, s, f, c, d, m, h, p, k, g, v, b, y, w, A, N, M, S, C, I, x, L, D, F, P, O, T, R, B, E, V, U, G, q, _, W, z, j = 0, H = 0, K = 0, J = 0, Q = 2 * o, X = 3 * o, Y = 4 * o, $ = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, oe = r[o * i], re = a[o * i], ae = r[2 * o * i], ie = a[2 * o * i], le = .4472135954999579, ue = $ + i; $ < ue; ) O = e[$] * le, 
            T = t[$] * le, R = e[Z] * le, B = t[Z] * le, E = e[ee] * le, V = t[ee] * le, U = e[te] * le, 
            G = t[te] * le, q = e[ne] * le, _ = t[ne] * le, l = O, u = T, s = R * (W = r[j]) - B * (z = a[j]), 
            f = R * z + B * W, c = E * (W = r[H]) - V * (z = a[H]), d = E * z + V * W, m = U * (W = r[K]) - G * (z = a[K]), 
            h = U * z + G * W, w = s + (p = q * (W = r[J]) - _ * (z = a[J])), A = f + (k = q * z + _ * W), 
            I = s - p, x = f - k, N = c + m, M = d + h, S = c - m, C = d - h, e[$] = O + w + N, 
            t[$] = T + A + M, g = l + w * oe + N * ae, v = u + A * oe + M * ae, b = x * re + C * ie, 
            y = -I * re - S * ie, e[Z] = g - b, t[Z] = v - y, e[ne] = g + b, t[ne] = v + y, 
...
fluid.defaults("flock.midi.system", {
    ...
    var t, n = [], o = e.channel ? e.channel : 0;
    switch (e.type) {
      case "noteOn":
      ...
      case "songPointer":
        o = 2, t = 15, n = flock.midi.write.valueToTwoByteArray(e.value);
        break;

      case "songSelect":
        o = 3, t = 15, n = flock.midi.write.valueToTwoByteArray(e.value);
        break;
    ...
    return (e = new Uint8Array(n.length + 1))[0] = (t << 4) + o, n && e.set(n, 1), e;
