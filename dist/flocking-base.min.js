            ...
            switch (n = k, h) {
              ...
              case 4:
                !function(e, t, n, o, r, a, i, l) {
                    for (var u, s, f, c, d, m, h, p, k, g, v, y, b, w, A, N, M, S, C, I, x, D, L = 0, F = 0, P = 0, O = 2 * o, B = 3 * o, T = n, R = n + i, E = n + 2 * i, V = n + 3 * i, U = T + i; T < U; ) b = .5 * e[T], 
                    w = .5 * t[T], A = .5 * e[R], N = .5 * t[R], M = .5 * e[E], S = .5 * t[E], C = .5 * e[V], 
                    I = .5 * t[V], u = A * (x = r[L]) - N * (D = a[L]), s = A * D + N * x, v = b - (f = M * (x = r[F]) - S * (D = a[F])), 
                    y = w - (c = M * D + S * x), b += f, w += c, h = u + (d = C * (x = r[P]) - I * (D = a[P])), 
                    p = s + (m = C * D + I * x), k = u - d, g = s - m, e[E] = b - h, t[E] = w - p, e[T] = b + h, 
                    t[T] = w + p, l ? (e[R] = v - g, t[R] = y + k, e[V] = v + g, t[V] = y - k) : (e[R] = v + g, 
                    t[R] = y - k, e[V] = v - g, t[V] = y + k), L += o, F += O, P += B, ++T, ++R, ++E, 
                    ++V;
                }(e, t, n, i, f, c, p, m);
                break;
              ...
              case 5:
                !function(e, t, n, o, r, a, i) {
                    for (var l, u, s, f, c, d, m, h, p, k, g, v, y, b, w, A, N, M, S, C, I, x, D, L, F, P, O, B, T, R, E, V, U, q, G, _, W, z, j = 0, H = 0, K = 0, J = 0, Q = 2 * o, X = 3 * o, Y = 4 * o, $ = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, oe = r[o * i], re = a[o * i], ae = r[2 * o * i], ie = a[2 * o * i], le = .4472135954999579, ue = $ + i; $ < ue; ) O = e[$] * le, 
                    B = t[$] * le, T = e[Z] * le, R = t[Z] * le, E = e[ee] * le, V = t[ee] * le, U = e[te] * le, 
                    q = t[te] * le, G = e[ne] * le, _ = t[ne] * le, l = O, u = B, s = T * (W = r[j]) - R * (z = a[j]), 
                    f = T * z + R * W, c = E * (W = r[H]) - V * (z = a[H]), d = E * z + V * W, m = U * (W = r[K]) - q * (z = a[K]), 
