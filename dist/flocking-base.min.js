            ...
            switch (n = k, h) {
              ...
              case 4:
                !function(e, t, n, o, r, a, i, l) {
                    for (var u, s, f, c, d, m, h, p, k, g, v, b, y, w, A, N, M, S, C, I, x, L, D = 0, F = 0, P = 0, O = 2 * o, R = 3 * o, T = n, B = n + i, E = n + 2 * i, V = n + 3 * i, U = T + i; T < U; ) y = .5 * e[T], 
                    w = .5 * t[T], A = .5 * e[B], N = .5 * t[B], M = .5 * e[E], S = .5 * t[E], C = .5 * e[V], 
                    I = .5 * t[V], u = A * (x = r[D]) - N * (L = a[D]), s = A * L + N * x, v = y - (f = M * (x = r[F]) - S * (L = a[F])), 
                    b = w - (c = M * L + S * x), y += f, w += c, h = u + (d = C * (x = r[P]) - I * (L = a[P])), 
                    p = s + (m = C * L + I * x), k = u - d, g = s - m, e[E] = y - h, t[E] = w - p, e[T] = y + h, 
              ...
              case 5:
                !function(e, t, n, o, r, a, i) {
                    for (var l, u, s, f, c, d, m, h, p, k, g, v, b, y, w, A, N, M, S, C, I, x, L, D, F, P, O, R, T, B, E, V, U, q, G, _, W, z, j = 0, H = 0, K = 0, J = 0, Q = 2 * o, X = 3 * o, Y = 4 * o, $ = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, oe = r[o * i], re = a[o * i], ae = r[2 * o * i], ie = a[2 * o * i], le = .4472135954999579, ue = $ + i; $ < ue; ) O = e[$] * le, 
                    R = t[$] * le, T = e[Z] * le, B = t[Z] * le, E = e[ee] * le, V = t[ee] * le, U = e[te] * le, 
                    q = t[te] * le, G = e[ne] * le, _ = t[ne] * le, l = O, u = R, s = T * (W = r[j]) - B * (z = a[j]), 
                    f = T * z + B * W, c = E * (W = r[H]) - V * (z = a[H]), d = E * z + V * W, m = U * (W = r[K]) - q * (z = a[K]), 
                    h = U * z + q * W, w = s + (p = G * (W = r[J]) - _ * (z = a[J])), A = f + (k = G * z + _ * W), 
                    I = s - p, x = f - k, N = c + m, M = d + h, S = c - m, C = d - h, e[$] = O + w + N, 
                    t[$] = R + A + M, g = l + w * oe + N * ae, v = u + A * oe + M * ae, b = x * re + C * ie, 
