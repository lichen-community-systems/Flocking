...
!function(e, t) {
    ...
    function q(e, t, n) {
        var r, o = at(e), a = D(e, t, o), i = "border-box" === pe.css(e, "boxSizing", !1, o);
    ...
    var ye = function(e) {
        function t(e, t, n, r) {
            ...
            if (!r && ((t ? t.ownerDocument || t : B) !== O && P(t), t = t || O, L)) {
        ...
        function y(e, n) {
            var o = n.length > 0, a = e.length > 0, i = function(r, i, u, l, s) {
                ...
                for (s && (T = i === O || i || s); m !== S && null != (c = k[m]); m++) {
                    if (a && c) {
                        for (f = 0, i || c.ownerDocument === O || (P(c), u = !L); d = e[f++]; ) if (d(c, i || O, u)) {
                            l.push(c);
                            break;
                        }
                        s && (_ = b);
        ...
        var k, b, x, S, C, w, A, N, T, I, M, P, O, D, L, R, E, V, F, q = "sizzle" + 1 * new Date(), B = e.document, _ = 0, G = 0, j = n(), U = n(), H = n(), W = function(e, t) {
            return e === t && (M = !0), 0;
        ...
        b = t.support = {}, C = t.isXML = function(e) {
            ...
            return r !== O && 9 === r.nodeType && r.documentElement ? (O = r, D = O.documentElement, 
            L = !C(O), B !== O && (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", xe, !1) : n.attachEvent && n.attachEvent("onunload", xe)), 
            b.attributes = o(function(e) {
            ...
            }, E = [], R = [], (b.qsa = me.test(O.querySelectorAll)) && (o(function(e) {
                ...
                D.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(":disabled").length && R.push(":enabled", ":disabled"), 
                e.querySelectorAll("*,:x"), R.push(",.*:");
            })), (b.matchesSelector = me.test(V = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && o(function(e) {
                b.disconnectedMatch = V.call(e, "*"), V.call(e, "[s!='']:x"), E.push("!=", re);
            }), R = R.length && new RegExp(R.join("|")), E = E.length && new RegExp(E.join("|")), 
            t = me.test(D.compareDocumentPosition), F = t || me.test(D.contains) ? function(e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === O || e.ownerDocument === B && F(B, e) ? -1 : t === O || t.ownerDocument === B && F(B, t) ? 1 : I ? Y(I, e) - Y(I, t) : 0 : 4 & n ? -1 : 1);
            } : function(e, t) {
                if (e === t) return M = !0, 0;
                var n, r = 0, o = e.parentNode, a = t.parentNode, u = [ e ], l = [ t ];
                if (!o || !a) return e === O ? -1 : t === O ? 1 : o ? -1 : a ? 1 : I ? Y(I, e) - Y(I, t) : 0;
                if (o === a) return i(e, t);
            ...
            if ((e.ownerDocument || e) !== O && P(e), n = n.replace(le, "='$1']"), b.matchesSelector && L && !H[n + " "] && (!E || !E.test(n)) && (!R || !R.test(n))) try {
                var r = V.call(e, n);
    ...
    var Oe = function(e, t, n, r, o, a, i) {
        var u = 0, l = e.length, s = null == n;
        if ("object" === pe.type(n)) {
            o = !0;
            for (u in n) Oe(e, t, u, n[u], !0, a, i);
    ...
    pe.extend({
        ...
        cleanData: function(e) {
            for (var t, n, r, o = pe.event.special, a = 0; void 0 !== (n = e[a]); a++) if (De(n)) {
                if (t = n[Le.expando]) {
    ...
    pe.extend({
        ...
        css: function(e, t, n, r) {
            ...
            void 0 === o && (o = D(e, t, r)), "normal" === o && t in st && (o = st[t]), "" === n || n ? (a = parseFloat(o), 
        ...
        if (t) return (parseFloat(D(e, "marginLeft")) || e.getBoundingClientRect().left - Ge(e, {
            marginLeft: 0
        }, function() {
    ...
    pe.extend(pe.event, {
        trigger: function(t, n, r, o) {
            ...
            f = pe.event.special[p] || {}, o || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                ...
                (c = s && i[s]) && c.apply && De(i) && (t.result = c.apply(i, n), !1 === t.result && t.preventDefault());
                return t.type = p, o || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(d.pop(), n) || !De(r) || s && pe.isFunction(r[p]) && !pe.isWindow(r) && ((u = r[s]) && (r[s] = null), 
        ...
        ajax: function(t, n) {
            ...
            var o, a, i, u, l, s, c, f, d, p, m = pe.ajaxSetup({}, n), g = m.context || m, h = m.context && (g.nodeType || g.jquery) ? pe(g) : pe.event, v = pe.Deferred(), y = pe.Callbacks("once memory"), k = m.statusCode || {}, b = {}, x = {}, S = "canceled", C = {
                ...
                getResponseHeader: function(e) {
                    var t;
                    if (c) {
                        if (!u) for (u = {}; t = Dt.exec(i); ) u[t[1].toLowerCase()] = t[2];
                        t = u[e.toLowerCase()];
                    }
            ...
            m.data && (a += (wt.test(a) ? "&" : "?") + m.data, delete m.data), !1 === m.cache && (a = a.replace(Ot, "$1"), 
    ...
    pe.ajaxSetup({
        ...
        pe.cssHooks[t] = L(de.pixelPosition, function(e, n) {
            if (n) return n = D(e, t), ot.test(n) ? pe(e).position()[t] + "px" : n;
        });
    }), pe.each({
        Height: "height",
        Width: "width"
...
!function(e, t) {
    ...
    if (!e.FFT) {
        var t = function(e, t, n, r, o, a, i) {
            ...
            for (var l, s, c, f, d, p, m, g, h, v, y, k, b, x, S, C, w, A, N, T, I, M, P = 0, O = 0, D = 0, L = 2 * r, R = 3 * r, E = n, V = n + i, F = n + 2 * i, q = n + 3 * i, B = E + i; E < B; ) b = .5 * e[E], 
            ...
            for (var u, l, s, c, f, d, p, m, g, h, v, y, k, b, x, S, C, w, A, N, T, I, M, P, O, D, L, R, E, V, F, q, B, _, G, j, U, H, W = 0, z = 0, $ = 0, K = 0, J = 2 * r, X = 3 * r, Q = 4 * r, Y = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, re = o[r * i], oe = a[r * i], ae = o[2 * r * i], ie = a[2 * r * i], ue = .4472135954999579, le = Y + i; Y < le; ) L = e[Y] * ue, 
...
!function() {
    ...
    flock.ugen.playBuffer = function(e, t, n) {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i, u, l, s, c, f, d = r.model, p = d.strides, m = r.output, g = r.inputs, h = r.buffers, v = h.length - 1, y = d.prevTrigger, k = d.maxVoices, b = d.activeVoices, x = d.freeVoices, S = g.trigger.output, C = p.trigger, w = 0, A = g.bufferIndex.output, N = p.bufferIndex, T = 0, I = g.speed.output, M = p.speed, P = 0, O = r.inputs.channel.output[0];
            for (t = 0; t < e; t++) {
