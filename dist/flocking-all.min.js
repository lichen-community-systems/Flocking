...
!function(e, t) {
    ...
    var $ = [], K = e.document, J = $.slice, X = $.concat, Q = $.push, Y = $.indexOf, Z = {}, ee = Z.toString, te = Z.hasOwnProperty, ne = {}, re = function(e, t) {
    ...
    re.fn = re.prototype = {
        ...
        proxy: function(e, t) {
            var n, r, o;
            if ("string" == typeof t && (n = e[t], t = e, e = n), re.isFunction(e)) return r = J.call(arguments, 2), 
            o = function() {
    ...
    var se = function(e) {
        function t(e, t, n, r) {
            ...
            if (!r && ((t ? t.ownerDocument || t : q) !== P && M(t), t = t || P, D)) {
                if (11 !== g && (f = ge.exec(e))) if (o = f[1]) {
                    ...
                    if ((o = f[3]) && k.getElementsByClassName && t.getElementsByClassName) return X.apply(n, t.getElementsByClassName(o)), 
                    n;
                }
                if (k.qsa && !U[e + " "] && (!L || !L.test(e))) {
                    ...
                    if (p) try {
                        return X.apply(n, m.querySelectorAll(p)), n;
                    } catch (e) {} finally {
        ...
        function g(e, t, n, o, a, i) {
            return o && !o[F] && (o = g(o)), a && !a[F] && (a = g(a, i)), r(function(r, i, u, s) {
                ...
                } else k = m(k === i ? k.splice(h, k.length) : k), a ? a(null, i, k, s) : X.apply(i, k);
            });
        }
        function h(e) {
        ...
        function v(e, n) {
            var o = n.length > 0, a = e.length > 0, i = function(r, i, u, s, l) {
                ...
                if (p += g, o && g !== p) {
                    ...
                    X.apply(s, v), l && !r && v.length > 0 && p + n.length > 1 && t.uniqueSort(s);
                }
                return l && (B = x, N = y), h;
            };
            return o ? r(i) : i;
        ...
        var y, k, b, x, S, w, C, A, N, T, I, M, P, O, D, L, R, E, V, F = "sizzle" + 1 * new Date(), q = e.document, B = 0, _ = 0, G = n(), j = n(), U = n(), H = function(e, t) {
            return e === t && (I = !0), 0;
        }, W = 1 << 31, z = {}.hasOwnProperty, $ = [], K = $.pop, J = $.push, X = $.push, Q = $.slice, Y = function(e, t) {
        ...
        return l.prototype = b.filters = b.pseudos, b.setFilters = new l(), w = t.tokenize = function(e, n) {
            ...
            if (n = n || [], 1 === d.length) {
                ...
                for (o = fe.needsContext.test(e) ? 0 : a.length; o-- && (i = a[o], !b.relative[u = i.type]); ) if ((l = b.find[u]) && (r = l(i.matches[0].replace(ye, ke), he.test(a[0].type) && s(t.parentNode) || t))) {
                    if (a.splice(o, 1), !(e = r.length && c(a))) return X.apply(n, r), n;
                    break;
                }
            }
    ...
    re.Callbacks = function(e) {
        ...
        when: function(e) {
            var t, n, r, o = 0, a = J.call(arguments), i = a.length, u = 1 !== i || e && re.isFunction(e.promise) ? i : 0, s = 1 === u ? e : re.Deferred(), l = function(e, n, r) {
                return function(o) {
                    n[e] = this, r[e] = arguments.length > 1 ? J.call(arguments) : o, r === t ? s.notifyWith(n, r) : --u || s.resolveWith(n, r);
                };
            };
    ...
    re.event = {
        ...
        dispatch: function(e) {
            e = re.event.fix(e);
            var t, n, r, o, a, i = [], u = J.call(arguments), s = (Se.get(this, "events") || {})[e.type] || [], l = re.event.special[e.type] || {};
    ...
    !function() {
        ...
        i.appendChild(u), re.extend(ne, {
            ...
            reliableMarginRight: function() {
                ...
                n.style.marginRight = n.style.width = "0", u.style.width = "1px", Je.appendChild(i), 
                t = !parseFloat(e.getComputedStyle(n).marginRight), Je.removeChild(i), u.removeChild(n), 
                t;
            }
        }));
    }();
    ...
    re.extend({
        ...
        re.cssHooks[t] = {
            get: function(e, n, r) {
                if (n) return Xe.test(re.css(e, "display")) && 0 === e.offsetWidth ? Ke(e, Qe, function() {
                    return O(e, t, r);
                }) : O(e, t, r);
            },
            set: function(e, n, r) {
...
!function(e, t) {
    ...
    if (!e.FFT) {
        var t = function(e, t, n, r, o, a, i) {
            ...
            for (var u, s, l, c, f, d, p, m, g, h, v, y, k, b, x, S, w, C, A, N, T, I, M, P, O, D, L, R, E, V, F, q, B, _, G, j, U, H, W = 0, z = 0, $ = 0, K = 0, J = 2 * r, X = 3 * r, Q = 4 * r, Y = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, re = o[r * i], oe = a[r * i], ae = o[2 * r * i], ie = a[2 * r * i], ue = .4472135954999579, se = Y + i; Y < se; ) L = e[Y] * ue, 
...
!function() {
    ...
    flock.ugen.distortion = function(e, t, n) {
        ...
        return r.gen = function(e) {
            ...
            for (n = o = 0; n < e; n++, o += s) t = Math.tanh(u[o]), i[n] = t;
