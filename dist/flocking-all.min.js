            ...
            switch (n = h, m) {
              ...
              case 4:
                !function(e, t, n, r, o, a, i, u) {
                    for (var l, s, c, f, d, p, m, g, h, v, y, k, b, x, S, w, C, A, N, T, I, M, P = 0, O = 0, D = 0, L = 2 * r, E = 3 * r, R = n, V = n + i, F = n + 2 * i, q = n + 3 * i, B = R + i; R < B; ) b = .5 * e[R], 
                    x = .5 * t[R], S = .5 * e[V], w = .5 * t[V], C = .5 * e[F], A = .5 * t[F], N = .5 * e[q], 
                    T = .5 * t[q], l = S * (I = o[P]) - w * (M = a[P]), s = S * M + w * I, y = b - (c = C * (I = o[O]) - A * (M = a[O])), 
                    ...
                    t[V] = k - h, e[q] = y - v, t[q] = k + h), P += r, O += L, D += E, ++R, ++V, ++F, 
                    ++q;
                }(e, t, n, i, c, f, g, p);
                break;
              ...
              case 5:
                !function(e, t, n, r, o, a, i) {
                    for (var u, l, s, c, f, d, p, m, g, h, v, y, k, b, x, S, w, C, A, N, T, I, M, P, O, D, L, E, R, V, F, q, B, _, G, j, U, H, W = 0, z = 0, $ = 0, K = 0, J = 2 * r, X = 3 * r, Q = 4 * r, Y = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, re = o[r * i], oe = a[r * i], ae = o[2 * r * i], ie = a[2 * r * i], ue = .4472135954999579, le = Y + i; Y < le; ) L = e[Y] * ue, 
