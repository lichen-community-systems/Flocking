...
!function(e, t) {
    ...
    function u(e) {
        var t = {};
        return pe.each(e.match(Ie) || [], function(e, n) {
            t[n] = !0;
        }), t;
    }
    function l(e) {
    ...
    function c(e, t, n, r) {
        var o;
        try {
            e && pe.isFunction(o = e.promise) ? o.call(e).done(t).fail(n) : e && pe.isFunction(o = e.then) ? o.call(e, t, n) : t.apply(void 0, [ e ].slice(r));
        } catch (e) {
            n.apply(void 0, [ e ]);
        }
    }
    ...
    function g(e, t, n, r) {
        var o, a = 1, i = 20, u = r ? function() {
            ...
            return pe.css(e, t, "");
        }, l = u(), s = n && n[3] || (pe.cssNumber[t] ? "" : "px"), c = (pe.cssNumber[t] || "px" !== s && +l) && Be.exec(pe.css(e, t));
        if (c && c[3] !== s) {
            s = s || c[3], n = n || [], c = +l || 1;
            do {
                c /= a = a || ".5", pe.style(e, t, c + s);
            } while (a !== (a = u() / l) && 1 !== a && --i);
        }
    ...
    function h(e) {
        ...
        return o || (t = n.body.appendChild(n.createElement(r)), o = pe.css(t, "display"), 
        t.parentNode.removeChild(t), "none" === o && (o = "block"), je[r] = o, o);
    }
    function v(e, t) {
        for (var n, r, o = [], a = 0, i = e.length; a < i; a++) (r = e[a]).style && (n = r.style.display, 
        t ? ("none" === n && (o[a] = Le.get(r, "display") || null, o[a] || (r.style.display = "")), 
        "" === r.style.display && _e(r) && (o[a] = h(r))) : "none" !== n && (o[a] = "none", 
        Le.set(r, "display", n)));
    ...
    function b(e, t, n, r, o) {
        for (var a, i, u, l, s, c, f = t.createDocumentFragment(), d = [], p = 0, m = e.length; p < m; p++) if ((a = e[p]) || 0 === a) if ("object" === pe.type(a)) pe.merge(d, a.nodeType ? [ a ] : a); else if ($e.test(a)) {
            for (i = i || f.appendChild(t.createElement("div")), u = (He.exec(a) || [ "", "" ])[1].toLowerCase(), 
            l = ze[u] || ze._default, i.innerHTML = l[1] + pe.htmlPrefilter(a) + l[2], c = l[0]; c--; ) i = i.lastChild;
            pe.merge(d, i.childNodes), (i = f.firstChild).textContent = "";
        } else d.push(t.createTextNode(a));
        for (f.textContent = "", p = 0; a = d[p++]; ) if (r && pe.inArray(a, r) > -1) o && o.push(a); else if (s = pe.contains(a.ownerDocument, a), 
        i = y(f.appendChild(a), "script"), s && k(i), n) for (c = 0; a = i[c++]; ) We.test(a.type || "") && n.push(a);
        return f;
    }
    function x() {
        return !0;
    ...
    function C(e, t, n, r, o, a) {
        ...
        }).guid = i.guid || (i.guid = pe.guid++)), e.each(function() {
    ...
    function I(e, t) {
        var n, r, o, a, i, u, l, s;
        if (1 === t.nodeType) {
            if (Le.hasData(e) && (a = Le.access(e), i = Le.set(t, a), s = a.events)) {
                delete i.handle, i.events = {};
                for (o in s) for (n = 0, r = s[o].length; n < r; n++) pe.event.add(t, o, s[o][n]);
            }
            Re.hasData(e) && (u = Re.access(e), l = pe.extend({}, u), Re.set(t, l));
        }
    }
    function M(e, t) {
    ...
    function P(e, t, r, o) {
        t = oe.apply([], t);
        var a, i, u, l, s, c, f = 0, d = e.length, p = d - 1, m = t[0], g = pe.isFunction(m);
        if (g || d > 1 && "string" == typeof m && !de.checkClone && et.test(m)) return e.each(function(n) {
            var a = e.eq(n);
            g && (t[0] = m.call(this, n, a.html())), P(a, t, r, o);
        });
        if (d && (a = b(t, e[0].ownerDocument, !1, e, o), i = a.firstChild, 1 === a.childNodes.length && (a = i), 
        i || o)) {
            for (l = (u = pe.map(y(a, "script"), T)).length; f < d; f++) s = a, f !== p && (s = pe.clone(s, !0, !0), 
            l && pe.merge(u, y(s, "script"))), r.call(e[f], s, f);
            if (l) for (c = u[u.length - 1].ownerDocument, pe.map(u, N), f = 0; f < l; f++) s = u[f], 
            We.test(s.type || "") && !Le.access(s, "globalEval") && pe.contains(c, s) && (s.src ? pe._evalUrl && pe._evalUrl(s.src) : n(s.textContent.replace(nt, ""), c));
        }
        return e;
    }
    function D(e, t, n) {
        for (var r, o = t ? pe.filter(t, e) : e, a = 0; null != (r = o[a]); a++) n || 1 !== r.nodeType || pe.cleanData(y(r)), 
        r.parentNode && (n && pe.contains(r.ownerDocument, r) && k(y(r, "script")), r.parentNode.removeChild(r));
        return e;
    }
    function O(e, t, n) {
        var r, o, a, i, u = e.style;
        return (n = n || at(e)) && ("" !== (i = n.getPropertyValue(t) || n[t]) || pe.contains(e.ownerDocument, e) || (i = pe.style(e, t)), 
        !de.pixelMarginRight() && ot.test(i) && rt.test(t) && (r = u.width, o = u.minWidth, 
    ...
    function F(e, t, n, r, o) {
        var a, i = 0;
        for (a = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0; a < 4; a += 2) "margin" === n && (i += pe.css(e, n + qe[a], !0, o)), 
        r ? ("content" === n && (i -= pe.css(e, "padding" + qe[a], !0, o)), "margin" !== n && (i -= pe.css(e, "border" + qe[a] + "Width", !0, o))) : (i += pe.css(e, "padding" + qe[a], !0, o), 
        "padding" !== n && (i += pe.css(e, "border" + qe[a] + "Width", !0, o)));
        return i;
    }
    function B(e, t, n) {
        var r, o = at(e), a = O(e, t, o), i = "border-box" === pe.css(e, "boxSizing", !1, o);
        return ot.test(a) ? a : (r = i && (de.boxSizingReliable() || a === e.style[t]), 
        "auto" === a && (a = e["offset" + t[0].toUpperCase() + t.slice(1)]), (a = parseFloat(a) || 0) + F(e, t, n || (i ? "border" : "content"), r, o) + "px");
    }
    function q(e, t, n, r, o) {
        return new q.prototype.init(e, t, n, r, o);
    }
    function _() {
        pt && (!1 === te.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(_) : e.setTimeout(_, pe.fx.interval), 
        pe.fx.tick());
    }
    function G() {
    ...
    function U(e, t, n) {
        for (var r, o = (W.tweeners[t] || []).concat(W.tweeners["*"]), a = 0, i = o.length; a < i; a++) if (r = o[a].call(n, t, e)) return r;
    }
    function H(e, t) {
        var n, r, o, a, i;
        for (n in e) if (r = pe.camelCase(n), o = t[r], a = e[n], Array.isArray(a) && (o = a[1], 
        a = e[n] = a[0]), n !== r && (e[r] = a, delete e[n]), (i = pe.cssHooks[r]) && "expand" in i) {
            a = i.expand(a), delete e[r];
            for (n in a) n in e || (e[n] = a[n], t[n] = o);
        } else t[r] = o;
    }
    function W(e, t, n) {
        var r, o, a = 0, i = W.prefilters.length, u = pe.Deferred().always(function() {
            delete l.elem;
        }), l = function() {
            if (o) return !1;
            for (var t = dt || G(), n = Math.max(0, s.startTime + s.duration - t), r = 1 - (n / s.duration || 0), a = 0, i = s.tweens.length; a < i; a++) s.tweens[a].run(r);
            return u.notifyWith(e, [ s, r, n ]), r < 1 && i ? n : (i || u.notifyWith(e, [ s, 1, 0 ]), 
            u.resolveWith(e, [ s ]), !1);
        }, s = u.promise({
            elem: e,
            props: pe.extend({}, t),
            ...
            createTween: function(t, n) {
                var r = pe.Tween(e, s.opts, t, n, s.opts.specialEasing[t] || s.opts.easing);
        ...
        for (H(c, s.opts.specialEasing); a < i; a++) if (r = W.prefilters[a].call(s, e, c, s.opts)) return pe.isFunction(r.stop) && (pe._queueHooks(s.elem, s.opts.queue).stop = pe.proxy(r.stop, r)), 
        r;
        return pe.map(c, U, s), pe.isFunction(s.opts.start) && s.opts.start.call(e, s), 
    ...
    function K(e, t, n, r) {
        ...
        }); else if (n || "object" !== pe.type(t)) r(e, t); else for (o in t) K(e + "[" + o + "]", t[o], n, r);
    }
    function J(e) {
        return function(t, n) {
            "string" != typeof t && (n = t, t = "*");
            var r, o = 0, a = t.toLowerCase().match(Ie) || [];
            if (pe.isFunction(n)) for (;r = a[o++]; ) "+" === r[0] ? (r = r.slice(1) || "*", 
    ...
    function X(e, t, n, r) {
        function o(u) {
            var l;
            return a[u] = !0, pe.each(e[u] || [], function(e, u) {
                var s = u(t, n, r);
                return "string" != typeof s || i || a[s] ? i ? !(l = s) : void 0 : (t.dataTypes.unshift(s), 
                o(s), !1);
            }), l;
        }
        var a = {}, i = e === Ft;
    ...
    var ee = [], te = e.document, ne = Object.getPrototypeOf, re = ee.slice, oe = ee.concat, ae = ee.push, ie = ee.indexOf, ue = {}, le = ue.toString, se = ue.hasOwnProperty, ce = se.toString, fe = ce.call(Object), de = {}, pe = function(e, t) {
        return new pe.fn.init(e, t);
    }, me = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, ge = /^-ms-/, he = /-([a-z])/g, ve = function(e, t) {
    ...
    pe.fn = pe.prototype = {
        ...
        for ("boolean" == typeof i && (s = i, i = arguments[u] || {}, u++), "object" == typeof i || pe.isFunction(i) || (i = {}), 
        u === l && (i = this, u--); u < l; u++) if (null != (e = arguments[u])) for (t in e) n = i[t], 
        i !== (r = e[t]) && (s && r && (pe.isPlainObject(r) || (o = Array.isArray(r))) ? (o ? (o = !1, 
        a = n && Array.isArray(n) ? n : []) : a = n && pe.isPlainObject(n) ? n : {}, i[t] = pe.extend(s, a, r)) : void 0 !== r && (i[t] = r));
        return i;
    }, pe.extend({
        ...
        isPlainObject: function(e) {
            var t, n;
            return !(!e || "[object Object]" !== le.call(e)) && (!(t = ne(e)) || "function" == typeof (n = se.call(t, "constructor") && t.constructor) && ce.call(n) === fe);
        },
        ...
        camelCase: function(e) {
            return e.replace(ge, "ms-").replace(he, ve);
        },
        each: function(e, t) {
            var n, o = 0;
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (r(Object(e)) ? pe.merge(n, "string" == typeof e ? [ e ] : e) : ae.call(n, e)), 
            n;
        },
        ...
        map: function(e, t, n) {
            var o, a, i = 0, u = [];
            if (r(e)) for (o = e.length; i < o; i++) null != (a = t(e[i], i, n)) && u.push(a); else for (i in e) null != (a = t(e[i], i, n)) && u.push(a);
            return oe.apply([], u);
        },
        guid: 1,
        proxy: function(e, t) {
    ...
    var ye = function(e) {
        function t(e, t, n, r) {
            var o, a, i, u, l, c, d, p = t && t.ownerDocument, m = t ? t.nodeType : 9;
            if (n = n || [], "string" != typeof e || !e || 1 !== m && 9 !== m && 11 !== m) return n;
            if (!r && ((t ? t.ownerDocument || t : q) !== D && P(t), t = t || D, L)) {
                if (11 !== m && (l = ge.exec(e))) if (o = l[1]) {
                    if (9 === m) {
                        if (!(i = t.getElementById(o))) return n;
                        if (i.id === o) return n.push(i), n;
                    } else if (p && (i = p.getElementById(o)) && F(t, i) && i.id === o) return n.push(i), 
                    n;
                } else {
                    if (l[2]) return X.apply(n, t.getElementsByTagName(e)), n;
                    if ((o = l[3]) && b.getElementsByClassName && t.getElementsByClassName) return X.apply(n, t.getElementsByClassName(o)), 
                    n;
                }
                if (b.qsa && !H[e + " "] && (!R || !R.test(e))) {
                    if (1 !== m) p = t, d = e; else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((u = t.getAttribute("id")) ? u = u.replace(ke, be) : t.setAttribute("id", u = B), 
                        a = (c = C(e)).length; a--; ) c[a] = "#" + u + " " + f(c[a]);
                        d = c.join(","), p = he.test(e) && s(t.parentNode) || t;
                    }
                    if (d) try {
        ...
        function d(e, t, n) {
            var r = t.dir, o = t.next, a = o || r, i = n && "parentNode" === a, u = G++;
            return t.first ? function(t, n, o) {
                ...
                } else for (;t = t[r]; ) if (1 === t.nodeType || i) if (f = t[B] || (t[B] = {}), 
                c = f[t.uniqueID] || (f[t.uniqueID] = {}), o && o === t.nodeName.toLowerCase()) t = t[r] || t; else {
                    if ((s = c[a]) && s[0] === _ && s[1] === u) return d[2] = s[2];
        ...
        function h(e, t, n, o, a, i) {
            return o && !o[B] && (o = h(o)), a && !a[B] && (a = h(a, i)), r(function(r, i, u, l) {
                var s, c, f, d = [], p = [], h = i.length, v = r || m(t || "*", u.nodeType ? [ u ] : u, []), y = !e || !r && t ? v : g(v, d, e, u, l), k = n ? a || (r ? e : h || o) ? [] : i : y;
                if (n && n(y, k, u, l), o) for (s = g(k, p), o(s, [], u, l), c = s.length; c--; ) (f = s[c]) && (k[p[c]] = !(y[p[c]] = f));
                if (r) {
                    if (a || e) {
                        if (a) {
                            for (s = [], c = k.length; c--; ) (f = k[c]) && s.push(y[c] = f);
                            a(null, k = [], s, l);
                        }
                        for (c = k.length; c--; ) (f = k[c]) && (s = a ? Y(r, f) : d[c]) > -1 && (r[s] = !(i[s] = f));
                    }
                } else k = g(k === i ? k.splice(h, k.length) : k), a ? a(null, i, k, l) : X.apply(i, k);
            });
        }
        function v(e) {
            for (var t, n, r, o = e.length, a = x.relative[e[0].type], i = a || x.relative[" "], u = a ? 1 : 0, l = d(function(e) {
                return e === t;
            }, i, !0), s = d(function(e) {
                return Y(t, e) > -1;
            }, i, !0), c = [ function(e, n, r) {
                var o = !a && (r || n !== N) || ((t = n).nodeType ? l(e, n, r) : s(e, n, r));
                return t = null, o;
            } ]; u < o; u++) if (n = x.relative[e[u].type]) c = [ d(p(c), n) ]; else {
                if ((n = x.filter[e[u].type].apply(null, e[u].matches))[B]) {
                    for (r = ++u; r < o && !x.relative[e[r].type]; r++) ;
                    return h(u > 1 && p(c), u > 1 && f(e.slice(0, u - 1).concat({
                        value: " " === e[u - 2].type ? "*" : ""
                    })).replace(ae, "$1"), n, u < r && v(e.slice(u, r)), r < o && v(e = e.slice(r)), r < o && f(e));
                }
                c.push(n);
            }
            return p(c);
        ...
        function y(e, n) {
            var o = n.length > 0, a = e.length > 0, i = function(r, i, u, l, s) {
                var c, f, d, p = 0, m = "0", h = r && [], v = [], y = N, k = r || a && x.find.TAG("*", s), b = _ += null == y ? 1 : Math.random() || .1, S = k.length;
                for (s && (N = i === D || i || s); m !== S && null != (c = k[m]); m++) {
                    if (a && c) {
                        for (f = 0, i || c.ownerDocument === D || (P(c), u = !L); d = e[f++]; ) if (d(c, i || D, u)) {
                            l.push(c);
                            break;
                        }
                        s && (_ = b);
                ...
                if (p += m, o && m !== p) {
                    ...
                    if (r) {
                        if (p > 0) for (;m--; ) h[m] || v[m] || (v[m] = K.call(l));
                        v = g(v);
                    }
                    X.apply(l, v), s && !r && v.length > 0 && p + n.length > 1 && t.uniqueSort(l);
                }
                return s && (_ = b, N = y), h;
            };
            return o ? r(i) : i;
        }
        var k, b, x, S, w, C, A, T, N, I, M, P, D, O, L, R, E, V, F, B = "sizzle" + 1 * new Date(), q = e.document, _ = 0, G = 0, j = n(), U = n(), H = n(), W = function(e, t) {
            return e === t && (M = !0), 0;
        }, z = {}.hasOwnProperty, $ = [], K = $.pop, J = $.push, X = $.push, Q = $.slice, Y = function(e, t) {
            for (var n = 0, r = e.length; n < r; n++) if (e[n] === t) return n;
            return -1;
        }, Z = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ee = "[\\x20\\t\\r\\n\\f]", te = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", ne = "\\[" + ee + "*(" + te + ")(?:" + ee + "*([*^$|!~]?=)" + ee + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + te + "))|)" + ee + "*\\]", re = ":(" + te + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ne + ")*)|.*)\\)|)", oe = new RegExp(ee + "+", "g"), ae = new RegExp("^" + ee + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ee + "+$", "g"), ie = new RegExp("^" + ee + "*," + ee + "*"), ue = new RegExp("^" + ee + "*([>+~]|" + ee + ")" + ee + "*"), le = new RegExp("=" + ee + "*([^\\]'\"]*?)" + ee + "*\\]", "g"), se = new RegExp(re), ce = new RegExp("^" + te + "$"), fe = {
            ID: new RegExp("^#(" + te + ")"),
            CLASS: new RegExp("^\\.(" + te + ")"),
            TAG: new RegExp("^(" + te + "|[*])"),
            ATTR: new RegExp("^" + ne),
        ...
        }, de = /^(?:input|select|textarea|button)$/i, pe = /^h\d$/i, me = /^[^{]+\{\s*\[native \w/, ge = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, he = /[+~]/, ve = new RegExp("\\\\([\\da-f]{1,6}" + ee + "?|(" + ee + ")|.)", "ig"), ye = function(e, t, n) {
            var r = "0x" + t - 65536;
        ...
        try {
            X.apply($ = Q.call(q.childNodes), q.childNodes), $[q.childNodes.length].nodeType;
        } catch (e) {
            X = {
        ...
        b = t.support = {}, w = t.isXML = function(e) {
            ...
            return r !== D && 9 === r.nodeType && r.documentElement ? (D = r, O = D.documentElement, 
            L = !w(D), q !== D && (n = D.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", xe, !1) : n.attachEvent && n.attachEvent("onunload", xe)), 
            b.attributes = o(function(e) {
                return e.className = "i", !e.getAttribute("className");
            }), b.getElementsByTagName = o(function(e) {
                return e.appendChild(D.createComment("")), !e.getElementsByTagName("*").length;
            }), b.getElementsByClassName = me.test(D.getElementsByClassName), b.getById = o(function(e) {
                return O.appendChild(e).id = B, !D.getElementsByName || !D.getElementsByName(B).length;
            ...
            }, E = [], R = [], (b.qsa = me.test(D.querySelectorAll)) && (o(function(e) {
                ...
                e.querySelectorAll("[id~=" + B + "-]").length || R.push("~="), e.querySelectorAll(":checked").length || R.push(":checked"), 
                e.querySelectorAll("a#" + B + "+*").length || R.push(".#.+[+~]");
            }), o(function(e) {
                e.innerHTML = "<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";
                var t = D.createElement("input");
                t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && R.push("name" + ee + "*[*^$|!~]?="), 
            ...
            })), (b.matchesSelector = me.test(V = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && o(function(e) {
                b.disconnectedMatch = V.call(e, "*"), V.call(e, "[s!='']:x"), E.push("!=", re);
            }), R = R.length && new RegExp(R.join("|")), E = E.length && new RegExp(E.join("|")), 
            t = me.test(O.compareDocumentPosition), F = t || me.test(O.contains) ? function(e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === D || e.ownerDocument === q && F(q, e) ? -1 : t === D || t.ownerDocument === q && F(q, t) ? 1 : I ? Y(I, e) - Y(I, t) : 0 : 4 & n ? -1 : 1);
            } : function(e, t) {
                if (e === t) return M = !0, 0;
                var n, r = 0, o = e.parentNode, a = t.parentNode, u = [ e ], l = [ t ];
                if (!o || !a) return e === D ? -1 : t === D ? 1 : o ? -1 : a ? 1 : I ? Y(I, e) - Y(I, t) : 0;
                if (o === a) return i(e, t);
            ...
            if ((e.ownerDocument || e) !== D && P(e), n = n.replace(le, "='$1']"), b.matchesSelector && L && !H[n + " "] && (!E || !E.test(n)) && (!R || !R.test(n))) try {
                var r = V.call(e, n);
            ...
            var n = x.attrHandle[t.toLowerCase()], r = n && z.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !L) : void 0;
            ...
            var t, n = [], r = 0, o = 0;
            if (M = !b.detectDuplicates, I = !b.sortStable && e.slice(0), e.sort(W), M) {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return fe.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && se.test(n) && (t = C(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), 
            ...
            filter: {
                ...
                CHILD: function(e, t, n, r, o) {
                    ...
                    return 1 === r && 0 === o ? function(e) {
                        ...
                        var s, c, f, d, p, m, g = a !== i ? "nextSibling" : "previousSibling", h = t.parentNode, v = u && t.nodeName.toLowerCase(), y = !l && !u, k = !1;
                        if (h) {
                            if (a) {
                                for (;g; ) {
                            ...
                            if (m = [ i ? h.firstChild : h.lastChild ], i && y) {
                                for (k = (p = (s = (c = (f = (d = h)[B] || (d[B] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === _ && s[1]) && s[2], 
                                d = p && h.childNodes[p]; d = ++p && d && d[g] || (k = p = 0) || m.pop(); ) if (1 === d.nodeType && ++k && d === t) {
                                    c[e] = [ _, p, k ];
                                    break;
                                }
                            } else if (y && (k = p = (s = (c = (f = (d = t)[B] || (d[B] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === _ && s[1]), 
                            !1 === k) for (;(d = ++p && d && d[g] || (k = p = 0) || m.pop()) && ((u ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++k || (y && ((c = (f = d[B] || (d[B] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [ _, k ]), 
                            d !== t)); ) ;
                ...
                PSEUDO: function(e, n) {
                    ...
                    return a[B] ? a(n) : a.length > 1 ? (o = [ e, e, "", n ], x.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function(e, t) {
        ...
        return c.prototype = x.filters = x.pseudos, x.setFilters = new c(), C = t.tokenize = function(e, n) {
            var r, o, a, i, u, l, s, c = U[e + " "];
            if (c) return n ? 0 : c.slice(0);
            for (u = e, l = [], s = x.preFilter; u; ) {
                r && !(o = ie.exec(u)) || (o && (u = u.slice(o[0].length) || u), l.push(a = [])), 
                r = !1, (o = ue.exec(u)) && (r = o.shift(), a.push({
                    value: r,
                    type: o[0].replace(ae, " ")
                }), u = u.slice(r.length));
                for (i in x.filter) !(o = fe[i].exec(u)) || s[i] && !(o = s[i](o)) || (r = o.shift(), 
                a.push({
                    value: r,
                    type: i,
                    matches: o
            ...
            return n ? u.length : u ? t.error(e) : U(e, l).slice(0);
        }, A = t.compile = function(e, t) {
            var n, r = [], o = [], a = H[e + " "];
            if (!a) {
                for (t || (t = C(e)), n = t.length; n--; ) (a = v(t[n]))[B] ? r.push(a) : o.push(a);
                (a = H(e, y(o, r))).selector = e;
            }
            return a;
        }, T = t.select = function(e, t, n, r) {
            var o, a, i, u, l, c = "function" == typeof e && e, d = !r && C(e = c.selector || e);
            if (n = n || [], 1 === d.length) {
                if ((a = d[0] = d[0].slice(0)).length > 2 && "ID" === (i = a[0]).type && 9 === t.nodeType && L && x.relative[a[1].type]) {
                    if (!(t = (x.find.ID(i.matches[0].replace(ve, ye), t) || [])[0])) return n;
                    c && (t = t.parentNode), e = e.slice(a.shift().value.length);
                }
                for (o = fe.needsContext.test(e) ? 0 : a.length; o-- && (i = a[o], !x.relative[u = i.type]); ) if ((l = x.find[u]) && (r = l(i.matches[0].replace(ve, ye), he.test(a[0].type) && s(t.parentNode) || t))) {
                    if (a.splice(o, 1), !(e = r.length && f(a))) return X.apply(n, r), n;
                    break;
                }
            }
            return (c || A(e, d))(r, t, !L, n, !t || he.test(e) && s(t.parentNode) || t), n;
        }, b.sortStable = B.split("").sort(W).join("") === B, b.detectDuplicates = !!M, 
        P(), b.sortDetached = o(function(e) {
    ...
    var ke = function(e, t, n) {
        ...
        return n;
    }, xe = pe.expr.match.needsContext, Se = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i, we = /^.[^:#\[\.,]*$/;
    pe.filter = function(e, t, n) {
        ...
        is: function(e) {
            return !!a(this, "string" == typeof e && xe.test(e) ? pe(e) : e || [], !1).length;
        }
    });
    var Ce, Ae = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ...
    var Te = /^(?:parents|prev(?:Until|All))/, Ne = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    pe.fn.extend({
        ...
        closest: function(e, t) {
            var n, r = 0, o = this.length, a = [], i = "string" != typeof e && pe(e);
            if (!xe.test(e)) for (;r < o; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (i ? i.index(n) > -1 : 1 === n.nodeType && pe.find.matchesSelector(n, e))) {
                a.push(n);
                break;
            }
        ...
        pe.fn[e] = function(n, r) {
            ...
            return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (o = pe.filter(r, o)), 
            this.length > 1 && (Ne[e] || pe.uniqueSort(o), Te.test(e) && o.reverse()), this.pushStack(o);
        };
    });
    var Ie = /[^\x20\t\r\n\f]+/g;
    pe.Callbacks = function(e) {
        e = "string" == typeof e ? u(e) : pe.extend({}, e);
        var t, n, r, o, a = [], i = [], l = -1, s = function() {
            for (o = o || e.once, r = t = !0; i.length; l = -1) for (n = i.shift(); ++l < a.length; ) !1 === a[l].apply(n[0], n[1]) && e.stopOnFalse && (l = a.length, 
            n = !1);
            ...
            fireWith: function(e, n) {
                return o || (n = [ e, (n = n || []).slice ? n.slice() : n ], i.push(n), t || s()), 
                this;
            },
            fire: function() {
        ...
        Deferred: function(t) {
            var n = [ [ "notify", "progress", pe.Callbacks("memory"), pe.Callbacks("memory"), 2 ], [ "resolve", "done", pe.Callbacks("once memory"), pe.Callbacks("once memory"), 0, "resolved" ], [ "reject", "fail", pe.Callbacks("once memory"), pe.Callbacks("once memory"), 1, "rejected" ] ], r = "pending", o = {
                state: function() {
                    return r;
                },
                always: function() {
                    ...
                    return pe.Deferred(function(t) {
                        pe.each(n, function(n, r) {
                            ...
                            a[r[1]](function() {
                                ...
                                e && pe.isFunction(e.promise) ? e.promise().progress(t.notify).done(t.resolve).fail(t.reject) : t[r[0] + "With"](this, o ? [ e ] : arguments);
                            });
                        }), e = null;
                    }).promise();
                },
                then: function(t, r, o) {
                        ...
                        return function() {
                            var u = this, c = arguments, f = function() {
                                ...
                                if (!(t < i)) {
                                    ...
                                    f = e && ("object" == typeof e || "function" == typeof e) && e.then, pe.isFunction(f) ? o ? f.call(e, a(i, n, l, o), a(i, n, s, o)) : (i++, 
                                    f.call(e, a(i, n, l, o), a(i, n, s, o), a(i, n, l, n.notifyWith))) : (r !== l && (u = void 0, 
                                    c = [ e ]), (o || n.resolveWith)(u, c));
                                }
                            }, d = o ? f : function() {
                                try {
                                    f();
                                } catch (e) {
                                    pe.Deferred.exceptionHook && pe.Deferred.exceptionHook(e, d.stackTrace), t + 1 >= i && (r !== s && (u = void 0, 
                    ...
                    return pe.Deferred(function(e) {
                        n[0][3].add(a(0, e, pe.isFunction(o) ? o : l, e.notifyWith)), n[1][3].add(a(0, e, pe.isFunction(t) ? t : l)), 
                        n[2][3].add(a(0, e, pe.isFunction(r) ? r : s));
                    }).promise();
                },
                promise: function(e) {
            ...
            return pe.each(n, function(e, t) {
                var i = t[2], u = t[5];
                o[t[1]] = i.add, u && i.add(function() {
                    r = u;
                }, n[3 - e][2].disable, n[0][2].lock), i.add(t[3].fire), a[t[0]] = function() {
                    return a[t[0] + "With"](this === a ? void 0 : this, arguments), this;
                }, a[t[0] + "With"] = i.fireWith;
            }), o.promise(a), t && t.call(a, a), a;
        },
        when: function(e) {
            var t = arguments.length, n = t, r = Array(n), o = re.call(arguments), a = pe.Deferred(), i = function(e) {
                return function(n) {
                    r[e] = this, o[e] = arguments.length > 1 ? re.call(arguments) : n, --t || a.resolveWith(r, o);
                };
            };
            if (t <= 1 && (c(e, a.done(i(n)).resolve, a.reject, !t), "pending" === a.state() || pe.isFunction(o[n] && o[n].then))) return a.then();
            for (;n--; ) c(o[n], i(n), a.reject);
            return a.promise();
        }
    });
    ...
    pe.fn.ready = function(e) {
        ...
        readyWait: 1,
        ready: function(e) {
            (!0 === e ? --pe.readyWait : pe.isReady) || (pe.isReady = !0, !0 !== e && --pe.readyWait > 0 || Pe.resolveWith(te, [ pe ]));
        }
    }), pe.ready.then = Pe.then, "complete" === te.readyState || "loading" !== te.readyState && !te.documentElement.doScroll ? e.setTimeout(pe.ready) : (te.addEventListener("DOMContentLoaded", f), 
    e.addEventListener("load", f));
    var De = function(e, t, n, r, o, a, i) {
        var u = 0, l = e.length, s = null == n;
        if ("object" === pe.type(n)) {
            o = !0;
            for (u in n) De(e, t, u, n[u], !0, a, i);
        } else if (void 0 !== r && (o = !0, pe.isFunction(r) || (i = !0), s && (i ? (t.call(e, r), 
    ...
    d.uid = 1, d.prototype = {
        ...
        set: function(e, t, n) {
            ...
            if ("string" == typeof t) o[pe.camelCase(t)] = n; else for (r in t) o[pe.camelCase(r)] = t[r];
            return o;
        },
        get: function(e, t) {
        ...
        remove: function(e, t) {
            ...
            if (void 0 !== r) {
                if (void 0 !== t) {
                    n = (t = Array.isArray(t) ? t.map(pe.camelCase) : (t = pe.camelCase(t)) in r ? [ t ] : t.match(Ie) || []).length;
                    for (;n--; ) delete r[t[n]];
                }
    ...
    var Le = new d(), Re = new d(), Ee = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Ve = /[A-Z]/g;
    pe.extend({
        hasData: function(e) {
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (o = Re.get(a), 1 === a.nodeType && !Le.get(a, "hasDataAttrs"))) {
                    for (n = i.length; n--; ) i[n] && 0 === (r = i[n].name).indexOf("data-") && (r = pe.camelCase(r.slice(5)), 
                    m(a, r, o[r]));
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                var n;
                if (a && void 0 === t) {
                    if (void 0 !== (n = Re.get(a, e))) return n;
                    if (void 0 !== (n = m(a, e))) return n;
        ...
        queue: function(e, t, n) {
            var r;
            if (e) return t = (t || "fx") + "queue", r = Le.get(e, t), n && (!r || Array.isArray(n) ? r = Le.access(e, t, pe.makeArray(n)) : r.push(n)), 
            r || [];
        },
        dequeue: function(e, t) {
            t = t || "fx";
            var n = pe.queue(e, t), r = n.length, o = n.shift(), a = pe._queueHooks(e, t);
        ...
        promise: function(e, t) {
            var n, r = 1, o = pe.Deferred(), a = this, i = this.length, u = function() {
                --r || o.resolveWith(a, [ a ]);
            };
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; i--; ) (n = Le.get(a[i], e + "queueHooks")) && n.empty && (r++, 
            n.empty.add(u));
            return u(), o.promise(t);
        }
    });
    var Fe = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Be = new RegExp("^(?:([+-])=|)(" + Fe + ")([a-z%]*)$", "i"), qe = [ "Top", "Right", "Bottom", "Left" ], _e = function(e, t) {
    ...
    var Ke = te.documentElement, Je = /^key/, Xe = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Qe = /^([^.]*)(?:\.(.+)|)/;
    pe.event = {
        global: {},
        add: function(e, t, n, r, o) {
            var a, i, u, l, s, c, f, d, p, m, g, h = Le.get(e);
            if (h) for (n.handler && (n = (a = n).handler, o = a.selector), o && pe.find.matchesSelector(Ke, o), 
            n.guid || (n.guid = pe.guid++), (l = h.events) || (l = h.events = {}), (i = h.handle) || (i = h.handle = function(t) {
                return void 0 !== pe && pe.event.triggered !== t.type ? pe.event.dispatch.apply(e, arguments) : void 0;
            }), s = (t = (t || "").match(Ie) || [ "" ]).length; s--; ) p = g = (u = Qe.exec(t[s]) || [])[1], 
            m = (u[2] || "").split(".").sort(), p && (f = pe.event.special[p] || {}, p = (o ? f.delegateType : f.bindType) || p, 
            f = pe.event.special[p] || {}, c = pe.extend({
                ...
                namespace: m.join(".")
            }, a), (d = l[p]) || ((d = l[p] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(e, r, m, i) || e.addEventListener && e.addEventListener(p, i)), 
            f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), o ? d.splice(d.delegateCount++, 0, c) : d.push(c), 
            pe.event.global[p] = !0);
        },
        remove: function(e, t, n, r, o) {
            var a, i, u, l, s, c, f, d, p, m, g, h = Le.hasData(e) && Le.get(e);
            if (h && (l = h.events)) {
                for (s = (t = (t || "").match(Ie) || [ "" ]).length; s--; ) if (u = Qe.exec(t[s]) || [], 
                p = g = u[1], m = (u[2] || "").split(".").sort(), p) {
                    ...
                    i && !d.length && (f.teardown && !1 !== f.teardown.call(e, m, h.handle) || pe.removeEvent(e, p, h.handle), 
                    delete l[p]);
                } else for (p in l) pe.event.remove(e, p + t[s], n, r, !0);
                pe.isEmptyObject(l) && Le.remove(e, "handle events");
            }
        },
        dispatch: function(e) {
            var t, n, r, o, a, i, u = pe.event.fix(e), l = new Array(arguments.length), s = (Le.get(this, "events") || {})[u.type] || [], c = pe.event.special[u.type] || {};
            for (l[0] = u, t = 1; t < arguments.length; t++) l[t] = arguments[t];
            if (u.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, u)) {
                for (i = pe.event.handlers.call(this, u, s), t = 0; (o = i[t++]) && !u.isPropagationStopped(); ) for (u.currentTarget = o.elem, 
                n = 0; (a = o.handlers[n++]) && !u.isImmediatePropagationStopped(); ) u.rnamespace && !u.rnamespace.test(a.namespace) || (u.handleObj = a, 
                u.data = a.data, void 0 !== (r = ((pe.event.special[a.origType] || {}).handle || a.handler).apply(o.elem, l)) && !1 === (u.result = r) && (u.preventDefault(), 
                u.stopPropagation()));
        ...
        handlers: function(e, t) {
            ...
            if (l && s.nodeType && !("click" === e.type && e.button >= 1)) for (;s !== this; s = s.parentNode || this) if (1 === s.nodeType && ("click" !== e.type || !0 !== s.disabled)) {
                for (a = [], i = {}, n = 0; n < l; n++) void 0 === i[o = (r = t[n]).selector + " "] && (i[o] = r.needsContext ? pe(o, this).index(s) > -1 : pe.find(o, this, null, [ s ]).length), 
                i[o] && a.push(r);
                a.length && u.push({
                    elem: s,
                    handlers: a
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? x : S, 
        ...
        pe.event.special[e] = {
            ...
            handle: function(e) {
                ...
                return o && (o === r || pe.contains(r, o)) || (e.type = a.origType, n = a.handler.apply(this, arguments), 
                e.type = t), n;
            }
        };
    }), pe.fn.extend({
    ...
    pe.extend({
        ...
        clone: function(e, t, n) {
            var r, o, a, i, u = e.cloneNode(!0), l = pe.contains(e.ownerDocument, e);
            if (!(de.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || pe.isXMLDoc(e))) for (i = y(u), 
            r = 0, o = (a = y(e)).length; r < o; r++) M(a[r], i[r]);
            if (t) if (n) for (a = a || y(e), i = i || y(u), r = 0, o = a.length; r < o; r++) I(a[r], i[r]); else I(e, u);
            return (i = y(u, "script")).length > 0 && k(i, !l && y(e, "script")), u;
        },
        cleanData: function(e) {
            for (var t, n, r, o = pe.event.special, a = 0; void 0 !== (n = e[a]); a++) if (Oe(n)) {
                if (t = n[Le.expando]) {
        ...
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++) 1 === e.nodeType && (pe.cleanData(y(e, !1)), 
            e.textContent = "");
            return this;
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return De(this, function(e) {
                ...
                if ("string" == typeof e && !Ze.test(e) && !ze[(He.exec(e) || [ "", "" ])[1].toLowerCase()]) {
                    e = pe.htmlPrefilter(e);
                    try {
                        for (;n < r; n++) 1 === (t = this[n] || {}).nodeType && (pe.cleanData(y(t, !1)), 
                        t.innerHTML = e);
                        t = 0;
                    } catch (e) {}
                }
        ...
        pe.fn[e] = function(e) {
            for (var n, r = [], o = pe(e), a = o.length - 1, i = 0; i <= a; i++) n = i === a ? this : this.clone(!0), 
            pe(o[i])[t](n), ae.apply(r, n.get());
            return this.pushStack(r);
        };
    });
    var rt = /^margin/, ot = new RegExp("^(" + Fe + ")(?!px)[a-z%]+$", "i"), at = function(t) {
    ...
    !function() {
        function t() {
            if (u) {
                ...
                u.innerHTML = "", Ke.appendChild(i);
                var t = e.getComputedStyle(u);
                n = "1%" !== t.top, a = "2px" === t.marginLeft, r = "4px" === t.width, u.style.marginRight = "50%", 
                o = "4px" === t.marginRight, Ke.removeChild(i), u = null;
            }
        }
        var n, r, o, a, i = te.createElement("div"), u = te.createElement("div");
        u.style && (u.style.backgroundClip = "content-box", u.cloneNode(!0).style.backgroundClip = "", 
        de.clearCloneStyle = "content-box" === u.style.backgroundClip, i.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", 
        i.appendChild(u), pe.extend(de, {
    ...
    pe.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, a, i, u = pe.camelCase(t), l = ut.test(t), s = e.style;
                if (l || (t = E(u)), i = pe.cssHooks[t] || pe.cssHooks[u], void 0 === n) return i && "get" in i && void 0 !== (o = i.get(e, !1, r)) ? o : s[t];
                "string" == (a = typeof n) && (o = Be.exec(n)) && o[1] && (n = g(e, t, o), a = "number"), 
                null != n && n === n && ("number" === a && (n += o && o[3] || (pe.cssNumber[u] ? "" : "px")), 
                de.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (s[t] = "inherit"), 
                i && "set" in i && void 0 === (n = i.set(e, n, r)) || (l ? s.setProperty(t, n) : s[t] = n));
            }
        },
        css: function(e, t, n, r) {
            var o, a, i, u = pe.camelCase(t);
            return ut.test(t) || (t = E(u)), (i = pe.cssHooks[t] || pe.cssHooks[u]) && "get" in i && (o = i.get(e, !0, n)), 
            void 0 === o && (o = O(e, t, r)), "normal" === o && t in st && (o = st[t]), "" === n || n ? (a = parseFloat(o), 
            !0 === n || isFinite(a) ? a || 0 : o) : o;
        }
    }), pe.each([ "height", "width" ], function(e, t) {
        pe.cssHooks[t] = {
            get: function(e, n, r) {
                if (n) return !it.test(pe.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? B(e, t, r) : Ge(e, lt, function() {
                    return B(e, t, r);
                });
            },
            set: function(e, n, r) {
                var o, a = r && at(e), i = r && F(e, t, r, "border-box" === pe.css(e, "boxSizing", !1, a), a);
                return i && (o = Be.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = pe.css(e, t)), 
                V(0, n, i);
            }
        };
        ...
        pe.cssHooks[e + t] = {
            expand: function(n) {
                for (var r = 0, o = {}, a = "string" == typeof n ? n.split(" ") : [ n ]; r < 4; r++) o[e + qe[r] + t] = a[r] || a[r - 2] || a[0];
                return o;
            }
        }, rt.test(e) || (pe.cssHooks[e + t].set = V);
    }), pe.fn.extend({
        css: function(e, t) {
            return De(this, function(e, t, n) {
                var r, o, a = {}, i = 0;
                if (Array.isArray(t)) {
                    for (r = at(e), o = t.length; i < o; i++) a[t[i]] = pe.css(e, t[i], !1, r);
                    return a;
                }
        ...
        init: function(e, t, n, r, o, a) {
            ...
            this.start = this.now = this.cur(), this.end = r, this.unit = a || (pe.cssNumber[n] ? "" : "px");
        },
        cur: function() {
    ...
    var dt, pt, mt = /^(?:toggle|show|hide)$/, gt = /queueHooks$/;
    pe.Animation = pe.extend(W, {
        ...
        tweener: function(e, t) {
            ...
            for (var n, r = 0, o = e.length; r < o; r++) n = e[r], W.tweeners[n] = W.tweeners[n] || [], 
            W.tweeners[n].unshift(t);
        },
        prefilters: [ function(e, t, n) {
            var r, o, a, i, u, l, s, c, f = "width" in t || "height" in t, d = this, p = {}, m = e.style, g = e.nodeType && _e(e), h = Le.get(e, "fxshow");
            n.queue || (null == (i = pe._queueHooks(e, "fx")).unqueued && (i.unqueued = 0, u = i.empty.fire, 
            i.empty.fire = function() {
                i.unqueued || u();
            }), i.unqueued++, d.always(function() {
                d.always(function() {
                    i.unqueued--, pe.queue(e, "fx").length || i.empty.fire();
                });
            }));
            for (r in t) if (o = t[r], mt.test(o)) {
                ...
                p[r] = h && h[r] || pe.style(e, r);
            }
            if ((l = !pe.isEmptyObject(t)) || !pe.isEmptyObject(p)) {
                f && 1 === e.nodeType && (n.overflow = [ m.overflow, m.overflowX, m.overflowY ], 
                null == (s = h && h.display) && (s = Le.get(e, "display")), "none" === (c = pe.css(e, "display")) && (s ? c = s : (v([ e ], !0), 
                s = e.style.display || s, c = pe.css(e, "display"), v([ e ]))), ("inline" === c || "inline-block" === c && null != s) && "none" === pe.css(e, "float") && (l || (d.done(function() {
                    m.display = s;
                ...
                for (r in p) l || (h ? "hidden" in h && (g = h.hidden) : h = Le.access(e, "fxshow", {
                    display: s
                }), a && (h.hidden = !g), g && v([ e ], !0), d.done(function() {
                    g || v([ e ]), Le.remove(e, "fxshow");
                    for (r in p) pe.style(e, r, p[r]);
                })), l = U(g ? h[r] : 0, r, d), r in h || (h[r] = l.start, g && (l.end = l.start, 
                l.start = 0));
            }
        } ],
        ...
        animate: function(e, t, n, r) {
            var o = pe.isEmptyObject(e), a = pe.speed(t, n, r), i = function() {
        ...
        stop: function(e, t, n) {
            ...
            this.each(function() {
                var t = !0, o = null != e && e + "queueHooks", a = pe.timers, i = Le.get(this);
                if (o) i[o] && i[o].stop && r(i[o]); else for (o in i) i[o] && i[o].stop && gt.test(o) && r(i[o]);
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"), this.each(function() {
                var t, n = Le.get(this), r = n[e + "queue"], o = n[e + "queueHooks"], a = pe.timers, i = r ? r.length : 0;
    ...
    pe.fn.extend({
        ...
        attr: function(e, t, n) {
            ...
            if (3 !== a && 8 !== a && 2 !== a) return void 0 === e.getAttribute ? pe.prop(e, t, n) : (1 === a && pe.isXMLDoc(e) || (o = pe.attrHooks[t.toLowerCase()] || (pe.expr.match.bool.test(t) ? ht : void 0)), 
        ...
        vt[t] = function(e, t, r) {
            ...
            return r || (a = vt[i], vt[i] = o, o = null != n(e, t, r) ? i : null, vt[i] = a), 
            o;
        };
    });
    var yt = /^(?:input|select|textarea|button)$/i, kt = /^(?:a|area)$/i;
    pe.fn.extend({
        prop: function(e, t) {
        ...
        prop: function(e, t, n) {
            var r, o, a = e.nodeType;
            if (3 !== a && 8 !== a && 2 !== a) return 1 === a && pe.isXMLDoc(e) || (t = pe.propFix[t] || t, 
            o = pe.propHooks[t]), void 0 !== n ? o && "set" in o && void 0 !== (r = o.set(e, n, t)) ? r : e[t] = n : o && "get" in o && null !== (r = o.get(e, t)) ? r : e[t];
        },
        propHooks: {
            tabIndex: {
                get: function(e) {
                    var t = pe.find.attr(e, "tabindex");
                    return t ? parseInt(t, 10) : yt.test(e.nodeName) || kt.test(e.nodeName) && e.href ? 0 : -1;
                }
            }
        },
        propFix: {
        ...
        addClass: function(e) {
            var t, n, r, o, a, i, u, l = 0;
            if (pe.isFunction(e)) return this.each(function(t) {
                pe(this).addClass(e.call(this, t, $(this)));
            });
            if ("string" == typeof e && e) for (t = e.match(Ie) || []; n = this[l++]; ) if (o = $(n), 
            r = 1 === n.nodeType && " " + z(o) + " ") {
                for (i = 0; a = t[i++]; ) r.indexOf(" " + a + " ") < 0 && (r += a + " ");
                o !== (u = z(r)) && n.setAttribute("class", u);
            }
            return this;
        },
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : pe.isFunction(e) ? this.each(function(n) {
                ...
                var t, r, o, a;
                if ("string" === n) for (r = 0, o = pe(this), a = e.match(Ie) || []; t = a[r++]; ) o.hasClass(t) ? o.removeClass(t) : o.addClass(t); else void 0 !== e && "boolean" !== n || ((t = $(this)) && Le.set(this, "__className__", t), 
                this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Le.get(this, "__className__") || ""));
            });
        },
        hasClass: function(e) {
            var t, n, r = 0;
            for (t = " " + e + " "; n = this[r++]; ) if (1 === n.nodeType && (" " + z($(n)) + " ").indexOf(t) > -1) return !0;
            return !1;
        }
    });
    var bt = /\r/g;
        ...
        val: function(e) {
            var t, n, r, o = this[0];
            {
                if (arguments.length) return r = pe.isFunction(e), this.each(function(n) {
                    var o;
                    1 === this.nodeType && (null == (o = r ? e.call(this, n, pe(this).val()) : e) ? o = "" : "number" == typeof o ? o += "" : Array.isArray(o) && (o = pe.map(o, function(e) {
                        return null == e ? "" : e + "";
                    })), (t = pe.valHooks[this.type] || pe.valHooks[this.nodeName.toLowerCase()]) && "set" in t && void 0 !== t.set(this, o, "value") || (this.value = o));
                });
                if (o) return (t = pe.valHooks[o.type] || pe.valHooks[o.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(o, "value")) ? n : "string" == typeof (n = o.value) ? n.replace(bt, "") : null == n ? "" : n;
            }
        }
    }), pe.extend({
        valHooks: {
            ...
            select: {
                get: function(e) {
                    var t, n, r, a = e.options, i = e.selectedIndex, u = "select-one" === e.type, l = u ? null : [], s = u ? i + 1 : a.length;
                    for (r = i < 0 ? s : u ? i : 0; r < s; r++) if (((n = a[r]).selected || r === i) && !n.disabled && (!n.parentNode.disabled || !o(n.parentNode, "optgroup"))) {
                        if (t = pe(n).val(), u) return t;
                        l.push(t);
                    }
                    return l;
                },
                set: function(e, t) {
                    for (var n, r, o = e.options, a = pe.makeArray(t), i = o.length; i--; ) ((r = o[i]).selected = pe.inArray(pe.valHooks.option.get(r), a) > -1) && (n = !0);
    ...
    pe.extend(pe.event, {
        trigger: function(t, n, r, o) {
            var a, i, u, l, s, c, f, d = [ r || te ], p = se.call(t, "type") ? t.type : t, m = se.call(t, "namespace") ? t.namespace.split(".") : [];
            if (i = u = r = r || te, 3 !== r.nodeType && 8 !== r.nodeType && !xt.test(p + pe.event.triggered) && (p.indexOf(".") > -1 && (p = (m = p.split(".")).shift(), 
            m.sort()), s = p.indexOf(":") < 0 && "on" + p, t = t[pe.expando] ? t : new pe.Event(p, "object" == typeof t && t), 
            ...
            f = pe.event.special[p] || {}, o || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                if (!o && !f.noBubble && !pe.isWindow(r)) {
                    for (l = f.delegateType || p, xt.test(l + p) || (i = i.parentNode); i; i = i.parentNode) d.push(i), 
                    u = i;
                    u === (r.ownerDocument || te) && d.push(u.defaultView || u.parentWindow || e);
                }
                for (a = 0; (i = d[a++]) && !t.isPropagationStopped(); ) t.type = a > 1 ? l : f.bindType || p, 
                (c = (Le.get(i, "events") || {})[t.type] && Le.get(i, "handle")) && c.apply(i, n), 
                (c = s && i[s]) && c.apply && Oe(i) && (t.result = c.apply(i, n), !1 === t.result && t.preventDefault());
                return t.type = p, o || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(d.pop(), n) || !Oe(r) || s && pe.isFunction(r[p]) && !pe.isWindow(r) && ((u = r[s]) && (r[s] = null), 
                pe.event.triggered = p, r[p](), pe.event.triggered = void 0, u && (r[s] = u)), t.result;
            }
        },
        ...
        pe.event.special[t] = {
            setup: function() {
                var r = this.ownerDocument || this, o = Le.access(r, t);
                o || r.addEventListener(e, n, !0), Le.access(r, t, (o || 0) + 1);
            },
            teardown: function() {
                var r = this.ownerDocument || this, o = Le.access(r, t) - 1;
                o ? Le.access(r, t, o) : (r.removeEventListener(e, n, !0), Le.remove(r, t));
            }
        };
    });
    var St = e.location, wt = pe.now(), Ct = /\?/;
    ...
    pe.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !pe(this).is(":disabled") && It.test(this.nodeName) && !Nt.test(e) && (this.checked || !Ue.test(e));
            }).map(function(e, t) {
                var n = pe(this).val();
    ...
    var Mt = /%20/g, Pt = /#.*$/, Dt = /([?&])_=[^&]*/, Ot = /^(.*?):[ \t]*([^\r\n]*)$/gm, Lt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Rt = /^(?:GET|HEAD)$/, Et = /^\/\//, Vt = {}, Ft = {}, Bt = "*/".concat("*"), qt = te.createElement("a");
    qt.href = St.href, pe.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function(t, n) {
            function r(t, n, r, u) {
                var s, d, p, b, x, S = n;
                c || (c = !0, l && e.clearTimeout(l), o = void 0, i = u || "", w.readyState = t > 0 ? 4 : 0, 
                s = t >= 200 && t < 300 || 304 === t, r && (b = Y(m, w, r)), b = Z(m, b, w, s), 
                s ? (m.ifModified && ((x = w.getResponseHeader("Last-Modified")) && (pe.lastModified[a] = x), 
                (x = w.getResponseHeader("etag")) && (pe.etag[a] = x)), 204 === t || "HEAD" === m.type ? S = "nocontent" : 304 === t ? S = "notmodified" : (S = b.state, 
                d = b.data, s = !(p = b.error))) : (p = S, !t && S || (S = "error", t < 0 && (t = 0))), 
                w.status = t, w.statusText = (n || S) + "", s ? v.resolveWith(g, [ d, S, w ]) : v.rejectWith(g, [ w, S, p ]), 
                w.statusCode(k), k = void 0, f && h.trigger(s ? "ajaxSuccess" : "ajaxError", [ w, m, s ? d : p ]), 
                y.fireWith(g, [ w, S ]), f && (h.trigger("ajaxComplete", [ w, m ]), --pe.active || pe.event.trigger("ajaxStop")));
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var o, a, i, u, l, s, c, f, d, p, m = pe.ajaxSetup({}, n), g = m.context || m, h = m.context && (g.nodeType || g.jquery) ? pe(g) : pe.event, v = pe.Deferred(), y = pe.Callbacks("once memory"), k = m.statusCode || {}, b = {}, x = {}, S = "canceled", w = {
                readyState: 0,
                ...
                statusCode: function(e) {
                    var t;
                    if (e) if (c) w.always(e[w.status]); else for (t in e) k[t] = [ k[t], e[t] ];
                    return this;
                },
                abort: function(e) {
                    var t = e || S;
            ...
            if (v.promise(w), m.url = ((t || m.url || St.href) + "").replace(Et, St.protocol + "//"), 
            m.type = n.method || n.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(Ie) || [ "" ], 
            null == m.crossDomain) {
                s = te.createElement("a");
                try {
                    s.href = m.url, s.href = s.href, m.crossDomain = qt.protocol + "//" + qt.host != s.protocol + "//" + s.host;
                } catch (e) {
                    m.crossDomain = !0;
                }
            }
            if (m.data && m.processData && "string" != typeof m.data && (m.data = pe.param(m.data, m.traditional)), 
            X(Vt, m, n, w), c) return w;
            (f = pe.event && m.global) && 0 == pe.active++ && pe.event.trigger("ajaxStart"), 
            m.type = m.type.toUpperCase(), m.hasContent = !Rt.test(m.type), a = m.url.replace(Pt, ""), 
            m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(Mt, "+")) : (p = m.url.slice(a.length), 
            m.data && (a += (Ct.test(a) ? "&" : "?") + m.data, delete m.data), !1 === m.cache && (a = a.replace(Dt, "$1"), 
            p = (Ct.test(a) ? "&" : "?") + "_=" + wt++ + p), m.url = a + p), m.ifModified && (pe.lastModified[a] && w.setRequestHeader("If-Modified-Since", pe.lastModified[a]), 
            pe.etag[a] && w.setRequestHeader("If-None-Match", pe.etag[a])), (m.data && m.hasContent && !1 !== m.contentType || n.contentType) && w.setRequestHeader("Content-Type", m.contentType), 
            w.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Bt + "; q=0.01" : "") : m.accepts["*"]);
            for (d in m.headers) w.setRequestHeader(d, m.headers[d]);
            if (m.beforeSend && (!1 === m.beforeSend.call(g, w, m) || c)) return w.abort();
            if (S = "abort", y.add(m.complete), w.done(m.success), w.fail(m.error), o = X(Ft, m, n, w)) {
                if (w.readyState = 1, f && h.trigger("ajaxSend", [ w, m ]), c) return w;
    ...
    de.cors = !!Gt && "withCredentials" in Gt, de.ajax = Gt = !!Gt, pe.ajaxTransport(function(t) {
        var n, r;
        if (de.cors || Gt && !t.crossDomain) return {
            send: function(o, a) {
                var i, u = t.xhr();
                ...
                n = function(e) {
                    return function() {
                        n && (n = r = u.onload = u.onerror = u.onabort = u.onreadystatechange = null, "abort" === e ? u.abort() : "error" === e ? "number" != typeof u.status ? a(0, "error") : a(u.status, u.statusText) : a(_t[u.status] || u.status, u.statusText, "text" !== (u.responseType || "text") || "string" != typeof u.responseText ? {
                            binary: u.response
                        } : {
                            text: u.responseText
    ...
    pe.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = jt.pop() || pe.expando + "_" + wt++;
            return this[e] = !0, e;
        }
    }), pe.ajaxPrefilter("json jsonp", function(t, n, r) {
        var o, a, i, u = !1 !== t.jsonp && (Ut.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Ut.test(t.data) && "data");
        if (u || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = pe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, 
        u ? t[u] = t[u].replace(Ut, "$1" + o) : !1 !== t.jsonp && (t.url += (Ct.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), 
        t.converters["script json"] = function() {
            return i || pe.error(o + " was not called"), i[0];
        }, t.dataTypes[0] = "json", a = e[o], e[o] = function() {
            i = arguments;
        }, r.always(function() {
            void 0 === a ? pe(e).removeProp(o) : e[o] = a, t[o] && (t.jsonpCallback = n.jsonpCallback, 
            jt.push(o)), i && pe.isFunction(a) && a(i[0]), i = a = void 0;
        }), "script";
        ...
        t.head.appendChild(r)) : t = te), o = Se.exec(e), a = !n && [], o ? [ t.createElement(o[1]) ] : (o = b([ e ], t, a), 
        a && a.length && pe(a).remove(), pe.merge([], o.childNodes));
    }, pe.fn.load = function(e, t, n) {
        var r, o, a, i = this, u = e.indexOf(" ");
        return u > -1 && (r = z(e.slice(u)), e = e.slice(0, u)), pe.isFunction(t) ? (n = t, 
        t = void 0) : t && "object" == typeof t && (o = "POST"), i.length > 0 && pe.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        }).done(function(e) {
            a = arguments, i.html(r ? pe("<div>").append(pe.parseHTML(e)).find(r) : e);
        ...
        setOffset: function(e, t, n) {
            var r, o, a, i, u, l, s = pe.css(e, "position"), c = pe(e), f = {};
            "static" === s && (e.style.position = "relative"), u = c.offset(), a = pe.css(e, "top"), 
            l = pe.css(e, "left"), ("absolute" === s || "fixed" === s) && (a + l).indexOf("auto") > -1 ? (i = (r = c.position()).top, 
            o = r.left) : (i = parseFloat(a) || 0, o = parseFloat(l) || 0), pe.isFunction(t) && (t = t.call(e, n, pe.extend({}, u))), 
        ...
        offset: function(e) {
            ...
            if (a) return a.getClientRects().length ? (r = a.getBoundingClientRect(), t = a.ownerDocument, 
        ...
        var n = "pageYOffset" === t;
        pe.fn[e] = function(r) {
            return De(this, function(e, r, o) {
                var a;
                if (pe.isWindow(e) ? a = e : 9 === e.nodeType && (a = e.defaultView), void 0 === o) return a ? a[t] : e[r];
        ...
        pe.each({
            ...
            pe.fn[r] = function(o, a) {
                var i = arguments.length && (n || "boolean" != typeof o), u = n || (!0 === o || !0 === a ? "margin" : "border");
                return De(this, function(t, n, o) {
                    var a;
                    return pe.isWindow(t) ? 0 === r.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (a = t.documentElement, 
                    Math.max(t.body["scroll" + e], a["scroll" + e], t.body["offset" + e], a["offset" + e], a["client" + e])) : void 0 === o ? pe.css(t, n, u) : pe.style(t, n, o, u);
                }, t, i ? o : void 0, i);
            };
        });
    }), pe.fn.extend({
    ...
    return pe.noConflict = function(t) {
        return e.$ === pe && (e.$ = Wt), t && e.jQuery === pe && (e.jQuery = Ht), pe;
    }, t || (e.jQuery = e.$ = pe), pe;
});
...
!function(e, t) {
    ...
    t.renderOneActivity = function(e, t) {
        ...
        return function(r, o, a) {
            ...
            } else for (var l in r) if ((i = o(r[l], l)) !== n) return e ? r[l] : i;
            return a;
        };
    ...
    t.model = {}, t.model.copyModel = function(n, r) {
        ...
        var l = t.model.pathToSegments(n, o), s = 0;
        if (a && (s = a.length, l = a.concat(l)), e = u(e, l, s, o, r === t.NO_VALUE ? 0 : 1), 
        ...
        for (var i = o, u = n.length - a, l = 0; l < u; ++l) {
            if (!e) return;
            var s = n[l];
            e = o && o[s] ? o[s] : t.model.resolvePathSegment(e, s, 1 === a, i), o = null;
        }
        return e;
    ...
    t.allocateGuid = function() {
        ...
        if (0 !== i) {
            var u = a.constraint.target || "none", l = t.extremalPriorities[u];
            void 0 === l && t.fail("Unrecognised extremal priority target " + u + ": the currently supported values are " + t.keys(t.extremalPriorities).join(", ") + ": register your value in fluid.extremalPriorities"), 
            a.fixed = i * (t.extremePriority + l);
        }
        ...
        if (-1 === a) return !0;
        if (a >= n) return !1;
        for (var i = a + ("after" === o.type ? 1 : 0), u = e[r], l = r; l >= i; --l) e[l] = e[l - 1];
        return e[i] = u, !0;
        ...
        var r, o = (n = n || {}).name || "<anonymous>", a = function() {
            r.listeners = {}, r.byId = {}, r.sortedListeners = [], r.addListener = function(n, o, a, i, u) {
                ...
                n) {
                    t.isPlainObject(n, !0) && !t.isApplicable(n) && (n = (l = n).listener, o = l.namespace, 
                    a = l.priority, i = l.softNamespace, u = l.listenerId), "string" == typeof n && (n = {
                        globalName: n
                    });
                    var s = u || t.event.identifyListener(n);
                    o = o || s, l = e.extend(l || {}, {
                        namespace: o,
                        listener: n,
                        softNamespace: i,
                    ...
                    }), r.byId[s] = l, (r.listeners[o] = t.makeArray(r.listeners[o]))[i ? "push" : "unshift"](l), 
            ...
            fire: function() {
                ...
                if (e && !r.destroyed) {
                    ...
                    for (var a = 0; a < e.length; ++a) {
                        ...
                        var u, l = i.listener.apply(null, arguments);
                        if ((n.preventable && !1 === l || r.destroyed) && (u = !1), void 0 !== u) return u;
                    }
                }
            }
        };
        ...
        t.each(r, function(r, o) {
            ...
            var l = t.event.resolveListenerRecord(r, e, o, i, !0);
            t.event.addListenerToFirer(a, l.records, i, l.adderWrapper);
        });
    ...
    t.defaultsStore = {}, t.resolveGradesImpl = function(e, n) {
        for (var r = (n = t.makeArray(n)).length - 1; r >= 0; --r) {
            var o = n[r];
            if (o && !e.gradeHash[o]) {
                var a = (t.isIoCReference(o) ? null : t.rawDefaults(o)) || {}, i = c[o] || s - 1;
                e.lastTick = Math.max(e.lastTick, i), e.gradeHash[o] = !0, e.gradeChain.push(o);
                for (var u = t.makeArray(a.gradeNames), l = u.length - 1; l >= 0; --l) t.resolveGradesImpl(e, u[l]);
            }
        }
        return e;
        ...
        for (var u = {}, l = 0; l < i.length; ++l) i[l] && i[l].mergePolicy && (u = e.extend(!0, u, i[l].mergePolicy));
        i = [ u, {} ].concat(i);
        var s = t.merge.apply(null, i);
        return s.gradeNames = a.gradeChain, t.freezeRecursive(s), {
            defaults: s,
            lastTick: a.lastTick
        };
        ...
        if (!o) {
            var l = t.rawDefaults(e);
            if (!l) return l;
            o = t.mergedDefaultsCache[r] = t.resolveGrade(l, e, n);
        }
        return o.defaults;
        ...
        for (var u = ("function" == typeof o.indexFunc ? o.indexFunc : t.getGlobalValue(o.indexFunc))(n) || [], l = 0; l < u.length; ++l) t.pushArray(r, u[l], e);
        ...
        return e ? (t.each(e, function(e, a) {
            ...
            o.hasDefaults = !0, u = !1; else for (var l = e.split(/\s*,\s*/), s = 0; s < l.length; ++s) i[l[s]] = !0;
        ...
        var l = e, s = t.isPrimitive(e);
        return void 0 !== n && (a.func || null === n || !t.isPlainObject(n) || a.nomerge ? (o[r] = void 0, 
        l = a.func ? a.func.call(null, e, n, u[i - 1], u, i) : n) : s && (l = e = t.freshContainer(n))), 
        l;
    }, t.fetchMergeChildren = function(e, n, r, o, a, i) {
        for (var u = t.derefMergePolicy(a), l = o.length - 1; l >= 0; --l) {
            var s = o[l];
            if (void 0 !== s && (t.each(s, function(u, l) {
                var s = t.concreteTrundler(a, l);
                l in e && (!i.evaluateFully || void 0 !== s || t.isPrimitive(e[l])) || (r[n] = l, 
                i.strategy(e, l, n + 1, r, o, a));
            }), u.replace)) break;
        }
        return e;
        ...
        var n = function(n, a, i, u, l, s) {
            ...
            !t.isPrimitive(n)) {
                ...
                void 0 === l && (u = t.makeArray(u), l = o(e.sources, u, i - 1, e.sourceStrategies), 
                s = r(e.mergePolicy, u, i - 1, t.concreteTrundler));
                var f, d, p, m = t.concreteTrundler(s, a), g = t.derefMergePolicy(m);
                g.replace ? (f = 1 - l.length, d = 0, p = -1) : (f = 0, d = l.length - 1, p = 1);
                for (var h, v = [], y = f; y <= d; ++y) {
                    var k = p * y, b = e.sourceStrategies[k](l[k], a, i, u);
    ...
    t.computeDynamicComponents = t.identity, t.mergeRecordTypes = {
        ...
        function i() {
            ...
            v = t.compileMergePolicy(y), e.extend(!0, s, v.builtins);
        }
        var u = t.rawDefaults(r), l = t.getMergedDefaults(r, u && u.gradeNames ? null : a.gradeNames), s = {}, c = [];
        c = t.expandComponentOptions ? c.concat(t.expandComponentOptions(s, l, o, n)) : c.concat([ t.simpleGingerBlock(l, "defaults"), t.simpleGingerBlock(o, "user") ]);
        var f = {}, d = [], p = [], m = {
            target: f,
            sourceStrategies: d
        }, g = function() {
        ...
        g();
        var h = t.makeMergeOptions(s, p, m);
    ...
    t.invokersMergePolicy = function(n, r) {
        ...
        for (var l = 0; l < i.mergeBlocks.length; ++l) i.mergeBlocks[l].initter();
    ...
    t.parseSelector = function(e, n) {
        ...
        for (var a = 0; ;) {
            for (var i = [], u = !0; ;) {
                ...
                var s = {}, c = l[2], d = n.charToTag[l[1]];
                d && (s[d] = c), i[i.length] = s, a = o.lastIndex, u = !1;
            }
            f.lastIndex = a;
            var p = {
                predList: i
        ...
        if (null === e) a("null"); else if (void 0 === e) a("undefined"); else if (e === t.SYNTHETIC_PROPERTY) a("[Synthetic property]"); else if (t.isPrimitive(e) && !u) a(JSON.stringify(e)); else {
            ...
            if (t.isArrayable(e)) if (0 === e.length) a("[]"); else {
                ...
                for (l = 0; l < s.length; ++l) {
                    var c = s[l], f = t.getSafeProperty(e, c);
...
!function(e, t) {
    ...
    t.visitComponentChildren = function(e, n, r, o) {
        ...
        t.visitComponentChildren(n, function(e, n, r) {
            ...
            for (var l = 0; l < r.length; ++l) {
                var s = i[l][r[l]];
                i[l + 1] = s, u[l + 1] = t.getContextHash(a, s) || {};
            }
        ...
        return i = i || [], {
            strategy: function(i, u, l) {
                if (1 === l) {
                    var s = t.driveStrategy(n, [ o, u ], r);
                    if (void 0 !== s) {
            ...
            initter: function() {
                ...
                for (var l in a) u && u[l] || t.getForComponent(e, i.concat([ l ]));
            }
        };
        ...
        var l = t.copy(t.get(r, o));
        t.each(i, function(e) {
            t.model.applyChangeRequest(l, {
                segs: e,
                type: "DELETE"
            });
        });
        ...
        return t.model.applyChangeRequest(s, {
            segs: a,
            type: "ADD",
            value: l
        }), t.checkComponentRecord(s), t.popActivity(), e.extend(s, {
            contextThat: n,
            recordType: u
        });
        ...
        return t.each(r, function(r) {
            var s = t.get(r.source, o);
            if (void 0 !== s) {
                l.push(t.makeDistributionRecord(n, r.source, o, a, i, r.recordType));
                var c = e.extend({}, s);
        ...
        var l = i[i.length - 1];
        !t.isCollectedDistribution(n, l, r) && t.matchIoCSelector(r.selector, o, a, i, u) && (e.push.apply(e, r.blocks), 
        t.noteCollectedDistribution(n, l, r));
        ...
        var u = t.getMemberNames(a, i), l = t.transform(i, function(e) {
            return a.idToShadow[e.id];
        }), s = l[l.length - (e ? 1 : 2)], c = t.getMembers(l, "contextHash");
        e ? (u.push(r), c.push(t.gradeNamesToHash(n)), i.push(o)) : t.registerCollectedClearer(l[l.length - 1], s, u[u.length - 1]);
        for (var f = [], d = 0; d < i.length - 1; ++d) t.each(l[d].distributions, function(e) {
            t.collectDistributions(f, s, e, i, c, u, d);
        });
        return f;
        ...
        if (!n.priority) {
            var r = t.getInstantiator(e), o = r.getThatStack(e), a = t.getMemberNames(r, o), i = r.getThatStack(n.contextThat), u = t.getMemberNames(r, i), l = t.computeTreeDistance(a, u);
            n.priority = t.mergeRecordTypes.distribution - l;
        }
        return n;
    ...
    t.distributeOptions = function(e, n) {
        ...
        t.each(o, function(n) {
            ...
            if (t.isIoCSSSelector(u.context)) {
                ...
                var l = t.extractSelectorHead(a);
                "/" === l ? o = t.rootComponent : i = l;
            } else i = u.context;
            (o = o || t.resolveContext(i, e)) || t.fail("Error in options distribution record ", n, " - could not resolve context {" + i + "} to a head component");
            var s, c = t.model.parseEL(u.path);
            if (void 0 !== n.record) s = [ t.makeDistributionRecord(e, n.record, [], c, []) ]; else {
                ...
                s = t.filterBlocks(e, r.mergeOptions.mergeBlocks, d, c, m, n.removeSource), r.mergeOptions.updateBlocks();
            }
            if (t.replicateProperty(n, "priority", s), t.replicateProperty(n, "namespace", s), 
            a) {
                var g = t.pushDistributions(o, a, n.target, s);
        ...
        t.each(a, function(n, a) {
            ...
            n.sources) {
                ...
                u.addListener(l), t.recordListener(u, l, r);
            }
        });
        ...
        var l = t.mountStrategy([ "events" ], e, o.eventStrategyBlock.strategy, [ "events" ]);
        if (o.memberStrategy = t.recordStrategy(e, a, i, "members", t.memberFromRecord, null, {
            model: !0,
            modelRelay: !0
        }), o.getConfig = {
            strategies: [ t.model.funcResolverStrategy, t.makeGingerStrategy(e), u, o.invokerStrategy.strategy, o.memberStrategy.strategy, l ]
        ...
        o.contextHash["fluid.resolveRoot"]) {
            ...
            if (o.contextHash["fluid.resolveRootSingle"]) {
                ...
                s = t.typeNameToMemberName(c);
            } else s = t.computeGlobalMemberName(e);
            var f = t.resolveRootComponent;
            f[s] && r.clearComponent(f, s), r.recordKnownComponent(f, e, s, !1);
        }
        return o.getConfig;
        ...
        return function(e, r, o, a) {
            ...
            if (void 0 === i) {
                var u = n.idToShadow[e.id].path, l = n.composePath(u, r);
                i = n.pathToComponent[l];
            }
            if (void 0 === i) {
                var s = t.getForComponent(e, [ "options", "components", r ]);
                s && (s.createOnEvent && t.fail('Error resolving path segment "' + r + '" of path ' + a.join(".") + " since component with record ", s, ' has annotation "createOnEvent" - this very likely represents an implementation error. Either alter the reference so it does not  match this component, or alter your workflow to ensure that the component is instantiated by the time this reference resolves'), 
    ...
    t.filterBuiltinGrades = function(e) {
        ...
        var u, l = t.globalInstantiator;
        if (r) return l.idToShadow[n.id].ownScope[e];
        var s = l.getFullStack(n);
        return t.visitComponentsForVisibility(l, s, function(n, r) {
        ...
        function n(e, n, o, a, i) {
            ...
            if (i) (u = r.idToShadow[n.id] = {}).that = n, u.path = o, u.memberName = a, t.constructScopeObjects(r, e, n, u); else {
                ...
                var l = r.idToShadow[e.id], s = t.keys(u.contextHash);
                t.remove_if(s, function(e) {
                    return u.contextHash && "memberName" === u.contextHash[e];
                }), s.push(a), t.each(s, function(e) {
                    l.childrenScope[e] || (l.childrenScope[e] = n);
                });
            }
        ...
        return e.extend(r, {
            ...
            if (e[a] = o, t.isComponent(o) || "instantiator" === o.type) {
                var u = r.idToShadow[e.id].path, l = r.composePath(u, a);
                n(e, o, l, a, i), r.events.onComponentAttach.fire(o, l, r, i);
            ...
            var l = r.idToShadow[e.id];
            a = a || {
                flat: !0,
                instantiator: r,
                destroyRecs: []
            }, o = o || e[n], void 0 === (u = u || l.path) && t.fail("Cannot clear component " + n + " from component ", e, " which was not created by this instantiator");
            var s = r.composePath(u, n), c = r.idToShadow[o.id];
            if (c) {
                var f = c.path === s;
                r.events.onComponentClear.fire(o, s, e, f), f ? (t.visitComponentChildren(o, function(e, t, n, i) {
                    var u = r.composeSegments.apply(null, n.slice(0, i));
                    r.clearComponent(o, t, null, a, !0, u);
                }, a, r.parseEL(s)), t.doDestroy(o, n, e), a.destroyRecs.push({
                    child: o,
                    childShadow: c,
                    name: n,
                    component: e
                    ...
                    return t === s;
                }), t.clearChildrenScope(r, l, o, c), delete r.pathToComponent[s], i || (delete e[n], 
    ...
    var o = function(n, o, a, i) {
        ...
        e.extend(l, a.mergeRecords), l.subcomponentRecord && t.checkComponentRecord(l.subcomponentRecord);
        var s = t.mergeRecordsToList(i, l);
        return t.transform(s, function(e) {
    ...
    t.fabricateDestroyMethod = function(e, t, n, r) {
        ...
        var l = o.localDynamic, s = e.extend({}, t.censorKeys(o.componentRecord, [ "type" ]), l), c = a.argumentMap, f = Object.keys(c).concat([ "type" ]);
        t.each(f, function(e) {
            for (var t = 0; t < u.length; ++t) void 0 !== u[t][e] && (s[e] = u[t][e]);
        }), r = s.type || r, delete s.type, delete s.options;
        var d = {
            distributions: u
        };
        ...
        if (!e[n]) {
            var o, a = e.options.components[n], i = t.globalInstantiator, u = i.idToShadow[e.id], l = r || u.subcomponentLocal && u.subcomponentLocal[n];
            if (t.pushActivity("initDependent", 'instantiating dependent component at path "%path" with record %record as child of %parent', {
                ...
                var s = t.expandImmediate(a.type, e, l);
                s || t.fail("Error in subcomponent record: ", a.type, " could not be resolved to a type for component ", n, " of parent ", e);
                var c = t.assembleCreatorArguments(e, s, {
                    componentRecord: a,
                    memberName: n,
                    localDynamic: l
                });
        ...
        var l = t.typeNameToMemberName(r.singleRootType || i);
        a.push(l), t.construct(a, r, o);
        ...
        return {
            apply: function(r, o, a, i) {
                var u = t.parseValidModelReference(n, "changePath listener record", e.changePath), l = t.expandOptions(e.value, n, {}, t.extend(a, {
                    arguments: o
                })), s = i && i.source && i.source.length ? t.makeArray(e.source).concat(i.source) : e.source;
                u.applier.change(u.modelSegs, l, e.type, s);
            }
        };
        ...
        function() {
            ...
            void 0 === n.args || n.args === t.NO_VALUE ? s = arguments : (t.expandImmediateImpl(a, u), 
            s = a.source), l = o.apply(null, s)), !1 === t.defeatLogging && t.popActivity(), 
            l;
        };
        ...
        var i = t.preExpand(o.args), u = {}, l = t.makeStackResolverOptions(e, u, !0), s = function() {
            !1 === t.defeatLogging && t.pushActivity("dispatchListener", "firing to listener to event named %eventName of component %that", {
                eventName: r,
                that: e
            });
            var s, c = a ? arguments[0] : arguments;
            u.arguments = c, void 0 !== o.args && o.args !== t.NO_VALUE ? (t.expandImmediateImpl(i, l), 
            s = i.source) : s = c;
            var f = n.apply(null, s);
            return !1 === t.defeatLogging && t.popActivity(), f;
        };
        return t.event.impersonateListener(n, s), s;
        ...
        var u = t.makeArray(e), l = {
            records: t.transform(u, function(e) {
                var u = t.isPrimitive(e) || e.expander ? {
                    listener: e
                } : t.copy(e), l = t.recordToApplicable(e, n, a);
                u.listener = l || (u.listener || u.func || u.funcName), u.listener || i(e, ' Listener record must contain a member named "listener", "func", "funcName" or "method"');
                var s = e.method ? t.event.resolveSoftNamespace(e.this) + "." + e.method : t.event.resolveSoftNamespace(u.listener);
                u.namespace || o || !s || (u.softNamespace = !0, u.namespace = (e.componentSource ? e.componentSource : n.typeName) + "." + s);
        ...
        var i, u = "fluid.event.firer" === a.typeName ? a : t.event.expandEvents(e, a), l = "fluid.event.firer" !== u.typeName;
        if (r.args || l) {
            i = t.makeEventFirer({
                name: " [composite] " + t.event.nameEvent(e, n)
            });
            var s = t.event.dispatchListener(e, i.fire, n, r, l);
            l ? t.event.listenerEngine(u, s, o) : o(u).addListener(s);
        } else (i = {
            typeName: "fluid.event.firer"
        }).fire = function() {
        ...
        }, i.addListener = function(a, i, l, s, c) {
            var f = t.event.dispatchListener(e, a, n, r);
            o(u).addListener(f, i, l, s, c);
        ...
        -1 !== o && -1 !== a) {
            ...
            var u = n.substring(0, o), l = e.trim(n.substring(o + 1, a)), s = "" === l ? [] : t.transform(l.split(","), e.trim, t.coerceToPrimitive), c = t.upgradePrimitiveFunc(u, null);
            return c.args = s, c;
        }
    ...
    t.expandCompactRec = function(e, n, r) {
        ...
        var l = r ? e.indexOf(r, o + 1) : e.length, s = e.substring(o + 1, l);
        ...
        for (;"string" == typeof e; ) {
            ...
            var u = r(o), l = 0 === a && i === e.length - 1;
            if (void 0 === u || null === u) return u;
            e = l ? u : e.substring(0, a) + u + e.substring(i + 1);
        }
        return e;
    }, t.fetchExpandChildren = function(n, r, o, a, i, u) {
        if (a.expander) {
            var l = t.expandExpander(n, a, u);
            if (t.isPrimitive(l) || !t.isPlainObject(l) || t.isArrayable(l) ^ t.isArrayable(n)) return l;
            e.extend(!0, n, l);
        }
        return t.each(a, function(e, l) {
            void 0 === e ? n[l] = void 0 : "expander" !== l && (o[r] = l, !0 !== t.getImmediate(u.exceptions, o, r) && u.strategy(n, l, r + 1, o, a, i));
        }), n;
    }, t.isUnexpandable = function(e) {
        return t.isPrimitive(e) || !t.isPlainObject(e);
    }, t.expandSource = function(e, n, r, o, a, i, u, l) {
        var s, c, f = t.derefMergePolicy(u);
        return "string" != typeof i || f.noexpand ? f.noexpand || t.isUnexpandable(i) ? s = i : i.expander ? s = t.expandExpander(a, i, e) : (s = t.freshContainer(i), 
        c = !0) : e.defaultEL && "{" !== i.charAt(0) ? s = i : (t.pushActivity("expandContextValue", "expanding context value %source held at path %path", {
            source: i,
            path: t.path.apply(null, o.slice(0, r))
        }), s = t.resolveContextValue(i, e), t.popActivity(1)), s !== t.NO_VALUE && a(s), 
        c && l(s, i, r, o, u), s;
        ...
        }, o = function(o, a, i, u, l, s) {
            if (t.guardCircularExpansion(u, i), o) {
                if (o.hasOwnProperty(a)) return o[a];
                void 0 === l && (l = n(e.source, u, i - 1, e.sourceStrategy), s = n(e.mergePolicy, u, i - 1, t.concreteTrundler));
                var c = e.sourceStrategy(l, a, i, u), f = t.concreteTrundler(s, a);
        ...
        if (t.guardCircularExpansion(a, a.length), t.isIoCReference(n)) {
            var u = t.parseContextReference(n), l = t.model.parseEL(u.path);
            i({
        ...
        var o = r.localRecord, a = n.expander.context, i = n.expander.segs, u = void 0 !== o[a], l = r.contextThat.lifecycleStatus, s = "treeConstructed" === l || "destroyed" === l, c = u ? o[a] : t.resolveContext(a, r.contextThat, s);
        if (c) {
            var f = c;
...
!function(e, t) {
    ...
    t.model.makeEnvironmentStrategy = function(e) {
        ...
        for (var i = o.strategies, u = n.length - a, l = r; l < u; ++l) {
            if (!e) return e;
            for (var s, c = 0; c < i.length && void 0 === (s = i[c](e, n[l], l + 1, n)); ++c) ;
            s === t.NO_VALUE && (s = void 0), e = s;
        }
        return e;
        ...
        var u = n.type || "default", l = o.resolvers[u];
        l || t.fail("Unable to find resolver of type " + u);
        var s = t.model.makeTrundler(o), c = {
            root: e,
            segs: a
        };
        return c = l(c, n, s), n.path && c && (c = s(c, n.path)), i ? c : c ? c.root : void 0;
    ...
    t.clearLinkCounts = function(e, n) {
        ...
        if ("string" == typeof r) if (t.isIoCReference(r)) {
            var l = (a = t.parseModelReference(e, r)).segs.indexOf("model");
            -1 === l ? o ? a.nonModel = !0 : i(' must be a reference into a component model via a path including the segment "model"') : (a.modelSegs = a.segs.slice(l + 1), 
        ...
        var s, c;
        return a.context ? ((s = t.resolveContext(a.context, e)) || i(" context must be a reference to an existing component"), 
        c = a.contextSegs ? t.getForComponent(s, a.contextSegs) : s) : c = e, a.nonModel || (t.isComponent(c) || u(c), 
        ...
        e.relays.push(u), u;
    }, t.relayRecursionBailout = 100, t.registerDirectChangeRelay = function(e, n, r, o, a, i, u, l) {
        var s = u.targetApplier || e.applier, c = u.sourceApplier || r.applier, f = s.applierId;
        n = t.makeArray(n);
        var d, p = function(r, c, d, p, m, g) {
            ...
            y || (y = t.registerRelayTransaction(v, s, h, u, l)), i && !u.targetApplier ? i(y.transaction, u.sourceApplier ? void 0 : r, o, n, p) : (!u.noRelayDeletesDirect && p && "DELETE" === p.type && y.transaction.fireChangeRequest({
                type: "DELETE",
                segs: n
        ...
        i(r), i(e);
        var l = t.filterKeys(a, [ "namespace", "priority" ]);
        a.update ? a.targetApplier ? t.registerDirectChangeRelay(e, n, r, o, u, null, {
            transactional: !1,
            targetApplier: a.targetApplier,
            update: a.update
        }, l) : t.registerDirectChangeRelay(r, o, e, [], u + "-transform", a.forwardAdapter, {
            transactional: !0,
            sourceApplier: a.forwardApplier
        }, l) : (t.registerDirectChangeRelay(r, o, e, n, u, a.forwardAdapter, {
            transactional: !1
        }, l), n && t.registerDirectChangeRelay(e, n, r, o, u, a.backwardAdapter, {
            transactional: !1
        }, l));
    ...
    }, t.makeTransformPackage = function(e, n, r, o, a, i, u, l) {
        var s = {
            forwardHolder: {
                model: n
            },
        ...
        s.generateAdapters = function(e) {
            if (s.forwardAdapterImpl = t.transformToAdapter(e ? e.newHolder.model : s.forwardHolder.model, o), 
            null !== r) {
                var a = t.model.transform.invertConfiguration(n);
                a !== t.model.transform.uninvertibleTransform ? (s.backwardHolder.model = a, s.backwardAdapterImpl = t.transformToAdapter(s.backwardHolder.model, r)) : s.backwardAdapterImpl = a;
            }
        }, s.forwardAdapter = function(e, n) {
            void 0 === n && s.generateAdapters(), t.model.guardedAdapter(e, a, s.forwardAdapterImpl, arguments);
        }, s.runTransform = function(e) {
            e.commit(), e.reset();
        }, s.forwardApplier = t.makeHolderChangeApplier(s.forwardHolder), s.forwardApplier.isRelayApplier = !0, 
        s.invalidator = t.makeEventFirer({
            name: "Invalidator for model relay with applier " + s.forwardApplier.applierId
        }), null !== r && (s.backwardApplier = t.makeHolderChangeApplier(s.backwardHolder), 
        s.backwardAdapter = function(e) {
            t.model.guardedAdapter(e, i, s.backwardAdapterImpl, arguments);
        }), s.update = s.invalidator.fire;
        var c = {
        ...
        return s.forwardHolder.model = t.parseImplicitRelay(e, n, [], c), s.refCount = c.refCount, 
        s.namespace = u, s.priority = l, s.generateAdapters(), s.invalidator.addListener(s.generateAdapters), 
        ...
        var l = t.model.parseRelayCondition(n.forward), s = t.model.parseRelayCondition(n.backward), c = t.makeTransformPackage(e, u, o.path, a.path, l, s, i, n.priority), f = {
        ...
        var l = t.transform(n, function(n) {
        ...
        u.initModels = l;
        var s = t.getInstantiator(e);
        return a.preCommit.addListener(function(e) {
            for (;t.model.updateRelays(s, e.id) > 0; ) ;
        }), a.preCommit.addListener(function(e, n, r) {
            "relay" !== r && t.model.commitRelays(s, e.id);
        }), a.postCommit.addListener(function(e, n, r) {
            "relay" !== r && (t.model.notifyExternal(s.modelTransactions[e.id]), delete s.modelTransactions[e.id]);
        }), null;
        ...
        var u = e[n], l = t.typeCode(a), s = t.typeCode(u), c = t.NO_VALUE;
        "primitive" === l ? t.model.isSameValue(u, a) || (c = a, ++i.unchanged) : (s !== l || "array" === l && a.length !== u.length) && (c = t.freshContainer(a)), 
        c !== t.NO_VALUE && (e[n] = c, i.changeMap && t.model.setChangedPath(i, o, i.inverse ? "DELETE" : "ADD")), 
        "primitive" !== l && t.model.fetchChangeChildren(e[n], r + 1, o, a, i);
        ...
        o = t.model.stepTargetAccess(e.model, n.type, n.segs, 0, a - 1, r)), "ADD" === n.type) {
            var u = n.value, l = t.makeArray(n.segs);
            t.model.applyChangeStrategy(o.root, o.last, a - 1, l, u, r, i);
        ...
        if ("primitive" === a && "primitive" === i) o = t.model.isSameValue(e, n); else if ("primitive" === a ^ "primitive" === i) o = !1; else {
            ...
            r.inverse = !0, t.model.applyHolderChangeRequest(l, {
                value: e,
                segs: [],
                type: "ADD"
            }, r), o = 0 === r.changes;
        ...
        for (var a = r.model, i = o.model, u = e, l = [ "model" ], s = !1, c = [], f = 0; f < n.length; ++f) {
            var d = n[f];
            "*" === d ? f === n.length - 1 ? s = !0 : t.fail("Wildcard specification in modelChanged listener is only supported for the final path segment: " + n.join(".")) : (l.push(d), 
            u = t.isPrimitive(u) ? u : u[d], a = a ? a[d] : void 0, i = i ? i[d] : void 0);
        }
        return u && (s ? "DELETE" === u ? t.outputMatches(c, l, i) : "ADD" === u ? t.outputMatches(c, l, a) : t.outputMatches(c, l, u) : c.push(l)), 
        c;
    ...
    }, t.notifyModelChanges = function(e, n, r, o, a, i, u, l) {
        if (e) for (var s = i && t.getModelTransactionRec(l, i.id), c = 0; c < e.length; ++c) for (var f = e[c], d = f.segsArray.length > 1, p = 0; p < f.segsArray.length; ++p) for (var m = t.matchChanges(n, f.segsArray[p], r, o), g = 0; g < m.length; ++g) {
            ...
            s && !f.isRelay && f.transactional ? t.storeExternalChange(s, u, h, f, v) : f.listener.apply(null, v);
        }
        ...
        return e.extend(a, {
            ...
            var u = "relay" === (e = "init" === o ? null : e || "local"), l = {
                ...
                reset: function() {
                    l.oldHolder = n, l.newHolder = {
                        model: t.copy(n.model)
                    }, l.changeRecord.changes = 0, l.changeRecord.unchanged = 0, l.changeRecord.changeMap = {};
                },
                commit: function(e) {
                    if (a.preCommit.fire(l, a, e), l.changeRecord.changes > 0) {
                        var r = {
                            model: n.model
                        };
                        n.model = l.newHolder.model, t.notifyModelChanges(a.transListeners.sortedListeners, l.changeRecord.changeMap, n, r, null, l, a, n);
                    }
                    u || a.postCommit.fire(l, a, e);
                },
                fireChangeRequest: function(e) {
                    t.preFireChangeRequest(a, e), e.transactionId = l.id;
                    var r = t.model.applyHolderChangeRequest(l.newHolder, e, l.changeRecord);
                    t.notifyModelChanges(a.listeners.sortedListeners, r, l.newHolder, n, e, l, a, n);
                },
                hasChangeSource: function(e) {
                    return l.fullSources[e];
                }
            }, s = t.getModelTransactionRec(n, l.id);
            return s && (t.mergeChangeSources(s.sources, o), l.sources = s.sources, l.fullSources = Object.create(s.sources), 
            l.fullSources[e] = !0), l.reset(), t.bindRequestChange(l), l;
...
!function(e, t) {
    ...
    t.registerNamespace("fluid.model.transform"), t.defaults("fluid.transformFunction", {
        ...
        if (t.hasGrade(o, "fluid.standardInputTransformFunction")) {
            ...
            var l = t.model.transform.getValue(e.inputPath, e.input, n);
            if (i.unshift(l), void 0 === l) return;
        }
        var s = a.apply(null, i);
        return t.hasGrade(o, "fluid.standardOutputTransformFunction") && void 0 !== (void 0 !== e.outputPath ? e.outputPath : r.doOutput ? "" : void 0) && void 0 !== s && (t.model.transform.setValue(e.outputPath, s, n), 
        s = void 0), s;
    };
    var n = [];
    t.registerNamespace("fluid.pathUtil"), t.pathUtil.getPathSegment = function(e, r) {
        ...
        t.each(n, function(n, r) {
            ...
            for (var a = 0; a < o.length; ++a) if (t.pathUtil.matchPath(o[a].matchPath, e.path, !0)) {
                ...
                var u = t.model.transform.lookupType(i.type), l = t.model.transform.doTransform(i, e, u);
                void 0 !== l && t.model.transform.setValue(null, l, e), e.outputPrefixOp.pop(), 
                e.inputPrefixOp.pop();
            }
        ...
        !i && !a) {
            ...
            if (u) {
                var l = t.makeArray(t.invokeGlobalFunction(u, [ e, n ]));
                Array.prototype.push.apply(n.inputPaths, l);
            }
        }
        ...
        return function(o, a, i, u) {
            for (var l = n.parser.compose.apply(null, u.slice(0, i)), s = 0; s < r.length; ++s) {
                var c = r[s];
                if (null !== t.pathUtil.matchPath(c, l, !0)) return e[c];
            }
        };
        ...
        o = o || {};
        var a = t.model.escapedGetConfig, i = t.model.escapedSetConfig, u = t.model.transform.decodeStrategy(n, o, a), l = {
            source: n,
            target: {
        ...
        t.model.transform.makeStrategy(l, t.model.transform.handleTransformStrategy), l.applier = {
            fireChangeRequest: function(e) {
                e.sequence = l.queuedChanges.length, l.queuedChanges.push(e);
            }
        }, t.bindRequestChange(l.applier), l.expand(r);
        var s = t.copy(i);
        return void 0 !== l.collectedFlatSchemaOpts && (e.extend(l.collectedFlatSchemaOpts, o.flatSchema), 
        u = t.model.transform.flatSchemaStrategy(l.collectedFlatSchemaOpts, a)), s.strategies = [ t.model.defaultFetchStrategy, u ? t.model.transform.schemaToCreatorStrategy(u) : t.model.defaultCreatorStrategy ], 
        l.finalApplier = o.finalApplier || t.makeHolderChangeApplier(l.target, {
            resolverSetConfig: s
        }), l.queuedTransforms.length > 0 && (l.typeStack = [], l.pathOp = t.model.makePathStack(l, "path"), 
        t.model.transform.expandWildcards(l, n)), t.model.fireSortedChanges(l.queuedChanges, l.finalApplier), 
        l.target.model;
...
!function(e, t) {
    ...
    t.defaults("fluid.transforms.identity", {
        ...
        for (var a = [], i = 0; i < o.length; ++i) {
            var u = o[i], l = u.inputPath ? t.model.transform.getValue(u.inputPath, void 0, r) : e, s = t.model.transform.matchValue(u.inputValue, l, u.partialMatches);
            a[i] = {
                index: i,
                matchValue: s
            };
        ...
        return t.each(e.match, function(o, u) {
            if (!0 !== o.outputUndefinedValue) {
                var l = {}, s = i(a ? o.inputValue : u, e.defaultInputValue);
                void 0 === s && t.fail("Failure inverting configuration for valueMapper - inputValue could not be resolved for record " + u + ": ", e), 
                l.outputValue = s, l.inputValue = !a && t.isPrimitive(o) ? o : i(o.outputValue, e.defaultOutputValue), 
                o.outputPath && (l.inputPath = t.model.composePaths(n.outputPrefix, i(o.outputPath, e.outputPath))), 
                o.inputPath && (l.outputPath = t.model.composePaths(n.inputPrefix, i(o.inputPath, e.inputPath))), 
                r.push(l);
            }
        }), o;
        ...
        var i = o.inputPrefixOp, u = o.outputPrefixOp, l = t.model.transform.applyPaths;
        l("push", i, n), l("push", u, r);
        var s = {};
        return t.each(a, function(n) {
            var r = o.expand(n);
            t.isPrimitive(r) ? s = r : e.extend(!0, s, r);
        }), l("pop", u, r), l("pop", i, n), s;
        ...
        return t.each(e, function(e, i) {
            var u = e[a], l = typeof u;
            "string" !== l && "boolean" !== l && "number" !== l && t.fail("indexArrayByKey encountered untransformable array due to missing or invalid key", e);
            var s = t.copy(e);
            delete s[a], n.innerValue && (s = t.model.transform.expandInnerValues([ r.inputPrefix, n.inputPath, i.toString() ], [ n.outputPath, u ], r, n.innerValue)), 
            o[u] = s;
        }), o;
        ...
        return t.each(n, function(n, u) {
            var l = {};
            l[i] = u, r.innerValue && (n = t.model.transform.expandInnerValues([ r.inputPath, u ], [ r.outputPath, a.length.toString() ], o, r.innerValue)), 
            e.extend(!0, l, n), a.push(l);
        }), a;
...
!function(e, t) {
    ...
    t.defaults("fluid.viewComponent", {
        ...
        return i.locate = function(o, i) {
            var l, s, c;
            if (void 0 !== (l = r[o])) return (s = i ? e(i) : n) || t.fail("DOM binder invoked for selector " + o + " without container"), 
            (c = "" === l ? s : l ? "function" == typeof l ? u(l.call(null, t.unwrap(s))) : u(l, s) : u()).selector || (c.selector = l, 
            c.context = s), c.selectorName = o, a(o, s, c), c;
        ...
        var l = u.options.jQuery;
        return t.log("Constructing view component " + n + " with container " + i.constructor.expando + (l ? " user jQuery " + l.expando : "") + " env: " + e.expando), 
        u;
        ...
        if (a) u = n; else {
            ...
            u = e.grep(u, function(e) {
                return e.name === i && (!l || t.dom.isContainer(l, e));
            });
        }
        if (void 0 === r) {
    ...
    if (!e.ArrayMath) {
        ...
        t.add = function(e, t, n) {
            ...
            l = r[i], s = o[i], c = a[i], e[i] = u * s - l * c, t[i] = u * c + l * s; else for (i = Math.min(e.length, t.length, o.length, a.length) - 1; i >= 0; --i) s = o[i], 
            ...
            t[i] = (l * s - u * c) * f; else for (i = Math.min(e.length, t.length, o.length, a.length) - 1; i >= 0; --i) f = 1 / ((s = o[i]) * s + (c = a[i]) * c), 
            ...
            for (var r = t.length - 1, o = Math.min(e.length, n.length) - 1; o >= 0; --o) {
                var a = n[o];
                a = a < 0 ? 0 : a > r ? r : a;
                var i = Math.floor(a), u = a - i, l = u * u, s = l * u, c = -2 * s + 3 * l, f = 1 - c, d = s - l, p = d - l + u, m = t[i > 0 ? i - 1 : 0], g = t[i], h = t[i < r ? i + 1 : r], v = t[i < r - 1 ? i + 2 : r];
            ...
            for (var r = t.length, o = r - 1, a = Math.min(e.length, n.length) - 1; a >= 0; --a) {
                var i = n[a];
                i -= Math.floor(i / r) * r;
                var u = Math.floor(i), l = i - u, s = l * l, c = s * l, f = -2 * c + 3 * s, d = 1 - f, p = c - s, m = p - s + l, g = t[u > 0 ? u - 1 : o], h = t[u], v = t[u < o ? u + 1 : 0], y = t[u < o - 1 ? u + 2 : u + 2 - Math.floor((u + 2) / r) * r];
            ...
            if (o) {
                ...
                if (a) {
                    ...
                    if (i) for (var l = Math.min(l, i.length), s = 0; s < l; ++s) e[t] = r[s], e[t + 1] = o[s], 
                    e[t + 2] = a[s], e[t + 3] = i[s], t += n; else for (s = 0; s < l; ++s) e[t] = r[s], 
                    e[t + 1] = o[s], e[t + 2] = a[s], t += n;
            ...
            if (o) {
                ...
                if (a) {
                    l = Math.min(l, a.length);
                    if (i) for (var l = Math.min(l, i.length), s = 0; s < l; ++s) r[s] = e[t], o[s] = e[t + 1], 
                    a[s] = e[t + 2], i[s] = e[t + 3], t += n; else for (s = 0; s < l; ++s) r[s] = e[t], 
                    o[s] = e[t + 1], a[s] = e[t + 2], t += n;
    ...
    if (!e.Filter) {
        ...
        t.prototype.filter = function(e, t) {
            ...
            for (n = 0; (f || d) && n < s; ++n) {
                ...
                p = i - f, f && f--;
                T = a[0] * t[n];
                for (A = 1; A < p; ++A) T += a[A] * t[n - A];
                for (;A < i; ++A) T += a[A] * l[A - p];
                for (p = o - d, d && d--, A = 0; A < p; ++A) T -= r[A] * e[n - 1 - A];
                for (;A < o; ++A) T -= r[A] * u[A - p];
                e[n] = T;
            }
            if (3 == i && 2 == o) for (var m, g, h = a[0], v = a[1], y = a[2], k = r[0], b = r[1], x = t[n - 1], S = t[n - 2], w = e[n - 1], C = e[n - 2]; n < s; ++n) m = S, 
            S = x, g = C, w = h * (x = t[n]) + v * S + y * m - k * (C = w) - b * g, e[n] = w; else for (;n < s; ++n) {
                var A, T = a[0] * t[n];
                for (A = 1; A < i; ++A) T += a[A] * t[n - A];
                for (A = 0; A < o; ++A) T -= r[A] * e[n - 1 - A];
                e[n] = T;
            }
            var N = Math.min(i - 1, s);
            for (n = i - 2; n >= N; --n) l[n] = l[n - N];
            for (n = 0; n < N; ++n) l[n] = t[s - 1 - n];
            for (N = Math.min(o, c), n = o - 1; n >= N; --n) u[n] = u[n - N];
            for (n = 0; n < N; ++n) u[n] = e[s - 1 - n];
    ...
    if (!e.FFT) {
        var t = function(e, t, n, r, o, a, i) {
            ...
            for (var u, l, s, c, f, d, p, m, g, h, v, y, k, b, x, S, w = 0, C = 0, A = 2 * r, T = n, N = n + i, I = n + 2 * i, M = a[r * i], P = .5773502691896258, D = T + i; T < D; ) g = e[T] * P, 
            h = t[T] * P, v = e[N] * P, y = t[N] * P, k = e[I] * P, b = t[I] * P, x = o[w], 
            c = v * (S = a[w]) + y * x, u = (s = v * x - y * S) - (f = k * (x = o[C]) - b * (S = a[C])), 
            l = c - (d = k * S + b * x), v = g - .5 * (p = s + f), y = h - .5 * (m = c + d), 
            u *= M, l *= M, e[T] = g + p, t[T] = h + m, e[I] = v + l, t[I] = y - u, e[N] = v - l, 
            t[N] = y + u, w += r, C += A, ++T, ++N, ++I;
        }, r = function(e, t, n, r, o, a, i, u) {
            for (var l, s, c, f, d, p, m, g, h, v, y, k, b, x, S, w, C, A, T, N, I, M, P = 0, D = 0, O = 0, L = 2 * r, R = 3 * r, E = n, V = n + i, F = n + 2 * i, B = n + 3 * i, q = E + i; E < q; ) b = .5 * e[E], 
            x = .5 * t[E], S = .5 * e[V], w = .5 * t[V], C = .5 * e[F], A = .5 * t[F], T = .5 * e[B], 
            N = .5 * t[B], l = S * (I = o[P]) - w * (M = a[P]), s = S * M + w * I, y = b - (c = C * (I = o[D]) - A * (M = a[D])), 
            k = x - (f = C * M + A * I), b += c, x += f, m = l + (d = T * (I = o[O]) - N * (M = a[O])), 
            g = s + (p = T * M + N * I), h = l - d, v = s - p, e[F] = b - m, t[F] = x - g, e[E] = b + m, 
            t[E] = x + g, u ? (e[V] = y - v, t[V] = k + h, e[B] = y + v, t[B] = k - h) : (e[V] = y + v, 
            t[V] = k - h, e[B] = y - v, t[B] = k + h), P += r, D += L, O += R, ++E, ++V, ++F, 
            ++B;
        }, o = function(e, t, n, r, o, a, i) {
            for (var u, l, s, c, f, d, p, m, g, h, v, y, k, b, x, S, w, C, A, T, N, I, M, P, D, O, L, R, E, V, F, B, q, _, G, j, U, H, W = 0, z = 0, $ = 0, K = 0, J = 2 * r, X = 3 * r, Q = 4 * r, Y = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, re = o[r * i], oe = a[r * i], ae = o[2 * r * i], ie = a[2 * r * i], ue = .4472135954999579, le = Y + i; Y < le; ) L = e[Y] * ue, 
            R = t[Y] * ue, E = e[Z] * ue, V = t[Z] * ue, F = e[ee] * ue, B = t[ee] * ue, q = e[te] * ue, 
            _ = t[te] * ue, G = e[ne] * ue, j = t[ne] * ue, u = L, l = R, s = E * (U = o[W]) - V * (H = a[W]), 
            c = E * H + V * U, f = F * (U = o[z]) - B * (H = a[z]), d = F * H + B * U, p = q * (U = o[$]) - _ * (H = a[$]), 
            m = q * H + _ * U, x = s + (g = G * (U = o[K]) - j * (H = a[K])), S = c + (h = G * H + j * U), 
            N = s - g, I = c - h, w = f + p, C = d + m, A = f - p, T = d - m, e[Y] = L + x + w, 
            t[Y] = R + S + C, v = u + x * re + w * ae, y = l + S * re + C * ae, k = I * oe + T * ie, 
            b = -N * oe - A * ie, e[Z] = v - k, t[Z] = y - b, e[ne] = v + k, t[ne] = y + b, 
            M = u + x * ae + w * re, P = l + S * ae + C * re, D = -I * ie + T * oe, O = N * ie - A * oe, 
            e[ee] = M + D, t[ee] = P + O, e[te] = M - D, t[te] = P - O, W += r, z += J, $ += X, 
            K += Q, ++Y, ++Z, ++ee, ++te, ++ne;
        }, a = function(e, t, n, r, o, a, i, u, l) {
            ...
            for (s = 0; s < i; ++s) {
                ...
                for (c = 0; c < u; ++c) {
                    p = k[0], m = b[0];
                    var w = 0;
                    for (f = 1; f < u; ++f) (w += S) >= l && (w -= l), g = k[f], h = b[f], p += g * (v = o[w]) - h * (y = a[w]), 
                    m += g * y + h * v;
                    e[d] = p, t[d] = m, d += i, S += r;
                }
            }
        }, i = function(e, u, l, s, c, f, d, p, m, g, h, v, y, k) {
            var b = m[g++], x = m[g++], S = l, w = l + b * x, C = d * p;
            if (1 == x) do {
                e[l] = s[f], u[l] = c[f], f += C, ++l;
            } while (l != w); else do {
                i(e, u, l, s, c, f, d * b, p, m, g, h, v, y, k), f += C, l += x;
            } while (l != w);
            switch (l = S, b) {
              case 2:
                t(e, u, l, d, h, v, x);
...
Random.prototype.exponential = function(e) {
    ...
    for (var u = Math.sqrt(2 * e - 1), l = e - this.LOG4, s = e + u; ;) if (!((i = this.random()) < 1e-7 || n > .9999999)) {
        var c = 1 - this.random(), f = Math.log(i / (1 - i)) / u, d = i * i * c, p = l + s * f - (a = e * Math.exp(f));
...
!function() {
    ...
    flock.shim = {
        ...
        return r *= flock.TWOPI, flock.generateBuffer(e, function(e) {
            var a, i, u, l = 0;
            for (a = 0; a < n; a++) i = o ? o[a] : 1, u = (a + 1) * (e * t), l += i * Math.cos(u + r);
            return l;
        });
        ...
        hermite: function(e, t) {
            var n = t.length, r = Math.floor(e), o = r % n, a = e - r, i = (o + 1) % n, u = (o + 2) % n, l = t[o > 0 ? o - 1 : n - 1], s = t[o], c = t[i], f = .5 * (c - l), d = s - c, p = f + d, m = p + d + .5 * (t[u] - s);
        ...
        t = flock.input.expandPath(t);
        var a = flock.get(e, t), i = t.lastIndexOf("."), u = t.slice(i + 1), l = i > -1 ? flock.get(e, t.slice(0, t.lastIndexOf(".inputs"))) : r, s = flock.input.resolveValue(e, t, n, l, u, a, o);
        ...
        if (void 0 !== i) {
            var u = i + o, l = o + a;
            if ("interconnect" === e && (u += a, l = t.length), !(u >= l)) return n.change("nextAvailableBus." + e, ++i), 
            u;
...
!function() {
    ...
    fluid.registerNamespace("flock.parse"), flock.parse.synthDef = function(e, t, n) {
        ...
        var l;
        l = t.options && void 0 !== t.options.sampleRate ? t.options.sampleRate : a[t.rate], 
        ...
        var s, c = t.rate === flock.rates.AUDIO ? i : 1;
        if (flock.hasTag(t.options, "flock.ugen.multiChannelOutput")) {
            var f = t.options.numOutputs || 1;
            s = [];
            for (var d = 0; d < f; d++) s.push(new Float32Array(c));
        } else s = new Float32Array(c);
        var p = fluid.copy(t.options);
        return p.buffers = o.buffers, p.buses = o.buses, p.enviro = r, flock.invoke(void 0, t.ugen, [ n, s, p ]);
    ...
    flock.parse.expandInputs = function(e) {
        ...
        var u, l = (t = flock.parse.ugenDef.mergeOptions(t, r)).inputs, s = {};
        for (u in l) {
            var c = l[u];
            null !== c && (s[u] = flock.input.shouldExpand(u, t) ? flock.parse.ugenForDef(c, n, r) : c);
        }
        ...
        var f = flock.parse.makeUGen(t, s, n, r);
...
!function() {
    ...
    flock.applyDeferred = function(e, t, n) {
        ...
        var n = t.src, r = n.indexOf(","), o = n.substring(0, r), a = n.substring(r + 1), i = o.indexOf(";base64"), u = i > -1, l = n.indexOf("data:") + 5, s = u ? i : r, c = n.substring(l, s);
...
!function() {
    ...
    fluid.registerNamespace("flock.audio.encode"), flock.audio.interleave = function(e) {
        var t, n, r = e.format.numSampleFrames, o = e.data.channels, a = e.format.numChannels, i = r * a, u = new Float32Array(i), l = 0;
        for (t = 0; t < r; t++) for (n = 0; n < a; n++) u[l] = o[n][t], l++;
        return u;
        ...
        flock.audio.encode.setString(h, 12, "fmt "), h.setUint32(16, u, !0), h.setUint16(20, l, !0), 
        h.setUint16(22, o, !0), h.setUint32(24, a, !0), h.setUint32(28, a * f, !0), h.setUint16(32, f, !0), 
        h.setUint16(34, d, !0);
        var v = 36;
        return 3 === l ? (h.setUint16(v, 0, !0), v += 2, v = flock.audio.encode.wav.writeFactChunk(h, v, e.format.numSampleFrames)) : 65534 === l && (h.setUint16(v, 22, !0), 
        ...
        flock.audio.encode.wav.writeDataChunk(n, v, h, r, s), h.buffer;
...
!function() {
    ...
    }), flock.midi.getFirstByte = function(e, t) {
        return (t << 4) + e;
    }, flock.midi.arrayToUint8TypedArray = function(e) {
        return new Uint8Array(e);
    }, flock.midi.write = function(e) {
        var t = e.channel ? e.channel : 0;
        switch (e.type) {
          case "noteOn":
            return flock.midi.arrayToUint8TypedArray([ flock.midi.getFirstByte(t, 9), e.note, e.velocity ]);

          case "noteOff":
            return flock.midi.arrayToUint8TypedArray([ flock.midi.getFirstByte(t, 8), e.note, e.velocity ]);

          case "aftertouch":
            return e.note ? flock.midi.arrayToUint8TypedArray([ flock.midi.getFirstByte(t, 10), e.note, e.velocity ]) : flock.midi.arrayToUint8TypedArray([ flock.midi.getFirstByte(t, 13), e.pressure ]);

          case "control":
            return flock.midi.arrayToUint8TypedArray([ flock.midi.getFirstByte(t, 11), e.number, e.value ]);

          case "program":
            return flock.midi.arrayToUint8TypedArray([ flock.midi.getFirstByte(t, 12), e.program ]);

          case "pitchbend":
            return flock.midi.arrayToUint8TypedArray([ flock.midi.getFirstByte(t, 14) ].concat(flock.midi.write.valueToTwoByteArray(e.value)));

          case "sysex":
            return flock.midi.write.sysex(e);

          case "songPointer":
            return flock.midi.arrayToUint8TypedArray([ flock.midi.getFirstByte(2, 15) ].concat(flock.midi.write.valueToTwoByteArray(e.value)));

          case "songSelect":
            return flock.midi.arrayToUint8TypedArray([ flock.midi.getFirstByte(3, 15) ].concat(flock.midi.write.valueToTwoByteArray(e.value)));
          ...
          default:
            flock.fail("Cannot handle MIDI message of type '" + e.type + "'.");
        }
    }, flock.midi.write.valueToTwoByteArray = function(e) {
        return [ 127 & e, e >> 7 & 127 ];
    }, flock.midi.write.sysex = function(e) {
        var t = e.data, n = t.length, r = new Uint8Array(t);
        return 240 !== t[0] && 247 !== t[n - 1] ? ((r = new Uint8Array(n + 2))[0] = 240, 
        r[n + 1] = 247, r.set(t, 1)) : 240 !== t[0] ? ((r = new Uint8Array(n + 1))[0] = 240, 
        r.set(t, 1)) : 247 !== t[n - 1] && ((r = new Uint8Array(n + 1))[n] = 247, r.set(t, 0)), 
        r;
...
!function() {
    ...
    flock.ugenDefaults = function(e, t) {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i, u, l, s, c, f, d = r.model, p = r.multiInputs.sources, m = r.options.buses, g = r.inputs.bus.output[0], h = r.inputs.expand.output[0];
            if (t = p.length, n = Math.max(h, t), !(t < 1)) {
                for (o = 0; o < n; o++) {
                    for (u = (i = p[o % t]).rate, l = m[g + o], s = u === flock.rates.AUDIO ? 1 : 0, 
                    c = 0, a = 0; a < e; a++, c += s) f = i.output[c], l[a] = l[a] + f;
        ...
        return r.singleBusGen = function(e) {
            ...
            var t, n, o, a = r.model, i = r.inputs.bus, u = r.options.buses, l = r.output;
            for (t = 0; t < e; t++) {
                for (o = 0, n = 0; n < i.length; n++) o += u[0 | i[n].output[0]][t];
                l[t] = o;
            }
            a.unscaledValue = o, r.mulAdd(e), a.value = flock.ugen.lastOutputValue(e, l);
        }, r.onInputChanged = function() {
...
!function() {
    ...
    flock.blit = function(e) {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n = r.model, o = r.output, a = r.inputs.freq.output[0], i = 1 - r.inputs.leakRate.output[0], u = n.phase, l = n.unscaledValue;
            for (void 0 === u && (flock.ugen.saw.updatePeriodState(n, a), u = n.d0 / 2), t = 0; t < e; t++) (u -= 1) < -2 && (flock.ugen.saw.updatePeriodState(n, a), 
            u += n.d0), o[t] = l = flock.blit(u) - n.dcOffset + i * l;
            n.phase = u, n.unscaledValue = l, r.mulAdd(e), n.value = flock.ugen.lastOutputValue(e, o);
        }, r.init = function() {
            r.onInputChanged();
        }, r.init(), r;
        ...
        return r.gen = function(e) {
            ...
            t = 0; t < e; t++) o[t] = l = flock.blit(u) * n.sign + i * l, u < -2 && (flock.ugen.square.updatePeriodState(n, a), 
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a = r.model, i = r.output, u = r.inputs.freq.output[0], l = 1 - r.inputs.leakRate.output[0], s = a.phase, c = a.unscaledValue, f = a.secondPrevVal;
            for (void 0 === s && (flock.ugen.tri.updatePeriodState(a, u), s = a.d0 / 4), t = 0; t < e; t++) c = n = flock.blit(s) * a.sign + l * c, 
            f = o = n + l * f, i[t] = o * a.ampScale, (s -= 1) < -2 && (flock.ugen.tri.updatePeriodState(a, u), 
            s += a.phaseResetValue);
            a.phase = s, a.unscaledValue = c, a.secondPrevVal = f, r.mulAdd(e), a.value = flock.ugen.lastOutputValue(e, i);
        }, r.init = function() {
            r.onInputChanged();
        }, r.init(), r;
...
!function() {
    ...
    flock.ugen.playBuffer = function(e, t, n) {
        ...
        return r.defaultKrTriggerGen = function(t) {
            var n, o, a = r.model, i = r.output, u = r.inputs.channel.output[0], l = r.buffer.data.channels[u], s = a.idx, c = r.inputs.loop.output[0], f = e.trigger.output[0];
            for (f > 0 && a.prevTrig <= 0 && (s = 0), a.prevTrig = f, n = 0; n < t; n++) {
                if (s > a.lastIdx) {
                    if (!(c > 0 && f > 0)) {
                        i[n] = o = 0;
                        continue;
                ...
                o = r.interpolate(s, l), i[n] = o, s++;
            }
            a.idx = s, a.unscaledValue = o, r.mulAdd(t), a.value = flock.ugen.lastOutputValue(t, i);
        }, r.otherwiseGen = function(t) {
            var n, o, a, i, u, l, s, c = r.model, f = r.output, d = r.inputs.channel.output[0], p = r.inputs.speed.output, m = r.buffer.data.channels[d], g = e.trigger.output, h = c.idx, v = r.inputs.loop.output[0], y = r.inputs.start.output[0] * c.lastIdx | 0, k = r.inputs.end.output[0] * c.lastIdx | 0;
            for (n = 0, o = 0, a = 0; n < t; n++, o += c.strides.trigger, a += c.strides.speed) {
                if (i = g[o], u = c.prevTrig, l = p[a], c.prevTrig = i, i > 0 && u <= 0) h = flock.ugen.playBuffer.resetIndex(l, y, k); else if (h < y || h > k) {
                    if (!(v > 0 && i > 0)) {
                        f[n] = s = 0;
                        continue;
                    }
                    h = flock.ugen.playBuffer.resetIndex(l, y, k);
                }
                s = r.interpolate(h, m), f[n] = s, h += c.stepSize * l;
            }
            c.idx = h, c.unscaledValue = s, r.mulAdd(t), c.value = flock.ugen.lastOutputValue(t, f);
        }, r.onInputChanged = function(e) {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i = r.model, u = i.strides.phase, l = r.output, s = r.inputs.channel.output[0], c = r.inputs.phase.output, f = r.buffer.data.channels[s], d = f.length;
            for (t = o = 0; t < e; t++, o += u) n = c[o] * d, a = r.interpolate(n, f), l[t] = a;
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a = r.model, i = r.output, u = r.inputs, l = r.buffer, s = r.multiInputs.sources, c = s.length, f = l.data.channels, d = l.format.numSampleFrames, p = u.start.output[0], m = u.loop.output[0];
            for (a.prevStart !== p && (a.prevStart = p, a.writeIdx = Math.floor(p)), t = 0; t < c; t++) {
                var g = s[t].output, h = f[t], v = i[t];
        ...
        return r.krGen = function(e) {
            var t, n = r.model, o = r.output, a = r.inputs.channel.output[0], i = r.buffer.data.channels[a], u = r.buffer.format.sampleRate, l = i.length / u;
            for (t = 0; t < e; t++) o[t] = l;
            n.unscaledValue = l, r.mulAdd(e), n.value = flock.ugen.lastOutputValue(e, o);
        }, r.onInputChanged = function(e) {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i, u, l, s, c, f, d = r.model, p = d.strides, m = r.output, g = r.inputs, h = r.buffers, v = h.length - 1, y = d.prevTrigger, k = d.maxVoices, b = d.activeVoices, x = d.freeVoices, S = g.trigger.output, w = p.trigger, C = 0, A = g.bufferIndex.output, T = p.bufferIndex, N = 0, I = g.speed.output, M = p.speed, P = 0, D = r.inputs.channel.output[0];
            for (t = 0; t < e; t++) {
                if ((n = S[C]) > 0 && y <= 0 && b.length < k) {
                    if (a = Math.round(A[N] * v), a = Math.max(0, a), a = Math.min(a, v), !(i = h[a])) continue;
                    (o = x.pop()).speed = I[P], o.currentIdx = 0, o.writePos = t, o.buffer = i.data.channels[D], 
                    b.push(o);
                }
                C += w, P += M, N += T, m[t] = 0, y = n;
            }
            for (u = 0; u < b.length; ) {
                for (l = (o = b[u]).buffer, s = Math.min(l.length - o.currentIdx, e), c = o.writePos; c < s; c++) f = r.interpolate ? r.interpolate(o.currentIdx, l) : l[0 | o.currentIdx], 
                m[c] += f, o.currentIdx += o.speed;
                o.currentIdx >= l.length ? (x.push(o), b.splice(u, 1)) : (o.writePos = 0, u++);
            }
...
!function() {
    ...
    flock.ugen.print = function(e, t, n) {
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a = r.inputs, i = r.output, u = r.model, l = u.label, s = a.channel, c = s ? a.source.output[s.output[0]] : a.source.output, f = a.trigger.output[0], d = a.freq.output[0];
            for (f > 0 && u.prevTrig <= 0 && fluid.log(fluid.logLevel.IMPORTANT, l + c), u.freq !== d && (u.sampInterval = Math.round(u.sampleRate / d), 
            u.freq = d, u.counter = u.sampInterval), t = 0, n = 0; t < e; t++, n += u.strides.source) u.counter >= u.sampInterval && (fluid.log(fluid.logLevel.IMPORTANT, l + c[n]), 
...
!function() {
    ...
    flock.ugen.distortion = function(e, t, n) {
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i, u = r.model, l = r.output, s = r.inputs.source.output, c = u.strides.source, f = r.inputs.gain.output, d = u.strides.gain;
            for (o = a = i = 0; o < e; o++, a += c, i += d) n = 1.5 * (t = s[a] * f[i]) - .5 * t * t * t, 
            l[o] = n;
            u.unscaledValue = n, r.mulAdd(e), u.value = flock.ugen.lastOutputValue(e, l);
        }, r.onInputChanged(), r;
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a = r.model, i = r.output, u = r.inputs.source.output, l = a.strides.source;
            for (n = o = 0; n < e; n++, o += l) t = Math.tanh(u[o]), i[n] = t;
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i, u, l, s = r.model, c = r.output, f = r.inputs.source.output, d = s.strides.source, p = r.inputs.amount.output, m = s.strides.amount;
            for (i = u = l = 0; i < e; i++, u += d, l += m) t = f[u], n = p[l], a = t * ((o = Math.abs(t)) + n) / (t * t + (n - 1) * o + 1), 
            c[i] = a;
            s.unscaledValue = a, r.mulAdd(e), s.value = flock.ugen.lastOutputValue(e, c);
        }, r.onInputChanged(), r;
    ...
    flock.ugen.distortion.tarrabiaDeJong = function(e, t, n) {
        ...
        return r.gen = function(e) {
            ...
            o = (1 + (l = 2 * n / (1 - n))) * t / (1 + l * Math.abs(t)), c[a] = o;
            s.unscaledValue = o, r.mulAdd(e), s.value = flock.ugen.lastOutputValue(e, c);
        }, r.onInputChanged(), r;
    ...
    flock.ugen.distortion.gloubiBoulga = function(e, t, n) {
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i, u, l, s = r.model, c = r.output, f = r.inputs.source.output, d = s.strides.source, p = r.inputs.gain.output, m = s.strides.gain;
            for (n = o = a = 0; n < e; n++, o += d, a += m) i = .686306 * (f[o] * p[a]), u = 1 + Math.exp(-.75 * Math.sqrt(Math.abs(i))), 
            t = ((l = Math.exp(i)) - Math.exp(-i * u)) / (l + Math.exp(-i)), c[n] = t;
            s.unscaledValue = t, r.mulAdd(e), s.value = flock.ugen.lastOutputValue(e, c);
        }, r.onInputChanged(), r;
...
!function() {
    ...
    flock.envelope.validate = function(e, t) {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n = r.model, o = n.stepSize, a = n.numSteps, i = a >= e ? e : a, u = e - i, l = n.level, s = r.output;
            for (t = 0; t < i; t++) s[t] = l, a--, l += o;
            if (u > 0) for (t = 0; t < u; t++) s[t] = l;
            n.level = n.unscaledValue = l, n.numSteps = a, r.mulAdd(e), n.value = flock.ugen.lastOutputValue(e, s);
        }, r.onInputChanged = function() {
            var e = r.model;
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n = r.model, o = n.multiplier, a = n.numSteps, i = a >= e ? e : a, u = e - i, l = n.level, s = r.output;
            for (t = 0; t < i; t++) s[t] = l, a--, l *= o;
            if (u > 0) for (t = 0; t < u; t++) s[t] = l;
            n.level = n.unscaledValue = l, n.numSteps = a, r.mulAdd(e), n.value = flock.ugen.lastOutputValue(e, s);
        }, r.onInputChanged = function() {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o = r.model, a = r.output, i = o.previousGate, u = r.inputs.gate.output[0], l = o.level, s = o.stage, c = s.currentStep, f = s.stepInc, d = s.numSteps, p = o.targetLevel, m = !1;
            ...
            m = !0), m && (f = (d = Math.round(t * o.sampleRate)) > 0 ? (p - l) / d : 0, c = 0, 
            d < 1 && (l = p)), n = 0; n < e; n++) a[n] = l, l = ++c < d ? l + f : c === d ? p : l;
            o.level = o.unscaledValue = l, o.targetLevel = p, o.previousGate = u, s.currentStep = c, 
            s.stepInc = f, s.numSteps = d, r.mulAdd(e), o.value = flock.ugen.lastOutputValue(e, a);
        }, r.init = function() {
            var e = r.model;
        ...
        var r = flock.ugen(e, t, n);
        return r.krGen = function(e) {
            var t, n = r.model, o = r.output, a = r.inputs, i = a.gate.output[0], u = a.timeScale.output[0], l = 0;
            for (flock.ugen.envGen.checkGate(r, i, u); l < e; ) t = Math.min(e - l, n.numSegmentSamps), 
            r.lineGen.gen(t, l, o, n), l += t, n.numSegmentSamps -= t, n.numSegmentSamps <= 0 && flock.ugen.envGen.nextStage(r, u);
            r.mulAdd(e), n.value = flock.ugen.lastOutputValue(e, o);
        }, r.arGen = function(e) {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a = r.model, i = r.inputs, u = r.output, l = i.step.output, s = i.trigger.output;
            for (void 0 === a.unscaledValue && (a.unscaledValue = i.start.output[0]), t = 0, 
            n = 0, o = 0; t < e; t++, n += a.strides.trigger, o += a.strides.step) s[n] > 0 && a.prevTrig <= 0 && (a.unscaledValue = i.reset.output[0]), 
            a.prevTrig = s[n], a.unscaledValue >= i.end.output[0] && (a.unscaledValue = i.start.output[0]), 
            u[t] = a.unscaledValue, a.unscaledValue += l[o];
...
!function() {
    ...
    flock.ugen.lag = function(e, t, n) {
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i = r.model, u = r.output, l = r.inputs, s = l.time.output[0], c = l.source.output, f = i.prevSamp, d = i.lagCoef;
            for (s !== i.prevTime && (i.prevtime = s, d = i.lagCoef = 0 === s ? 0 : Math.exp(flock.LOG001 / (s * i.sampleRate))), 
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o = r.model, a = r.inputs, i = r.output, u = o.coeffs, l = a.freq.output[0], s = a.q.output[0], c = a.source.output;
            for (o.prevFreq === l && o.prevQ === s || r.updateCoefficients(o, l, s), t = 0; t < e; t++) n = c[t] - u.a[0] * o.d0 - u.a[1] * o.d1, 
            i[t] = u.b[0] * n + u.b[1] * o.d0 + u.b[2] * o.d1, o.d1 = o.d0, o.d0 = n;
            o.prevQ = s, o.prevFreq = l, o.value = o.unscaledValue = flock.ugen.lastOutputValue(e, i);
        }, r.onInputChanged = function() {
    ...
    flock.coefficients = {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i, u, l, s = r.model, c = r.inputs, f = r.output, d = c.source.output, p = s.strides.source, m = c.resonance.output, g = s.strides.resonance, h = c.cutoff.output, v = s.strides.cutoff, y = s.f, k = s.fSq, b = s.fSqSq, x = s.oneMinusF, S = s.fb;
            for (t = n = o = a = 0; t < e; t++, n += p, o += g, a += v) i = h[a], u = m[o], 
            i !== s.prevCutoff && (i > s.nyquistRate && (i = s.nyquistRate), y = s.f = i / s.nyquistRate * 1.16, 
            k = s.fSq = y * y, b = s.fSqSq = k * k, x = s.oneMinusF = 1 - y, s.prevRes = void 0), 
            u !== s.prevRes && (u > 4 ? u = 4 : u < 0 && (u = 0), S = s.fb = u * (1 - .15 * k)), 
            l = d[n] - s.out4 * S, l *= .35013 * b, s.out1 = l + .3 * s.in1 + x * s.out1, s.in1 = l, 
            s.out2 = s.out1 + .3 * s.in2 + x * s.out2, s.in2 = s.out1, s.out3 = s.out2 + .3 * s.in3 + x * s.out3, 
            s.in3 = s.out2, s.out4 = s.out3 + .3 * s.in4 + x * s.out4, s.in4 = s.out3, f[t] = s.out4;
            s.unscaledValue = s.out4, r.mulAdd(e), s.value = flock.ugen.lastOutputValue(e, f);
        }, r.onInputChanged(), r;
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o = r.model, a = r.inputs, i = r.output, u = a.source.output, l = a.time.output[0], s = r.delayBuffer;
            for (l !== o.time && (o.time = l, o.delaySamps = l * r.model.sampleRate), t = 0; t < e; t++) o.pos >= o.delaySamps && (o.pos = 0), 
            i[t] = n = s[o.pos], s[o.pos] = u[t], o.pos++;
            o.unscaledValue = n, r.mulAdd(e), o.value = flock.ugen.lastOutputValue(e, i);
        }, r.onInputChanged = function(e) {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o = r.model, a = r.inputs, i = r.output, u = a.source.output, l = o.prevVal;
            for (t = 0; t < e; t++) i[t] = n = l, l = u[t];
            o.prevVal = l, o.unscaledValue = n, r.mulAdd(e), o.value = flock.ugen.lastOutputValue(e, i);
        }, r.onInputChanged = function() {
            flock.onMulAddInputChanged(r);
        }, r.onInputChanged(), r;
        ...
        r.gen = function(e) {
            var t, n, o, a = r.model, i = r.inputs, u = r.output, l = i.source.output, s = i.mix.output[0], c = 1 - s, f = .28 * i.room.output[0] + .7, d = .4 * i.damp.output[0], p = 1 - d;
            for (t = 0; t < e; t++) {
                var m = l[t], g = .015 * m;
                ...
                r.filtery_a[0] = r.filterx_a[0] - r.filtery_a[1], o = c * m + s * r.filtery_a[0], 
                u[t] = o;
            }
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o = r.model, a = r.inputs, i = r.output, u = a.source.output, l = a.time.output[0];
            if (l !== o.time && (o.time = l, o.coeff = 0 === l ? 0 : Math.exp(flock.LOG001 / (l * r.model.sampleRate))), 
...
!function() {
    ...
    flock.ugen.gate = function(e, t, n) {
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i = r.model, u = i.strides, l = r.output, s = r.inputs, c = s.source.output, f = s.sideChain.output, d = u.sideChain, p = s.threshold.output, m = u.threshold, g = r.options.holdLastValue, h = i.lastValue;
            for (t = n = o = 0; t < e; t++, n += d, o += m) f[n] >= p[o] ? l[t] = a = h = c[t] : l[t] = a = g ? h : 0;
            i.lastValue = h, i.unscaledValue = a, r.mulAdd(e), i.value = flock.ugen.lastOutputValue(e, l);
        }, r.onInputChanged = function() {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i = r.model, u = r.output, l = r.inputs.trigger.output, s = r.inputs.duration.output[0];
            for (s !== i.duration && (i.duration = s, i.durationSamps = Math.floor(s * i.sampleRate)), 
            n = o = 0; n < e; n++, o += i.strides.trigger) (t = l[o]) > 0 && i.prevTrigger <= 0 ? (a = r.options.resetOnTrigger && i.sampsRemaining > 0 ? 0 : 1, 
        ...
        return r.arGen = function(e) {
            var t, n, o, a, i = r.model, u = r.inputs, l = u.source.output, s = u.trigger, c = i.strides.source, f = r.output;
            for (void 0 === i.holdVal && (i.holdVal = l[0]), t = 0, n = 0; t < e; t++, n += c) (o = s.output[t]) > 0 && i.prevTrig <= 0 && (i.holdVal = l[n]), 
...
!function() {
    ...
    flock.ugen.triggerGrains = function(e, t, n) {
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i, u, l, s = r.model, c = r.inputs, f = r.output, d = c.channel.output[0], p = r.buffer.data.channels[d], m = r.buffer.format.sampleRate, g = c.dur.output[0], h = c.amp.output, v = c.centerPos.output, y = c.trigger.output, k = c.speed.output, b = r.options.grainEnv, x = e - 1, S = 0, w = 0, C = 0, A = 0;
            for (t = 0; t < e; t++) {
                if (y[w] > 0 && s.prevTrigger <= 0 && s.activeGrains.length < s.maxNumGrains) {
                    for ((a = s.freeGrains.pop()).numSamps = s.sampleRate * g, a.centerIdx = a.numSamps / 2 * s.stepSize, 
                    a.envScale = r.options.grainEnv.length / a.numSamps, a.sampIdx = 0, a.amp = h[C], 
                    i = v[S] * m - a.centerIdx; i < 0; ) i += p.length;
                    a.readPos = i, a.writePos = t, a.speed = k[A], s.activeGrains.push(a);
                }
                s.prevTrigger = y[w], f[t] = 0, S += s.strides.centerPos, w += s.strides.trigger, 
                C += s.strides.amp, A += s.strides.speed;
            }
            for (n = 0; n < s.activeGrains.length; ) {
                for (o = (a = s.activeGrains[n]).writePos; o < Math.min(o + (a.numSamps - a.sampIdx), e); o++) u = r.interpolate(a.readPos, p), 
                l = flock.interpolate.linear(a.sampIdx * a.envScale, b), f[o] += u * l * a.amp, 
                a.readPos = (a.readPos + s.stepSize * a.speed) % p.length, a.sampIdx++;
                a.sampIdx >= a.numSamps ? (s.freeGrains.push(a), s.activeGrains.splice(n, 1)) : (n++, 
                a.writePos = o % e);
            }
            s.unscaledValue = f[x], r.mulAdd(e), s.value = f[x];
        }, r.onBufferReady = function() {
            var e = r.model;
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i, u, l, s = r.model, c = r.options, f = r.inputs, d = r.output, p = r.delayLine, m = f.grainDur.output[0], g = f.delayDur.output[0], h = f.numGrains.output[0], v = f.source.output, y = c.maxDelayDur, k = c.grainEnv;
            for (s.delayDur !== g && (s.delayDur = g, g > y && (g = y), s.delayLength = g * s.sampleRate | 0, 
            s.writePos = s.writePos % s.delayLength), s.grainDur !== m && (s.grainDur = m, s.grainLength = s.sampleRate * s.grainDur | 0, 
            s.envScale = k.length / s.grainLength), h = h > c.maxNumGrains ? c.maxNumGrains : Math.round(h), 
            t = 0; t < e; t++) {
                for (p[s.writePos] = v[t], s.writePos = ++s.writePos % s.delayLength, o = 0, n = 0; n < h; n++) a = s.grainIdx[n], 
                i = s.delayLineIdx[n], a > s.grainLength && (a = 0, i = Math.random() * s.delayLength | 0), 
                u = p[i], l = a * s.envScale, o += u * flock.interpolate.linear(l, k), s.delayLineIdx[n] = ++i % s.delayLength, 
                s.grainIdx[n] = ++a;
                o /= h, d[t] = o;
            }
            s.unscaledValue = o, r.mulAdd(e), s.value = flock.ugen.lastOutputValue(e, d);
...
!function() {
    ...
    flock.ugen.amplitude = function(e, t, n) {
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a = r.model, i = r.inputs.source.output, u = r.output, l = a.attackTime, s = r.inputs.attack.output[0], c = a.releaseTime, f = r.inputs.release.output[0], d = a.prevVal, p = a.attackCoef, m = a.releaseCoef;
            for (s !== l && (a.attackTime = s, p = a.attackCoef = 0 === s ? 0 : Math.exp(flock.LOG01 / (s * a.sampleRate))), 
...
!function() {
    ...
    flock.ugen.midiFreq = function(e, t, n) {
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a = r.model, i = a.a4, u = i.freq, l = i.noteNum, s = a.notesPerOctave, c = r.inputs.note.output, f = r.output;
            for (t = 0, n = 0; t < e; t++, n += a.strides.note) f[t] = o = flock.midiFreq(c[n], u, l, s);
...
!function() {
    ...
    flock.ugen.pan2 = function(e, t, n) {
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i = r.model, u = r.output, l = u[0], s = u[1], c = r.inputs, f = c.source.output, d = c.pan.output;
            for (t = 0, n = 0; t < e; t++, n += i.strides.pan) o = f[t], a = .5 * d[n] + .5, 
            s[t] = o * Math.sin(a * flock.HALFPI), l[t] = o * Math.cos(a * flock.HALFPI);
            var p = e - 1;
...
!function() {
    ...
    flock.ugen.osc = function(e, t, n) {
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i, u = r.model, l = r.inputs, s = l.freq.output, c = l.phase.output, f = l.table, d = u.tableLen, p = u.tableIncHz, m = u.tableIncRad, g = r.output, h = u.phase;
            for (t = 0, n = 0, o = 0; t < e; t++, n += u.strides.phase, o += u.strides.freq) (a = h + c[n] * m) >= d ? a -= d : a < 0 && (a += d), 
            g[t] = i = r.interpolate(a, f), (h += s[o] * p) >= d ? h -= d : h < 0 && (h += d);
    ...
    flock.ugen.sin = function(e, t, n) {
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i = r.model, u = r.inputs.freq.output, l = r.inputs.phase.output, s = r.output, c = i.phase, f = i.sampleRate;
            for (t = 0, n = 0, o = 0; t < e; t++, n += i.strides.phase, o += i.strides.freq) s[t] = a = Math.sin(c + l[n]), 
            c += u[o] / f * flock.TWOPI;
            i.phase = c, i.unscaledValue = a, r.mulAdd(e), i.value = flock.ugen.lastOutputValue(e, s);
        }, r.onInputChanged = function() {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a = r.model, i = r.inputs.freq.output, u = r.output, l = a.scale, s = r.inputs.phase.output[0], c = a.phase;
            for (t = 0, n = 0; t < e; t++, n += a.strides.freq) u[t] = o = c + s, (c += i[n] * l) >= 1 ? c -= 2 : c <= -1 && (c += 2);
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a = r.inputs, i = r.model, u = a.freq.output, l = i.freqInc, s = a.width.output[0], c = r.output, f = i.scale, d = void 0 !== i.phase ? i.phase : a.phase.output[0];
            for (t = 0, n = 0; t < e; t++, n += l) d >= 1 ? (d -= 1, c[t] = o = s < .5 ? 1 : -1) : c[t] = o = d < s ? 1 : -1, 
            d += u[n] * f;
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a = r.inputs, i = r.model, u = r.output, l = a.freq.output, s = i.strides.freq, c = a.phase.output[0], f = i.phase, d = i.scale;
            for (f += c, t = 0, n = 0; t < e; t++, n += s) f >= 1 ? (f -= 1, o = 1) : o = 0, 
            u[t] = o, f += l[n] * d;
...
!function() {
    ...
    flock.ugen.dust = function(e, t, n) {
        ...
        return r.gen = function(t) {
            var n, o, a, i, u, l = r.model, s = r.output, c = e.density.output[0];
            for (c !== l.density ? (l.density = c, n = l.threshold = c * l.sampleDur, o = l.scale = n > 0 ? 1 / n : 0) : (n = l.threshold, 
            o = l.scale), u = 0; u < t; u++) i = (a = Math.random()) < n ? a * o : 0, s[u] = i;
            l.unscaledValue = i, r.mulAdd(t), l.value = flock.ugen.lastOutputValue(t, s);
        }, r.onInputChanged(), r;
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i = r.model, u = i.state, l = r.a, s = r.p, c = i.offset, f = r.output;
            for (t = 0; t < e; t++) {
                for (a = 0, n = 0; n < u.length; n++) o = Math.random(), u[n] = s[n] * (u[n] - o) + o, 
                a += l[n] * u[n];
                a = 2 * a - c, f[t] = a;
            }
            i.unscaledValue = a, r.mulAdd(e), i.value = flock.ugen.lastOutputValue(e, f);
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(t) {
            var n, o, a = r.model, i = e.freq.output[0], u = t, l = r.output, s = 0;
            i = i > .001 ? i : .001;
            do {
                ...
                a.ramp = 0)), u -= n = u < a.counter ? u : a.counter, a.counter -= n, o = 0; o < n; o++) l[s] = a.unscaledValue, 
                a.unscaledValue += a.ramp, s++;
            } while (u);
            r.mulAdd(t), a.value = flock.ugen.lastOutputValue(t, l);
        }, r.input = function() {
        ...
        return r.gen = function(e) {
            var t, n, o, a = r.model, i = r.generator, u = r.output, l = r.inputs.lambda.output, s = r.model.strides.lambda;
            for (t = n = 0; t < e; t++, n += s) u[t] = o = i.exponential(l[n]);
            a.unscaledValue = o, r.mulAdd(e), a.value = flock.ugen.lastOutputValue(e, u);
        }, r;
        ...
        var r = flock.ugen.random(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i = r.model, u = r.inputs, l = r.generator, s = r.output, c = i.strides.alpha, f = u.alpha.output, d = i.strides.beta, p = u.beta.output;
            for (t = n = o = 0; t < e; t++, n += c, o += d) s[t] = a = l.gamma(f[n], p[o]);
        ...
        var r = flock.ugen.random(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i = r.model, u = r.output, l = r.inputs, s = r.generator, c = i.strides.mu, f = l.mu.output, d = i.strides.sigma, p = l.sigma.output;
            for (t = n = o = 0; t < e; t++, n += c, o += d) u[t] = a = s.normal(f[n], p[o]);
            i.unscaledValue = a, r.mulAdd(e), i.value = flock.ugen.lastOutputValue(e, u);
        }, r;
        ...
        var r = flock.ugen.random(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a = r.model, i = r.generator, u = r.output, l = r.model.strides.alpha, s = r.inputs.alpha.output;
            for (t = n = 0; t < e; t++, n += l) u[t] = o = i.pareto(s[n]);
            a.unscaledValue = o, r.mulAdd(e), a.value = flock.ugen.lastOutputValue(e, u);
        }, r;
        ...
        var r = flock.ugen.random(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a = r.model, i = r.generator, u = r.output, l = r.model.strides.mode, s = r.inputs.mode.output;
            for (t = n = 0; t < e; t++, n += l) u[t] = o = i.triangular(-1, 1, s[n]);
            a.unscaledValue = o, r.mulAdd(e), a.value = flock.ugen.lastOutputValue(e, u);
        }, r;
        ...
        return r.gen = function(e) {
            var t, n, o, a, i = r.model, u = r.inputs, l = r.generator, s = r.output, c = i.strides.alpha, f = u.alpha.output, d = i.strides.beta, p = u.beta.output;
            for (t = n = o = 0; t < e; t++, n += c, o += d) s[t] = a = l.weibull(f[n], p[o]);
            i.unscaledValue = a, r.mulAdd(e), i.value = flock.ugen.lastOutputValue(e, s);
        }, r;
...
!function() {
    ...
    flock.ugen.change = function(e, t, n) {
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            for (var t, n = r.model, o = r.inputs.initial.output, a = n.strides.initial, i = r.inputs.target.output, u = n.strides.target, l = r.output, s = n.samplesLeft, c = n.crossfadeLevel, f = 0, d = 0, p = 0; f < e; f++, 
            d += a, p += u) s > 0 ? (t = o[d], s--) : c > 0 ? (t = o[d] * c + i[p] * (1 - c), 
            c -= n.crossfadeStepSize) : t = i[p], l[f] = t;
            n.samplesLeft = s, n.crossfadeLevel = c, n.value = n.unscaledValue = t;
        }, r.onInputChanged = function(e) {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i = r.model, u = r.output, l = r.inputs.list, s = l.length - 1, c = r.inputs.index.output;
            for (t = 0, o = 0; t < e; t++, o += i.strides.index) a = Math.round(c[o] * s), a = Math.max(0, a), 
            n = l[a = Math.min(a, s)], u[t] = n;
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a = r.inputs.values, i = r.inputs, u = i.freq.output, l = i.loop.output[0], s = r.model, c = s.scale, f = r.output, d = i.start ? Math.round(i.start.output[0]) : 0, p = i.end ? Math.round(i.end.output[0]) : a.length;
            for (void 0 === s.unscaledValue && (t = a[d], s.unscaledValue = void 0 === t ? 0 : t), 
            void 0 === s.nextIdx && (s.nextIdx = d), n = 0, o = 0; n < e; n++, o += s.strides.freq) {
                if (s.nextIdx >= p) {
                    if (!(l > 0)) {
                        f[n] = s.unscaledValue;
                        continue;
                ...
                f[n] = s.unscaledValue = a[s.nextIdx], s.phase += u[o] * c, s.phase >= 1 && (s.phase = 0, 
                s.nextIdx++);
            }
            r.mulAdd(e), s.value = flock.ugen.lastOutputValue(e, f);
        }, r.onInputChanged = function() {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o = r.model, a = r.options, i = a.resetOnNext, u = r.output, l = r.inputs.loop.output[0], s = r.inputs.durations, c = r.inputs.values;
            for (o.shouldValidateSequences && (o.shouldValidateSequences = !1, flock.ugen.sequencer.validateSequences(s, c)), 
            t = 0; t < e; t++) 0 !== c.length && 0 !== s.length ? (o.samplesRemaining <= 0 ? o.idx < s.length - 1 ? (o.idx++, 
            n = flock.ugen.sequencer.nextStage(s, c, i, o)) : l > 0 ? (o.idx = 0, n = flock.ugen.sequencer.nextStage(s, c, i, o)) : n = a.holdLastValue ? o.unscaledValue : 0 : (n = c[o.idx], 
...
!function() {
    ...
    flock.ugen.valueChangeTrigger = function(e, t, n) {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i, u = r.model, l = r.inputs.source.output, s = u.strides.source, c = r.inputs.duration.output, f = u.strides.duration, d = u.prevDur, p = r.output;
            for (t = n = o = 0; t < e; t++, n += s, o += f) a = l[n], (i = c[o]) !== d && (u.prevDur = i, 
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i, u = r.model, l = r.options, s = r.output, c = r.inputs, f = u.strides.trigger, d = u.strides.source, p = c.trigger.output, m = c.source.output, g = l.callback, h = g.func, v = g.args, y = g.this, k = u.lastArgIdx, b = u.prevTrig;
            for (t = n = o = 0; t < e; t++, n += f, o += d) a = p[n], i = m[o], a > 0 && b <= 0 && h && (v[k] = i, 
            h.apply(y, v)), s[t] = i, b = a;
...
!function() {
    ...
    fluid.registerNamespace("flock.view"), flock.view.scope = function(t, n) {
        ...
        return r.refreshView = function() {
            var e, t, n, o = r.ctx, a = r.model.height, i = r.model.halfHeight, u = r.model.width, l = r.model.values, s = l.length, c = r.model.scaleX * (u / s);
            for (o.clearRect(0, 0, u, a), o.beginPath(), e = 0; e < s; e++) t = e * c, n = l[e] * r.model.scaleY * i + i, 
            o.lineTo(t, n);
            o.stroke();
        }, r.init = function() {
...
!function() {
    ...
    fluid.registerNamespace("flock.ugen"), flock.ugen.scope = function(e, t, n) {
        ...
        return o.exponentialGen = function(e) {
            var t, n, r = o.model, a = flock.ugen.mouse.cursor.normalize(o.target, r), i = r.movingAvg, u = o.inputs.lag.output[0], l = o.inputs.add.output[0], s = o.inputs.mul.output[0], c = r.lagCoef, f = o.output;
            for (u !== c && (c = 0 === u ? 0 : Math.exp(flock.LOG001 / (u * r.sampleRate)), 
            r.lagCoef = c), t = 0; t < e; t++) n = s + l, i = (a = Math.pow(n / l, a) * l) + c * (i - a), 
            f[t] = i;
            r.movingAvg = i, r.value = r.unscaledValue = i;
        }, o.linearGen = function(e) {
            var t, n = o.model, r = flock.ugen.mouse.cursor.normalize(o.target, n), a = n.movingAvg, i = o.inputs.lag.output[0], u = o.inputs.add.output[0], l = o.inputs.mul.output[0], s = n.lagCoef, c = o.output;
            for (i !== s && (s = 0 === i ? 0 : Math.exp(flock.LOG001 / (i * n.sampleRate)), 
            n.lagCoef = s), t = 0; t < e; t++) a = r + s * (a - r), c[t] = a * l + u;
