...
!function(e, t) {
    ...
    var ye = function(e) {
        ...
        var k, b, x, S, C, w, A, N, T, I, M, P, D, O, L, R, E, V, F, q = "sizzle" + 1 * new Date(), B = e.document, _ = 0, G = 0, j = n(), U = n(), H = n(), W = function(e, t) {
            return e === t && (M = !0), 0;
        ...
        b = t.support = {}, C = t.isXML = function(e) {
            ...
            L = !C(D), B !== D && (n = D.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", xe, !1) : n.attachEvent && n.attachEvent("onunload", xe)), 
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return fe.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && se.test(n) && (t = w(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), 
        ...
        return c.prototype = x.filters = x.pseudos, x.setFilters = new c(), w = t.tokenize = function(e, n) {
            ...
            var n, r = [], o = [], a = H[e + " "];
            if (!a) {
                for (t || (t = w(e)), n = t.length; n--; ) (a = v(t[n]))[q] ? r.push(a) : o.push(a);
                (a = H(e, y(o, r))).selector = e;
            }
            return a;
        }, N = t.select = function(e, t, n, r) {
            var o, a, i, u, l, c = "function" == typeof e && e, d = !r && w(e = c.selector || e);
            if (n = n || [], 1 === d.length) {
    ...
    var St = e.location, Ct = pe.now(), wt = /\?/;
    ...
    Bt.href = St.href, pe.extend({
        ...
        ajax: function(t, n) {
            function r(t, n, r, u) {
                var s, d, p, b, x, S = n;
                c || (c = !0, l && e.clearTimeout(l), o = void 0, i = u || "", C.readyState = t > 0 ? 4 : 0, 
                s = t >= 200 && t < 300 || 304 === t, r && (b = Y(m, C, r)), b = Z(m, b, C, s), 
                s ? (m.ifModified && ((x = C.getResponseHeader("Last-Modified")) && (pe.lastModified[a] = x), 
                (x = C.getResponseHeader("etag")) && (pe.etag[a] = x)), 204 === t || "HEAD" === m.type ? S = "nocontent" : 304 === t ? S = "notmodified" : (S = b.state, 
                d = b.data, s = !(p = b.error))) : (p = S, !t && S || (S = "error", t < 0 && (t = 0))), 
                C.status = t, C.statusText = (n || S) + "", s ? v.resolveWith(g, [ d, S, C ]) : v.rejectWith(g, [ C, S, p ]), 
                C.statusCode(k), k = void 0, f && h.trigger(s ? "ajaxSuccess" : "ajaxError", [ C, m, s ? d : p ]), 
                y.fireWith(g, [ C, S ]), f && (h.trigger("ajaxComplete", [ C, m ]), --pe.active || pe.event.trigger("ajaxStop")));
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var o, a, i, u, l, s, c, f, d, p, m = pe.ajaxSetup({}, n), g = m.context || m, h = m.context && (g.nodeType || g.jquery) ? pe(g) : pe.event, v = pe.Deferred(), y = pe.Callbacks("once memory"), k = m.statusCode || {}, b = {}, x = {}, S = "canceled", C = {
                readyState: 0,
                ...
                statusCode: function(e) {
                    var t;
                    if (e) if (c) C.always(e[C.status]); else for (t in e) k[t] = [ k[t], e[t] ];
                    return this;
                },
                abort: function(e) {
                    var t = e || S;
            ...
            if (v.promise(C), m.url = ((t || m.url || St.href) + "").replace(Et, St.protocol + "//"), 
            ...
            m.data && (a += (wt.test(a) ? "&" : "?") + m.data, delete m.data), !1 === m.cache && (a = a.replace(Dt, "$1"), 
            p = (wt.test(a) ? "&" : "?") + "_=" + Ct++ + p), m.url = a + p), m.ifModified && (pe.lastModified[a] && C.setRequestHeader("If-Modified-Since", pe.lastModified[a]), 
            pe.etag[a] && C.setRequestHeader("If-None-Match", pe.etag[a])), (m.data && m.hasContent && !1 !== m.contentType || n.contentType) && C.setRequestHeader("Content-Type", m.contentType), 
            C.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + qt + "; q=0.01" : "") : m.accepts["*"]);
            for (d in m.headers) C.setRequestHeader(d, m.headers[d]);
            if (m.beforeSend && (!1 === m.beforeSend.call(g, C, m) || c)) return C.abort();
            if (S = "abort", y.add(m.complete), C.done(m.success), C.fail(m.error), o = X(Ft, m, n, C)) {
                if (C.readyState = 1, f && h.trigger("ajaxSend", [ C, m ]), c) return C;
    ...
    pe.ajaxSetup({
        ...
        u ? t[u] = t[u].replace(Ut, "$1" + o) : !1 !== t.jsonp && (t.url += (wt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), 
...
!function(e, t) {
    ...
    if (!e.Filter) {
        ...
        t.prototype.filter = function(e, t) {
            ...
            if (3 == i && 2 == o) for (var m, g, h = a[0], v = a[1], y = a[2], k = r[0], b = r[1], x = t[n - 1], S = t[n - 2], C = e[n - 1], w = e[n - 2]; n < s; ++n) m = S, 
            S = x, g = w, C = h * (x = t[n]) + v * S + y * m - k * (w = C) - b * g, e[n] = C; else for (;n < s; ++n) {
                var A, N = a[0] * t[n];
    ...
    if (!e.FFT) {
        var t = function(e, t, n, r, o, a, i) {
            ...
            for (var u, l, s, c, f, d, p, m, g, h, v, y, k, b, x, S, C = 0, w = 0, A = 2 * r, N = n, T = n + i, I = n + 2 * i, M = a[r * i], P = .5773502691896258, D = N + i; N < D; ) g = e[N] * P, 
            ...
            for (var l, s, c, f, d, p, m, g, h, v, y, k, b, x, S, C, w, A, N, T, I, M, P = 0, D = 0, O = 0, L = 2 * r, R = 3 * r, E = n, V = n + i, F = n + 2 * i, q = n + 3 * i, B = E + i; E < B; ) b = .5 * e[E], 
            x = .5 * t[E], S = .5 * e[V], C = .5 * t[V], w = .5 * e[F], A = .5 * t[F], N = .5 * e[q], 
            T = .5 * t[q], l = S * (I = o[P]) - C * (M = a[P]), s = S * M + C * I, y = b - (c = w * (I = o[D]) - A * (M = a[D])), 
            k = x - (f = w * M + A * I), b += c, x += f, m = l + (d = N * (I = o[O]) - T * (M = a[O])), 
            ...
            for (var u, l, s, c, f, d, p, m, g, h, v, y, k, b, x, S, C, w, A, N, T, I, M, P, D, O, L, R, E, V, F, q, B, _, G, j, U, H, W = 0, z = 0, $ = 0, K = 0, J = 2 * r, X = 3 * r, Q = 4 * r, Y = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, re = o[r * i], oe = a[r * i], ae = o[2 * r * i], ie = a[2 * r * i], ue = .4472135954999579, le = Y + i; Y < le; ) L = e[Y] * ue, 
            ...
            t[Y] = R + S + w, v = u + x * re + C * ae, y = l + S * re + w * ae, k = I * oe + N * ie, 
            b = -T * oe - A * ie, e[Z] = v - k, t[Z] = y - b, e[ne] = v + k, t[ne] = y + b, 
            M = u + x * ae + C * re, P = l + S * ae + w * re, D = -I * ie + N * oe, O = T * ie - A * oe, 
            ...
            for (s = 0; s < i; ++s) {
                ...
                for (c = 0; c < u; ++c) {
                    p = k[0], m = b[0];
                    var C = 0;
                    for (f = 1; f < u; ++f) (C += S) >= l && (C -= l), g = k[f], h = b[f], p += g * (v = o[C]) - h * (y = a[C]), 
                    m += g * y + h * v;
                    e[d] = p, t[d] = m, d += i, S += r;
                }
            }
        }, i = function(e, u, l, s, c, f, d, p, m, g, h, v, y, k) {
            var b = m[g++], x = m[g++], S = l, C = l + b * x, w = d * p;
            if (1 == x) do {
                e[l] = s[f], u[l] = c[f], f += w, ++l;
            } while (l != C); else do {
                i(e, u, l, s, c, f, d * b, p, m, g, h, v, y, k), f += w, l += x;
            } while (l != C);
            switch (l = S, b) {
              case 2:
                t(e, u, l, d, h, v, x);
...
!function() {
    ...
    flock.ugen.playBuffer = function(e, t, n) {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i, u, l, s, c, f, d = r.model, p = d.strides, m = r.output, g = r.inputs, h = r.buffers, v = h.length - 1, y = d.prevTrigger, k = d.maxVoices, b = d.activeVoices, x = d.freeVoices, S = g.trigger.output, C = p.trigger, w = 0, A = g.bufferIndex.output, N = p.bufferIndex, T = 0, I = g.speed.output, M = p.speed, P = 0, D = r.inputs.channel.output[0];
            for (t = 0; t < e; t++) {
                if ((n = S[w]) > 0 && y <= 0 && b.length < k) {
...
!function() {
    ...
    flock.ugen.triggerGrains = function(e, t, n) {
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i, u, l, s = r.model, c = r.inputs, f = r.output, d = c.channel.output[0], p = r.buffer.data.channels[d], m = r.buffer.format.sampleRate, g = c.dur.output[0], h = c.amp.output, v = c.centerPos.output, y = c.trigger.output, k = c.speed.output, b = r.options.grainEnv, x = e - 1, S = 0, C = 0, w = 0, A = 0;
            for (t = 0; t < e; t++) {
                if (y[C] > 0 && s.prevTrigger <= 0 && s.activeGrains.length < s.maxNumGrains) {
                    for ((a = s.freeGrains.pop()).numSamps = s.sampleRate * g, a.centerIdx = a.numSamps / 2 * s.stepSize, 
                    a.envScale = r.options.grainEnv.length / a.numSamps, a.sampIdx = 0, a.amp = h[w], 
                    i = v[S] * m - a.centerIdx; i < 0; ) i += p.length;
                    a.readPos = i, a.writePos = t, a.speed = k[A], s.activeGrains.push(a);
                }
                s.prevTrigger = y[C], f[t] = 0, S += s.strides.centerPos, C += s.strides.trigger, 
                w += s.strides.amp, A += s.strides.speed;
            }
