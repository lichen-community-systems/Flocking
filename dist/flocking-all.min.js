...
!function(e, t) {
    ...
    var m = function(n) {
        var e, p, b, a, o, m, f, g, x, l, s, S, w, i, C, h, u, c, v, A = "sizzle" + 1 * new Date(), y = n.document, N = 0, r = 0, d = ie(), k = ie(), T = ie(), I = function(e, t) {
            return e === t && (s = !0), 0;
        }, M = {}.hasOwnProperty, t = [], P = t.pop, D = t.push, O = t.push, L = t.slice, E = function(e, t) {
        ...
        function ae(e, t, n, r) {
            ...
            if (!r && ((t ? t.ownerDocument || t : y) !== w && S(t), t = t || w, C)) {
                if (11 !== d && (l = Q.exec(e))) if (o = l[1]) {
                    ...
                    if ((o = l[3]) && p.getElementsByClassName && t.getElementsByClassName) return O.apply(n, t.getElementsByClassName(o)), 
                    n;
                }
        ...
        function xe(p, m, g, h, v, e) {
            return h && !h[A] && (h = xe(h)), v && !v[A] && (v = xe(v, e)), ue(function(e, t, n, r) {
                ...
                } else d = be(d === t ? d.splice(s, d.length) : d), v ? v(null, t, d, r) : O.apply(t, d);
            });
        }
        function Se(e) {
        ...
        return he.prototype = b.filters = b.pseudos, b.setFilters = new he(), m = ae.tokenize = function(e, t) {
            ...
            if (!i) {
                ...
                (i = T(e, (h = a, y = 0 < (v = o).length, k = 0 < h.length, r = function(e, t, n, r, o) {
                    ...
                    if (l += s, y && s !== l) {
                        ...
                        O.apply(r, f), o && !e && 0 < f.length && 1 < l + v.length && ae.uniqueSort(r);
                    }
                    return o && (N = m, x = d), c;
                }, y ? ue(r) : r))).selector = e;
            }
            ...
            if (n = n || [], 1 === c.length) {
                ...
                for (o = $.needsContext.test(e) ? 0 : a.length; o-- && (i = a[o], !b.relative[u = i.type]); ) if ((l = b.find[u]) && (r = l(i.matches[0].replace(Z, ee), Y.test(a[0].type) && ge(t.parentNode) || t))) {
                    if (a.splice(o, 1), !(e = r.length && ve(a))) return O.apply(n, r), n;
                    break;
                }
            }
    ...
    function Re(n, r, o, a) {
        ...
        t || a)) {
            for (u = (i = A.map(pe(e, "script"), Oe)).length; c < f; c++) l = e, c !== d && (l = A.clone(l, !0, !0), 
    ...
    var It = /%20/g, Mt = /#.*$/, Pt = /([?&])_=[^&]*/, Dt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Ot = /^(?:GET|HEAD)$/, Lt = /^\/\//, Et = {}, Rt = {}, Vt = "*/".concat("*"), Ft = C.createElement("a");
    function qt(a) {
        return function(e, t) {
        ...
        ajax: function(e, t) {
            ...
            var c, f, d, n, p, r, m, g, o, a, h = A.ajaxSetup({}, t), v = h.context || h, y = h.context && (v.nodeType || v.jquery) ? A(v) : A.event, k = A.Deferred(), b = A.Callbacks("once memory"), x = h.statusCode || {}, i = {}, u = {}, l = "canceled", S = {
                ...
                getResponseHeader: function(e) {
                    var t;
                    if (m) {
                        if (!n) for (n = {}; t = Dt.exec(d); ) n[t[1].toLowerCase()] = t[2];
                        t = n[e.toLowerCase()];
                    }
            ...
            h.type = h.type.toUpperCase(), h.hasContent = !Ot.test(h.type), f = h.url.replace(Mt, ""), 
            ...
            switch (n = h, m) {
              ...
              case 4:
                !function(e, t, n, r, o, a, i, u) {
                    for (var l, s, c, f, d, p, m, g, h, v, y, k, b, x, S, w, C, A, N, T, I, M, P = 0, D = 0, O = 0, L = 2 * r, E = 3 * r, R = n, V = n + i, F = n + 2 * i, q = n + 3 * i, B = R + i; R < B; ) b = .5 * e[R], 
                    x = .5 * t[R], S = .5 * e[V], w = .5 * t[V], C = .5 * e[F], A = .5 * t[F], N = .5 * e[q], 
                    ...
                    t[R] = x + g, u ? (e[V] = y - v, t[V] = k + h, e[q] = y + v, t[q] = k - h) : (e[V] = y + v, 
                    t[V] = k - h, e[q] = y - v, t[q] = k + h), P += r, D += L, O += E, ++R, ++V, ++F, 
                    ++q;
                }(e, t, n, i, c, f, g, p);
                break;
              ...
              case 5:
                !function(e, t, n, r, o, a, i) {
                    for (var u, l, s, c, f, d, p, m, g, h, v, y, k, b, x, S, w, C, A, N, T, I, M, P, D, O, L, E, R, V, F, q, B, _, G, j, U, H, W = 0, z = 0, $ = 0, K = 0, J = 2 * r, X = 3 * r, Q = 4 * r, Y = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, re = o[r * i], oe = a[r * i], ae = o[2 * r * i], ie = a[2 * r * i], ue = .4472135954999579, le = Y + i; Y < le; ) L = e[Y] * ue, 
...
!function() {
    ...
    flock.ugen.playBuffer = function(y, e, t) {
        ...
        var D = flock.ugen(e, t, n);
        return D.gen = function(e) {
            var t, n, r, o, a, i, u, l, s, c, f = D.model, d = f.strides, p = D.output, m = D.inputs, g = D.buffers, h = g.length - 1, v = f.prevTrigger, y = f.maxVoices, k = f.activeVoices, b = f.freeVoices, x = m.trigger.output, S = d.trigger, w = 0, C = m.bufferIndex.output, A = d.bufferIndex, N = 0, T = m.speed.output, I = d.speed, M = 0, P = D.inputs.channel.output[0];
            for (t = 0; t < e; t++) {
            ...
            for (i = 0; i < k.length; ) {
                for (u = (r = k[i]).buffer, l = Math.min(u.length - r.currentIdx, e), s = r.writePos; s < l; s++) c = D.interpolate ? D.interpolate(r.currentIdx, u) : u[0 | r.currentIdx], 
                p[s] += c, r.currentIdx += r.speed;
                r.currentIdx >= u.length ? (b.push(r), k.splice(i, 1)) : (r.writePos = 0, i++);
            }
            f.prevTrigger = v, f.unscaledValue = c, D.mulAdd(e), f.value = flock.ugen.lastOutputValue(e, p);
        }, D.init = function() {
            D.buffers = [], D.allocateVoices(), D.onInputChanged();
        }, D.allocateVoices = function() {
            for (var e = 0; e < D.model.maxVoices; e++) D.model.freeVoices.push({});
        }, D.onInputChanged = function() {
            var e, t, n = D.enviro.buffers, r = D.options.bufferIDs;
            for (e = D.buffers.length = 0; e < r.length; e++) t = n[r[e]], D.buffers.push(t);
            flock.onMulAddInputChanged(D), D.calculateStrides();
        }, D.init(), D;
