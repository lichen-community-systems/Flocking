...
!function(e, t) {
    ...
    function g(e, t, n, r) {
        var o, a = 1, i = 20, u = r ? function() {
            ...
            return pe.css(e, t, "");
        }, l = u(), s = n && n[3] || (pe.cssNumber[t] ? "" : "px"), c = (pe.cssNumber[t] || "px" !== s && +l) && qe.exec(pe.css(e, t));
        if (c && c[3] !== s) {
            s = s || c[3], n = n || [], c = +l || 1;
            do {
    ...
    function P(e, t, r, o) {
        ...
        i || o)) {
            for (l = (u = pe.map(y(a, "script"), N)).length; f < d; f++) s = a, f !== p && (s = pe.clone(s, !0, !0), 
            l && pe.merge(u, y(s, "script"))), r.call(e[f], s, f);
            if (l) for (c = u[u.length - 1].ownerDocument, pe.map(u, T), f = 0; f < l; f++) s = u[f], 
    ...
    function F(e, t, n, r, o) {
        var a, i = 0;
        for (a = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0; a < 4; a += 2) "margin" === n && (i += pe.css(e, n + Be[a], !0, o)), 
        r ? ("content" === n && (i -= pe.css(e, "padding" + Be[a], !0, o)), "margin" !== n && (i -= pe.css(e, "border" + Be[a] + "Width", !0, o))) : (i += pe.css(e, "padding" + Be[a], !0, o), 
        "padding" !== n && (i += pe.css(e, "border" + Be[a] + "Width", !0, o)));
        return i;
    }
    function q(e, t, n) {
    ...
    var ye = function(e) {
        function t(e, t, n, r) {
            ...
            if (!r && ((t ? t.ownerDocument || t : B) !== D && P(t), t = t || D, L)) {
                ...
                if (b.qsa && !H[e + " "] && (!R || !R.test(e))) {
                    if (1 !== m) p = t, d = e; else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((u = t.getAttribute("id")) ? u = u.replace(ke, be) : t.setAttribute("id", u = q), 
        ...
        function d(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                } else for (;t = t[r]; ) if (1 === t.nodeType || i) if (f = t[q] || (t[q] = {}), 
        ...
        function h(e, t, n, o, a, i) {
            return o && !o[q] && (o = h(o)), a && !a[q] && (a = h(a, i)), r(function(r, i, u, l) {
        ...
        function v(e) {
            for (var t, n, r, o = e.length, a = x.relative[e[0].type], i = a || x.relative[" "], u = a ? 1 : 0, l = d(function(e) {
                ...
                var o = !a && (r || n !== T) || ((t = n).nodeType ? l(e, n, r) : s(e, n, r));
                return t = null, o;
            } ]; u < o; u++) if (n = x.relative[e[u].type]) c = [ d(p(c), n) ]; else {
                if ((n = x.filter[e[u].type].apply(null, e[u].matches))[q]) {
        ...
        function y(e, n) {
            var o = n.length > 0, a = e.length > 0, i = function(r, i, u, l, s) {
                var c, f, d, p = 0, m = "0", h = r && [], v = [], y = T, k = r || a && x.find.TAG("*", s), b = _ += null == y ? 1 : Math.random() || .1, S = k.length;
                for (s && (T = i === D || i || s); m !== S && null != (c = k[m]); m++) {
                    if (a && c) {
        ...
        var k, b, x, S, w, C, A, N, T, I, M, P, D, O, L, R, E, V, F, q = "sizzle" + 1 * new Date(), B = e.document, _ = 0, G = 0, j = n(), U = n(), H = n(), W = function(e, t) {
            return e === t && (M = !0), 0;
        ...
        try {
            X.apply($ = Q.call(B.childNodes), B.childNodes), $[B.childNodes.length].nodeType;
        } catch (e) {
            X = {
        ...
        b = t.support = {}, w = t.isXML = function(e) {
            ...
            L = !w(D), B !== D && (n = D.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", xe, !1) : n.attachEvent && n.attachEvent("onunload", xe)), 
            b.attributes = o(function(e) {
                ...
                e.querySelectorAll("[id~=" + q + "-]").length || R.push("~="), e.querySelectorAll(":checked").length || R.push(":checked"), 
            ...
            t = me.test(O.compareDocumentPosition), F = t || me.test(O.contains) ? function(e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === D || e.ownerDocument === B && F(B, e) ? -1 : t === D || t.ownerDocument === B && F(B, t) ? 1 : I ? Y(I, e) - Y(I, t) : 0 : 4 & n ? -1 : 1);
            } : function(e, t) {
                if (e === t) return M = !0, 0;
                ...
                for (;u[r] === l[r]; ) r++;
                return r ? i(u[r], l[r]) : u[r] === B ? -1 : l[r] === B ? 1 : 0;
            }, D) : D;
            ...
            filter: {
                    ...
                    return 1 === r && 0 === o ? function(e) {
                        ...
                        if (h) {
                            ...
                            if (m = [ i ? h.firstChild : h.lastChild ], i && y) {
                                for (k = (p = (s = (c = (f = (d = h)[q] || (d[q] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === _ && s[1]) && s[2], 
                                d = p && h.childNodes[p]; d = ++p && d && d[g] || (k = p = 0) || m.pop(); ) if (1 === d.nodeType && ++k && d === t) {
                                    c[e] = [ _, p, k ];
                                    break;
                                }
                            } else if (y && (k = p = (s = (c = (f = (d = t)[q] || (d[q] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === _ && s[1]), 
                            !1 === k) for (;(d = ++p && d && d[g] || (k = p = 0) || m.pop()) && ((u ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++k || (y && ((c = (f = d[q] || (d[q] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [ _, k ]), 
                            d !== t)); ) ;
                ...
                PSEUDO: function(e, n) {
                    ...
                    return a[q] ? a(n) : a.length > 1 ? (o = [ e, e, "", n ], x.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function(e, t) {
        ...
        return c.prototype = x.filters = x.pseudos, x.setFilters = new c(), C = t.tokenize = function(e, n) {
            ...
            var n, r = [], o = [], a = H[e + " "];
            if (!a) {
                for (t || (t = C(e)), n = t.length; n--; ) (a = v(t[n]))[q] ? r.push(a) : o.push(a);
        ...
        }, b.sortStable = q.split("").sort(W).join("") === q, b.detectDuplicates = !!M, 
    ...
    var Ne = /^(?:parents|prev(?:Until|All))/, Te = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    pe.fn.extend({
        ...
        pe.fn[e] = function(n, r) {
            ...
            this.length > 1 && (Te[e] || pe.uniqueSort(o), Ne.test(e) && o.reverse()), this.pushStack(o);
        };
    });
    var Ie = /[^\x20\t\r\n\f]+/g;
    ...
    var Fe = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, qe = new RegExp("^(?:([+-])=|)(" + Fe + ")([a-z%]*)$", "i"), Be = [ "Top", "Right", "Bottom", "Left" ], _e = function(e, t) {
    ...
    pe.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" == (a = typeof n) && (o = qe.exec(n)) && o[1] && (n = g(e, t, o), a = "number"), 
        ...
        pe.cssHooks[t] = {
            get: function(e, n, r) {
                if (n) return !it.test(pe.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? q(e, t, r) : Ge(e, lt, function() {
                    return q(e, t, r);
                });
            },
            set: function(e, n, r) {
                var o, a = r && at(e), i = r && F(e, t, r, "border-box" === pe.css(e, "boxSizing", !1, a), a);
                return i && (o = qe.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = pe.css(e, t)), 
                V(0, n, i);
            }
        };
        ...
        pe.cssHooks[e + t] = {
            expand: function(n) {
                for (var r = 0, o = {}, a = "string" == typeof n ? n.split(" ") : [ n ]; r < 4; r++) o[e + Be[r] + t] = a[r] || a[r - 2] || a[0];
                return o;
            }
    ...
    var At = /\[\]$/, Nt = /\r?\n/g, Tt = /^(?:submit|button|image|reset|file)$/i, It = /^(?:input|select|textarea|keygen)/i;
    pe.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !pe(this).is(":disabled") && It.test(this.nodeName) && !Tt.test(e) && (this.checked || !Ue.test(e));
            }).map(function(e, t) {
                var n = pe(this).val();
    ...
    var Mt = /%20/g, Pt = /#.*$/, Dt = /([?&])_=[^&]*/, Ot = /^(.*?):[ \t]*([^\r\n]*)$/gm, Lt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Rt = /^(?:GET|HEAD)$/, Et = /^\/\//, Vt = {}, Ft = {}, qt = "*/".concat("*"), Bt = te.createElement("a");
    Bt.href = St.href, pe.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function(t, n) {
            ...
            null == m.crossDomain) {
                ...
                try {
                    s.href = m.url, s.href = s.href, m.crossDomain = Bt.protocol + "//" + Bt.host != s.protocol + "//" + s.host;
                } catch (e) {
                    m.crossDomain = !0;
                }
            }
            ...
            w.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + qt + "; q=0.01" : "") : m.accepts["*"]);
...
!function(e, t) {
    ...
    if (!e.FFT) {
        var t = function(e, t, n, r, o, a, i) {
            ...
            for (var u, l, s, c, f, d, p, m, g, h, v, y, k, b, x, S, w = 0, C = 0, A = 2 * r, N = n, T = n + i, I = n + 2 * i, M = a[r * i], P = .5773502691896258, D = N + i; N < D; ) g = e[N] * P, 
            ...
            for (var l, s, c, f, d, p, m, g, h, v, y, k, b, x, S, w, C, A, N, T, I, M, P = 0, D = 0, O = 0, L = 2 * r, R = 3 * r, E = n, V = n + i, F = n + 2 * i, q = n + 3 * i, B = E + i; E < B; ) b = .5 * e[E], 
            x = .5 * t[E], S = .5 * e[V], w = .5 * t[V], C = .5 * e[F], A = .5 * t[F], N = .5 * e[q], 
            T = .5 * t[q], l = S * (I = o[P]) - w * (M = a[P]), s = S * M + w * I, y = b - (c = C * (I = o[D]) - A * (M = a[D])), 
            k = x - (f = C * M + A * I), b += c, x += f, m = l + (d = N * (I = o[O]) - T * (M = a[O])), 
            g = s + (p = N * M + T * I), h = l - d, v = s - p, e[F] = b - m, t[F] = x - g, e[E] = b + m, 
            t[E] = x + g, u ? (e[V] = y - v, t[V] = k + h, e[q] = y + v, t[q] = k - h) : (e[V] = y + v, 
            t[V] = k - h, e[q] = y - v, t[q] = k + h), P += r, D += L, O += R, ++E, ++V, ++F, 
            ++q;
        }, o = function(e, t, n, r, o, a, i) {
            for (var u, l, s, c, f, d, p, m, g, h, v, y, k, b, x, S, w, C, A, N, T, I, M, P, D, O, L, R, E, V, F, q, B, _, G, j, U, H, W = 0, z = 0, $ = 0, K = 0, J = 2 * r, X = 3 * r, Q = 4 * r, Y = n, Z = n + i, ee = n + 2 * i, te = n + 3 * i, ne = n + 4 * i, re = o[r * i], oe = a[r * i], ae = o[2 * r * i], ie = a[2 * r * i], ue = .4472135954999579, le = Y + i; Y < le; ) L = e[Y] * ue, 
            ...
            t[Y] = R + S + C, v = u + x * re + w * ae, y = l + S * re + C * ae, k = I * oe + N * ie, 
            b = -T * oe - A * ie, e[Z] = v - k, t[Z] = y - b, e[ne] = v + k, t[ne] = y + b, 
            M = u + x * ae + w * re, P = l + S * ae + C * re, D = -I * ie + N * oe, O = T * ie - A * oe, 
...
!function() {
    ...
    fluid.defaults("flock.midi.system", {
        ...
        var t, n = [], r = e.channel ? e.channel : 0;
        switch (e.type) {
          case "noteOn":
            t = 9, n = [ e.note, e.velocity ];
            break;

          case "noteOff":
            t = 8, n = [ e.note, e.velocity ];
            break;

          case "aftertouch":
            e.note ? (t = 10, n = [ e.note, e.pressure ]) : (t = 13, n = [ e.pressure ]);
            break;

          case "control":
            t = 11, n = [ e.number, e.value ];
            break;
          ...
          case "pitchbend":
            t = 14, n = flock.midi.write.valueToTwoByteArray(e.value);
            break;
          ...
          case "songPointer":
            r = 2, t = 15, n = flock.midi.write.valueToTwoByteArray(e.value);
            break;

          case "songSelect":
            r = 3, t = 15, n = flock.midi.write.valueToTwoByteArray(e.value);
            break;
        ...
        return (e = new Uint8Array(n.length + 1))[0] = (t << 4) + r, n && e.set(n, 1), e;
...
!function() {
    ...
    flock.ugen.playBuffer = function(e, t, n) {
        ...
        var r = flock.ugen(e, t, n);
        return r.gen = function(e) {
            var t, n, o, a, i, u, l, s, c, f, d = r.model, p = d.strides, m = r.output, g = r.inputs, h = r.buffers, v = h.length - 1, y = d.prevTrigger, k = d.maxVoices, b = d.activeVoices, x = d.freeVoices, S = g.trigger.output, w = p.trigger, C = 0, A = g.bufferIndex.output, N = p.bufferIndex, T = 0, I = g.speed.output, M = p.speed, P = 0, D = r.inputs.channel.output[0];
            for (t = 0; t < e; t++) {
