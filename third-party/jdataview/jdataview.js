 ...
 * Licensed under the WTF License: http://sam.zoy.org/wtfpl/
 *
 * Modifications by Colin Clark, 2012:
 *  - Removal of half-baked jQuery patching code.
 *  - Minor lintification of jDataView.createBuffer()
 */
...
(function (global) {
    ...
    jDataView.createBuffer = function () {
    	...
    	if (compatibility.NodeBuffer) {
    	    buffer = new Buffer(arguments.length);
